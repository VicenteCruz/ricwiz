"use strict";var Zo=Object.create;var Oe=Object.defineProperty;var Ko=Object.getOwnPropertyDescriptor;var Xo=Object.getOwnPropertyNames;var ei=Object.getPrototypeOf,ti=Object.prototype.hasOwnProperty;var $=(t,e,o)=>()=>{if(o)throw o[0];try{return t&&(e=t(t=0)),e}catch(i){throw o=[i],i}};var Ye=(t,e)=>{for(var o in e)Oe(t,o,{get:e[o],enumerable:!0})},dt=(t,e,o,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Xo(e))!ti.call(t,s)&&s!==o&&Oe(t,s,{get:()=>e[s],enumerable:!(i=Ko(e,s))||i.enumerable});return t};var v=(t,e,o)=>(o=t!=null?Zo(ei(t)):{},dt(e||!t||!t.__esModule?Oe(o,"default",{value:t,enumerable:!0}):o,t)),ee=t=>dt(Oe({},"__esModule",{value:!0}),t);function C(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var b,Ne,lt=$(()=>{"use strict";b=v(require("vscode"));Ne=class{constructor(e){this._extensionUri=e}_extensionUri;webviewView;resolveWebviewView(e,o,i){this.webviewView=e,e.webview.options={enableScripts:!0,localResourceRoots:[this._extensionUri]},this.updateBranch("",!1),e.webview.onDidReceiveMessage(s=>{switch(s.command){case"createBranches":b.commands.executeCommand("ricwiz.createBranches");break;case"createBranchForTicket":b.commands.executeCommand("ricwiz.createBranches",s.args);break;case"prepareDeploy":b.commands.executeCommand("ricwiz.prepareDeploy");break;case"openMRs":b.commands.executeCommand("ricwiz.createMergeRequests");break;case"openMRsVSCode":b.commands.executeCommand("ricwiz.createMergeRequestsVSCode");break;case"openExternal":s.args&&b.env.openExternal(b.Uri.parse(s.args));break;case"openJira":b.commands.executeCommand("ricwiz.openJiraTicket");break;case"showJiraDetails":b.commands.executeCommand("ricwiz.showJiraDetails");break;case"changeJiraStatus":b.commands.executeCommand("ricwiz.changeJiraStatus");break;case"addJiraComment":b.commands.executeCommand("ricwiz.addJiraComment");break;case"addJiraLabel":b.commands.executeCommand("ricwiz.addJiraLabel");break;case"setPage":this.setPage(s.args);break;case"openDashboard":b.commands.executeCommand("ricwiz.openJiraDashboard");break;case"openJiraDetailsForId":b.commands.executeCommand("ricwiz.openJiraDetailsForId",s.args);break;case"refreshDashboard":b.commands.executeCommand("ricwiz.openJiraDashboard");break;case"switchDashboardQuery":b.commands.executeCommand("ricwiz.openJiraDashboard",parseInt(s.args));break;case"toggleDashboardBranches":b.commands.executeCommand("ricwiz.toggleDashboardBranches",s.args);break;case"openJiraVSCode":b.commands.executeCommand("ricwiz.openJiraTicketVSCode");break;case"openSettings":b.commands.executeCommand("ricwiz.openSettings");break;case"checkout":s.branch&&b.commands.executeCommand("ricwiz.checkoutBranch",s.branch);break;case"copyBranch":b.commands.executeCommand("ricwiz.copyBranchName");break;case"generatePackageXml":b.commands.executeCommand("ricwiz.generatePackageXml");break;case"openDevTools":this.setPage("devtools");break;case"openMain":this.setPage("main");break;case"generateDestructiveChanges":b.commands.executeCommand("ricwiz.generateDestructiveChanges");break;case"deployPackage":b.commands.executeCommand("ricwiz.deployPackage");break;case"runSmartTests":b.commands.executeCommand("ricwiz.runSmartTests");break;case"importData":b.commands.executeCommand("ricwiz.importData");break;case"listTicketFiles":b.commands.executeCommand("ricwiz.listTicketFiles");break;case"resetTracking":b.commands.executeCommand("ricwiz.resetTracking");break;case"extractComponent":b.commands.executeCommand("ricwiz.extractComponent");break;case"deployMultiOrg":b.commands.executeCommand("ricwiz.deployMultiOrg");break;case"captureAdminChanges":b.commands.executeCommand("ricwiz.captureAdminChanges");break;case"whoToBlame":b.commands.executeCommand("ricwiz.whoToBlame");break;case"syncAll":b.commands.executeCommand("ricwiz.syncAll");break;case"updateBases":b.commands.executeCommand("ricwiz.updateBases");break;case"deleteUnused":b.commands.executeCommand("ricwiz.deleteUnusedBranches");break;case"conflict_commitAndContinue":b.commands.executeCommand("ricwiz.conflictAction","commitAndContinue");break;case"conflict_resolveDeletions":b.commands.executeCommand("ricwiz.conflictAction","resolveDeletions");break;case"conflict_abortDeploy":b.commands.executeCommand("ricwiz.conflictAction","abortDeploy");break;case"openFile":if(s.file){let u=b.workspace.workspaceFolders;if(u){let a=b.Uri.joinPath(u[0].uri,s.file);b.commands.executeCommand("vscode.open",a)}}break;case"searchTicket":b.commands.executeCommand("ricwiz.searchTicket");break;case"manualRefresh":b.commands.executeCommand("ricwiz.manualRefresh");break;case"toggleAutoRefresh":b.commands.executeCommand("ricwiz.toggleAutoRefresh");break;case"openHistory":b.commands.executeCommand("ricwiz.openHistory");break}})}conflictState=null;setConflictState(e){this.conflictState=e,this.updateView()}updateBranch(e,o,i=[],s=[],u=[],a=[],p=""){this.webviewView&&(this.currentBranchCache=e,this.currentBranchIsMergedCache=o,this.relatedBranchesCache=i,this.commitsCache=s,this.baseBranchesCache=u,this.recentTicketsCache=a,this.ticketTitleCache=p,this.updateView())}currentBranchCache="";currentBranchIsMergedCache=!1;relatedBranchesCache=[];commitsCache=[];baseBranchesCache=[];recentTicketsCache=[];ticketTitleCache="";currentPage="main";blameDataCache=null;jiraDataCache=null;dashboardDataCache=null;dashboardShowBranches=!1;autoRefreshEnabled=!0;setDashboardShowBranches(e){this.dashboardShowBranches=e}getDashboardShowBranches(){return this.dashboardShowBranches}setBlameData(e){this.blameDataCache=e}setJiraData(e){this.jiraDataCache=e}setDashboardData(e){this.dashboardDataCache=e}setAutoRefresh(e){this.autoRefreshEnabled=e,this.updateView()}isAutoRefreshEnabled(){return this.autoRefreshEnabled}setPage(e){this.currentPage=e,this.updateView()}updateView(){if(!this.webviewView)return;let e=this.webviewView.webview.asWebviewUri(b.Uri.joinPath(this._extensionUri,"resources","logo.png"));this.webviewView.webview.html=this._getHtmlForWebview(e,this.currentBranchCache,this.relatedBranchesCache,this.commitsCache,this.baseBranchesCache,this.recentTicketsCache,this.currentPage)}_getHtmlForWebview(e,o,i,s,u,a,p){let l=s.length>0?`
        ...
        </html>`}}});function mt(t){le=t.secrets}async function pt(t){if(!le)throw new Error("SecretStorage is not initialized.");await le.store("ricwiz.jiraApiToken",t)}async function ut(){if(!le)throw new Error("SecretStorage is not initialized.");return await le.get("ricwiz.jiraApiToken")}async function gt(t){if(!le)throw new Error("SecretStorage is not initialized.");await le.store("ricwiz.gitlabApiToken",t)}async function Ze(){if(!le)throw new Error("SecretStorage is not initialized.");return await le.get("ricwiz.gitlabApiToken")}var le,xe=$(()=>{"use strict"});var Se={};Ye(Se,{checkBranchExists:()=>fe,exec:()=>h,extractTicketSuggestion:()=>vt,getCurrentBranch:()=>I,getWorkspaceCwd:()=>y,normalizeTicketId:()=>yt,promptForTicketId:()=>J,resolvePrefix:()=>wt,ricwizLogger:()=>A});function y(){let t=ke.workspace.workspaceFolders;if(t)return t[0].uri.fsPath}async function I(t){try{let{stdout:e}=await h("git branch --show-current",{cwd:t});return e.trim()}catch{return""}}function wt(t,e){if(!t.includes(e)){let o=t.match(/([A-Z]+-)\d+/i);if(o)return o[1].toUpperCase()}return e}function vt(t,e,o=!1){let i=t.match(new RegExp(`(${e}\\d+)`,"i"));return i?i[1].toUpperCase():t.includes(e)&&!t.includes("-to-")?t.substring(t.indexOf(e)):o&&t.includes("-to-")?t.substring(t.indexOf(e)).split("-to-")[0]:""}function yt(t,e){let o=t.trim();return/^\d/.test(o)?`${e}${o}`.toUpperCase():o.toUpperCase()}async function J(t,e){let o=ke.workspace.getConfiguration("ricwiz"),i=e?.prefix??o.get("ticketPrefix","SFPSCA-"),s=await I(t),u=wt(s,i),a=e?.suggestedValue??vt(s,u,e?.handleToSuffix),p=await ke.window.showInputBox({prompt:e?.prompt||"Enter the full ticket ID (e.g., SCPSCA-1234) or just the number",placeHolder:e?.placeHolder||"Ticket ID or number",value:a});return p?{ticketId:yt(p,u),currentBranch:s,prefix:u}:void 0}async function fe(t,e){try{return await h(`git show-ref --verify --quiet refs/heads/${e}`,{cwd:t}),!0}catch{}try{return await h(`git show-ref --verify --quiet refs/remotes/origin/${e}`,{cwd:t}),!0}catch{}return!1}var ke,ft,ht,oi,A,h,R=$(()=>{"use strict";ke=v(require("vscode")),ft=v(require("child_process")),ht=v(require("util")),oi=ht.promisify(ft.exec),A=ke.window.createOutputChannel("Ricwiz"),h=async(t,e)=>{A.appendLine(`[EXEC] ${t}`);let o=await oi(t,{maxBuffer:50*1024*1024,...e});return{stdout:o.stdout.toString(),stderr:o.stderr.toString()}}});async function bt(){let t=y();if(!t){W.window.showErrorMessage("Ricwiz: Open a workspace that is a Git repository.");return}let o=W.workspace.getConfiguration("ricwiz").get("ticketSourceBranch","main");await W.window.withProgress({location:W.ProgressLocation.Notification,title:`Ricwiz: Finding deleted files compared to origin/${o}...`,cancellable:!1},async()=>{try{let{stdout:i}=await h(`git diff --name-only --diff-filter=D origin/${o}...HEAD`,{cwd:t}),s=i.split(`
`).map(c=>c.trim()).filter(c=>c.length>0);if(s.length===0){W.window.showInformationMessage(`Ricwiz: No deleted files found compared to origin/${o}.`);return}let u={},a=(c,m)=>{u[c]||(u[c]=[]),u[c].includes(m)||u[c].push(m)};for(let c of s){let m=c.replace(/\\/g,"/");if(m.includes("/classes/")){let f=m.match(/\/classes\/([^/.]+)\.cls/);f&&a("ApexClass",f[1])}else if(m.includes("/triggers/")){let f=m.match(/\/triggers\/([^/.]+)\.trigger/);f&&a("ApexTrigger",f[1])}else if(m.includes("/lwc/")){let f=m.match(/\/lwc\/([^/]+)\//);f&&a("LightningComponentBundle",f[1])}else if(m.includes("/aura/")){let f=m.match(/\/aura\/([^/]+)\//);f&&a("AuraDefinitionBundle",f[1])}else if(m.includes("/objects/")&&m.includes("/fields/")){let f=m.match(/\/objects\/([^/]+)\//),g=m.match(/\/fields\/([^/.]+)\.field/);f&&g&&a("CustomField",`${f[1]}.${g[1]}`)}else if(m.includes("/objects/")){let f=m.match(/\/objects\/([^/.]+)\.object/);f&&a("CustomObject",f[1])}else if(m.includes("/layouts/")){let f=m.match(/\/layouts\/([^/.]+)\.layout/);f&&a("Layout",f[1])}else if(m.includes("/flows/")){let f=m.match(/\/flows\/([^/.]+)\.flow/);f&&a("Flow",f[1])}else if(m.includes("/permissionsets/")){let f=m.match(/\/permissionsets\/([^/.]+)\.permissionset/);f&&a("PermissionSet",f[1])}else if(m.includes("/profiles/")){let f=m.match(/\/profiles\/([^/.]+)\.profile/);f&&a("Profile",f[1])}else if(m.includes("/customMetadata/")){let f=m.match(/\/customMetadata\/([^/.]+)\.md/);f&&a("CustomMetadata",f[1])}else if(m.includes("/flexipages/")){let f=m.match(/\/flexipages\/([^/.]+)\.flexipage/);f&&a("FlexiPage",f[1])}}if(Object.keys(u).length===0){W.window.showInformationMessage("Ricwiz: Found deleted files in Git, but none mapped to recognizable Salesforce metadata.");return}let p=`<?xml version="1.0" encoding="UTF-8"?>
...
</Package>`;let l=Ue.join(t,"destructiveChanges");he.existsSync(l)||he.mkdirSync(l);let d=Ue.join(l,"destructiveChanges.xml"),n=Ue.join(l,"package.xml");he.writeFileSync(d,p,"utf8"),he.existsSync(n)||he.writeFileSync(n,`<?xml version="1.0" encoding="UTF-8"?>
<Package xmlns="http://soap.sforce.com/2006/04/metadata">
    <version>58.0</version>
</Package>`,"utf8");let r=await W.workspace.openTextDocument(d);await W.window.showTextDocument(r),W.window.showInformationMessage("Ricwiz: destructiveChanges.xml generated successfully!")}catch(i){W.window.showErrorMessage(`Ricwiz: Error generating destructive changes: ${i.message}`)}})}var W,Ue,he,xt=$(()=>{"use strict";W=v(require("vscode")),Ue=v(require("path")),he=v(require("fs"));R()});async function kt(){let t=y();if(!t)return;let o=ae.workspace.getConfiguration("ricwiz").get("ticketSourceBranch","main");await ae.window.withProgress({location:ae.ProgressLocation.Notification,title:"Ricwiz: Finding Apex Tests to run...",cancellable:!1},async()=>{try{let{stdout:i}=await h(`git diff --name-status origin/${o}...HEAD`,{cwd:t}),s=i.split(`
`).map(c=>c.trim()).filter(c=>c.length>0),u=new Set,a=new Set;for(let c of s){let m=c.split(/\s+/);if(m[0].startsWith("D"))continue;let f=m[1];if(f&&f.endsWith(".cls")){let g=f.match(/\/classes\/([^/.]+)\.cls/);if(g){let w=g[1];w.toLowerCase().endsWith("test")?u.add(w):a.add(w)}}}for(let c of a)u.add(`${c}Test`);if(u.size===0){ae.window.showInformationMessage("Ricwiz: No Apex Classes were modified in this branch.");return}let p=Array.from(u).map(c=>({label:`$(beaker) ${c}`,description:"Apex Test Class"})),l=await ae.window.showQuickPick(p,{canPickMany:!0,title:"Select Test Classes to Run",placeHolder:"Select tests..."});if(!l||l.length===0)return;let n=`sf apex run test -n ${l.map(c=>c.label.replace("$(beaker) ","").trim()).join(",")} -r human -w 30`,r=ae.window.createTerminal("Ricwiz: Smart Tests");r.show(),r.sendText(n)}catch(i){ae.window.showErrorMessage(`Ricwiz: Error finding tests: ${i.message}`)}})}var ae,Ct=$(()=>{"use strict";ae=v(require("vscode"));R()});var we,$t=$(()=>{"use strict";we=class{static isValidShellArg(e){return e?/^[a-zA-Z0-9\-_/.]+$/.test(e):!1}}});var Be,zt,je,L,me=$(()=>{"use strict";Be=v(require("vscode")),zt=v(require("path")),je=v(require("fs")),L=class t{style;upstreamRemote;originRemote;ticketSourceBranch;ticketPrefix;environments;static baseConfig=Be.workspace.getConfiguration("ricwiz");activeProfile;profileName;constructor(e){this.activeProfile=e,this.profileName=e?.name;let o=t.baseConfig;this.style=e?.workflowStyle||o.get("workflowStyle","standard"),this.style==="multi-remote"?(this.upstreamRemote=e?.upstreamRemote||o.get("upstreamRemote","salesforce-master"),this.originRemote=e?.originRemote||o.get("originRemote","origin")):(this.upstreamRemote="origin",this.originRemote="origin"),this.ticketSourceBranch=e?.ticketSourceBranch||o.get("ticketSourceBranch","main"),this.ticketPrefix=e?.ticketPrefix||o.get("ticketPrefix","SFPSCA-");let i=[{name:"Qual",sourceBranch:"quality"},{name:"Val",sourceBranch:"validation"},{name:"Prod",sourceBranch:"main"}];this.environments=e?.environments||o.get("environments",i)}getConfig(e,o){return this.activeProfile&&this.activeProfile[e]!==void 0?this.activeProfile[e]:t.baseConfig.get(e,o)}static async initialize(e,o){let i=t.baseConfig.get("profiles",[]),s=zt.join(e,"ricwiz.json");if(je.existsSync(s))try{let u=je.readFileSync(s,"utf-8"),a=JSON.parse(u);a&&Array.isArray(a.profiles)&&(i=[...i,...a.profiles])}catch(u){Be.window.showErrorMessage(`Ricwiz: Error parsing ricwiz.json: ${u.message}`)}if(i.length>0){if(!o?.forcePrompt)try{let{exec:l}=(R(),ee(Se)),{stdout:d}=await l("git branch --show-current",{cwd:e}),n=d.trim(),r=n;n.includes("-to-")&&(r=n.split("-to-")[0]);let{stdout:c}=await l(`git config branch.${r}.ricwiz-profile`,{cwd:e}),m=c.trim();if(m){let f=i.find(g=>g.name===m);if(f)return new t(f)}}catch{}let u=i.map(l=>l.name),a=await Be.window.showQuickPick(u,{placeHolder:"Ricwiz: Select Workflow Profile",ignoreFocusOut:!0});if(!a)return;let p=i.find(l=>l.name===a);return new t(p)}return new t}buildUpstreamPath(e){return e.includes("/")?e:`${this.upstreamRemote}/${e}`}getFetchRemote(e){return e.includes("/")?e.split("/")[0]:this.upstreamRemote}getFetchBranch(e){return e.includes("/")?e.substring(e.indexOf("/")+1):e}}});async function Rt(t){let e=y();if(!e){M.window.showErrorMessage("Open a folder or workspace that is a Git repository.");return}let o=await L.initialize(e,{forcePrompt:!0});if(!o)return;let i=typeof t=="string"?t:void 0,s=await J(e,{prefix:o.ticketPrefix,suggestedValue:i});if(!s){M.window.showErrorMessage("Branch creation cancelled: Ticket not provided.");return}let{ticketId:u}=s,a=o.environments,p="all",l=[{label:"Create Main Branch & Environments",description:"Creates the main ticket branch and all environment branches",value:"all"},{label:"Create Main Branch Only",description:"Creates only the main ticket branch (skips environments)",value:"mainOnly"},{label:"Create Environments Only",description:"Creates only the environment branches (skip main branch)",value:"envs"}];if(a.length>0){let r=await M.window.showQuickPick(l,{placeHolder:"Ricwiz: What do you want to create?",ignoreFocusOut:!0});if(!r)return;p=r.value}let d=o.ticketSourceBranch;if(p==="all"||p==="mainOnly"){let r=[];try{let{stdout:g}=await h('git branch --all --format="%(refname:short)"',{cwd:e});r=g.split(`
`).map(w=>w.trim()).filter(w=>w&&w!=="origin"),r=[...new Set(r)]}catch{}let c=M.window.createQuickPick();c.title="Ricwiz: Ticket Source Branch",c.placeholder="Confirm or change the source branch for this ticket",c.value=o.ticketSourceBranch,c.ignoreFocusOut=!0;let m=()=>{let g=c.value.trim(),w=[];g&&w.push({label:g,description:"Use typed branch"}),w.push(...r.map(z=>({label:z}))),c.items=w};c.onDidChangeValue(m),m();let f=await new Promise(g=>{c.onDidAccept(()=>{let w=c.selectedItems[0];g(w?w.label:c.value),c.hide()}),c.onDidHide(()=>g(void 0)),c.show()});if(!f){M.window.showInformationMessage("Branch creation cancelled.");return}d=f.trim()}let n=u;if(!we.isValidShellArg(n)){M.window.showErrorMessage(`Invalid format for ticket ID: ${n}`);return}if(!we.isValidShellArg(d)){M.window.showErrorMessage(`Invalid format for ticketSourceBranch in settings: ${d}`);return}for(let r of a){if(!we.isValidShellArg(r.name)){M.window.showErrorMessage(`Invalid format for environment name in settings: ${r.name}`);return}if(!we.isValidShellArg(r.sourceBranch)){M.window.showErrorMessage(`Invalid format for environment sourceBranch in settings: ${r.sourceBranch}`);return}}try{await h("git status",{cwd:e})}catch{M.window.showErrorMessage("The opened folder does not appear to be a valid Git repository.");return}try{await M.window.withProgress({location:M.ProgressLocation.Notification,title:"Ricwiz: Creating Branches",cancellable:!1},async r=>{let c=[];r.report({message:"Checking remote status (git fetch)...",increment:10});try{await h("git fetch",{cwd:e})}catch{}try{if(p==="all"||p==="mainOnly"){if(r.report({message:`Creating main branch ${n}...`,increment:10}),await fe(e,n))M.window.showInformationMessage(`Ricwiz: The branch ${n} already exists. Skipping creation...`),await h(`git checkout ${n}`,{cwd:e});else try{let m=o.getFetchRemote(d),f=o.getFetchBranch(d),g=o.buildUpstreamPath(d);await h(`git fetch ${m} ${f}`,{cwd:e}),await h(`git checkout -b ${n} ${g}`,{cwd:e}),c.push(n)}catch{try{await h(`git checkout -b ${n} ${d}`,{cwd:e}),c.push(n)}catch{throw new Error(`Could not create main branch '${n}' from '${d}'. Does the source branch exist?`)}}try{await h(`git config branch.${n}.ricwiz-source "${d}"`,{cwd:e}),o.profileName&&await h(`git config branch.${n}.ricwiz-profile "${o.profileName}"`,{cwd:e})}catch{}}if(p==="all"||p==="envs"){let m=50/(a.length||1);for(let f of a){let g=`${u}-to-${f.name}`,w=f.sourceBranch;if(r.report({message:`Processing environment branch ${g}...`,increment:m}),!await fe(e,g))try{let z=o.buildUpstreamPath(w);await h(`git checkout -b ${g} ${z}`,{cwd:e}),c.push(g)}catch{try{await h(`git checkout -b ${g} ${w}`,{cwd:e}),c.push(g)}catch{throw new Error(`Could not create environment branch '${g}' from '${w}'. Does the source branch exist?`)}}}}r.report({message:`Publishing branches to ${o.originRemote}...`,increment:10});for(let m of c)try{await h(`git push -u ${o.originRemote} ${m}`,{cwd:e})}catch{M.window.showWarningMessage(`Ricwiz: Branch ${m} was created locally but could not be pushed to ${o.originRemote}.`)}if(p==="all"||p==="mainOnly"){r.report({message:`Switching to ${n}...`,increment:10});try{await h(`git checkout ${n}`,{cwd:e})}catch{}}r.report({increment:100}),M.window.showInformationMessage("Ricwiz: All set! You can start working on your branches! \u{1F680}")}catch(m){if(M.window.showErrorMessage(`Ricwiz Branch Creation Failed: ${m.message}`),c.length>0){try{await h(`git checkout ${d}`,{cwd:e})}catch{}for(let f of c)try{await h(`git branch -D ${f}`,{cwd:e})}catch{}M.window.showWarningMessage(`Ricwiz: Rolled back (deleted) ${c.length} branch(es) locally due to failure.`)}}})}catch(r){M.window.showErrorMessage(`Ricwiz general error: ${r.message}`)}}var M,St=$(()=>{"use strict";M=v(require("vscode"));R();$t();me()});async function ve(t,e,o,i){i&&i.report({message:"CONFLICT! Resolve & click 'Commit & Continue' in Ricwiz panel."});let s=!1,u=!1,a=async()=>{try{let{stdout:n}=await h("git status --porcelain",{cwd:t});return n.split(`
...
`).map(c=>c.trimRight()).filter(c=>c.length>2).filter(c=>{let m=c.substring(0,2);return["UU","AA","UD","DU","AU","UA","DD"].includes(m)}).map(c=>{let m=c.substring(0,2);return{file:c.substring(3).trim(),state:r(m)}})}catch{return[]}},l=async()=>{if(s)return;let n=await a(),r=await p(),{webviewProvider:c}=(We(),ee(Je));c&&c.setConflictState({isConflict:!0,sourceStr:e,targetStr:o,deletionsCount:n.length,files:r})},d=ce.commands.registerCommand("ricwiz.conflictAction",async n=>{if(n==="abortDeploy")u=!0;else if(n==="resolveDeletions"){try{let c=(await a()).map(f=>({label:f})),m=await ce.window.showQuickPick(c,{canPickMany:!0,placeHolder:"Select conflicted files to DELETE",title:"Ricwiz: Delete Conflicted Files"});if(m&&m.length>0){for(let f of m)try{await h(`git rm --force "${f.label}"`,{cwd:t})}catch{}ce.window.showInformationMessage(`Ricwiz: Deleted ${m.length} conflicted file(s).`)}}catch(r){ce.window.showErrorMessage(`Ricwiz: Error. (${r.message})`)}l()}else if(n==="commitAndContinue")try{let c=(await a()).filter(f=>Bt.existsSync(Pt.join(t,f)));if(c.length>0&&await ce.window.showWarningMessage(`Wait! There are ${c.length} file(s) with deletion conflicts that are still on your disk.

If you commit now, you will KEEP them in the project.

Are you sure you want to KEEP them?`,{modal:!0},"Yes, KEEP them","No, let me DELETE them")!=="Yes, KEEP them"){l();return}let m=!1;try{let{stdout:f}=await h('git grep -E "^<<<<<<< "',{cwd:t});f.trim().length>0&&(m=!0)}catch{}if(m){ce.window.showErrorMessage("Ricwiz: You still have unresolved conflict markers (<<<<<<<) in your files. Please resolve them first!"),l();return}await h("git add .",{cwd:t}),await h("git commit --no-edit",{cwd:t})}catch(r){ce.window.showErrorMessage(`Ricwiz: Could not commit automatically. (${r.message})`),l()}});for(l();;){if(u){s=!0,d.dispose(),(We(),ee(Je)).webviewProvider?.setConflictState(null);try{await h("git merge --abort",{cwd:t})}catch{}return!1}try{let{stdout:n}=await h("git status --porcelain",{cwd:t});if(n.trim().length===0)return s=!0,d.dispose(),(We(),ee(Je)).webviewProvider?.setConflictState(null),ce.window.showInformationMessage("Ricwiz: Changes committed!"),!0}catch{}await new Promise(n=>setTimeout(n,2e3))}}var ce,Bt,Pt,qe=$(()=>{"use strict";ce=v(require("vscode")),Bt=v(require("fs")),Pt=v(require("path"));R()});async function Et(){let t=y();if(!t){U.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}try{await h("git status",{cwd:t})}catch{U.window.showErrorMessage("Ricwiz: The opened folder does not appear to be a valid Git repository.");return}let e=await L.initialize(t);if(!e)return;let o=e.environments,i=await J(t,{prefix:e.ticketPrefix});if(!i){U.window.showErrorMessage("Operation cancelled: Ticket not provided.");return}let{ticketId:s,currentBranch:u}=i,a=s;if(!await fe(t,a)){U.window.showErrorMessage(`Ricwiz: Main branch '${a}' does not exist! Prepare deploy is only available when a main ticket branch is used.`);return}let p=e.getConfig("defaultReviewers",""),l="";try{let{stdout:d}=await h(`git config branch.${s}.ricwiz-reviewers`,{cwd:t});l=d.trim()}catch{}if(p.trim()){let d=await U.window.showInputBox({prompt:"Ricwiz: Reviewers for this deploy (optional, comma-separated)",placeHolder:"e.g. @joao, 123456",value:l||p,ignoreFocusOut:!0});if(d===void 0)return;try{d.trim()?await h(`git config branch.${s}.ricwiz-reviewers "${d.trim()}"`,{cwd:t}):l&&await h(`git config --unset branch.${s}.ricwiz-reviewers`,{cwd:t})}catch{}}await U.window.withProgress({location:U.ProgressLocation.Notification,title:"Ricwiz: Preparing Deploy",cancellable:!0},async(d,n)=>{let r=0,c=u,m=!1;n.onCancellationRequested(()=>{m=!0}),d.report({message:"Syncing remote information...",increment:10});try{await h("git fetch --all",{cwd:t});let g=10/(o.length||1);for(let w of o)try{if(m)throw new Error("Aborted");d.report({message:`Fetching ${w.sourceBranch}...`,increment:g});let z=e.getFetchRemote(w.sourceBranch),x=e.getFetchBranch(w.sourceBranch);await h(`git fetch ${z} ${x}:${x}`,{cwd:t})}catch{}}catch{}let f=60/(o.length||1);for(let g of o){if(m)break;let w=`${s}-to-${g.name}`,z=g.sourceBranch;try{d.report({message:`Processing ${w}...`,increment:f/4}),await h(`git checkout ${w}`,{cwd:t});try{await h(`git pull ${e.originRemote} ${w}`,{cwd:t})}catch{}let x=async re=>{try{await h(`git merge ${re}`,{cwd:t})}catch(E){let N=!1;try{let{stdout:H}=await h("git ls-files -u",{cwd:t});H.trim().length>0&&(N=!0)}catch{}let G=((E.stdout||"")+(E.stderr||"")+(E.message||"")).toLowerCase();if(N||G.includes("conflict")||G.includes("conflit")){if(!await ve(t,re,w,d))throw m=!0,new Error("Deploy aborted by user.")}else throw E}};d.report({message:`Merging ${z} into ${w}...`,increment:f/4});let P=e.getFetchRemote(z),B=e.getFetchBranch(z),O=e.buildUpstreamPath(z);if(await h(`git fetch ${P} ${B}`,{cwd:t}),await x(O),d.report({message:`Merging ${a} into ${w}...`,increment:f/4}),await x(a),m)break;d.report({message:`Pushing ${w}...`,increment:f/4}),await h(`git push ${e.originRemote} ${w}`,{cwd:t}),r++}catch(x){x.message.includes("aborted")?U.window.showInformationMessage("Ricwiz: Deploy cancelled."):U.window.showErrorMessage(`Ricwiz: Failed to process branch ${w}. Detail: ${x.message}`);return}}if(!m){d.report({message:"Finishing up...",increment:10});let g=c;try{await h(`git show-ref --verify --quiet refs/heads/${a}`,{cwd:t}),g=a}catch{}try{let w=await I(t);g&&g!==w?(await h(`git checkout ${g}`,{cwd:t}),U.window.showInformationMessage(`Ricwiz: Operation complete. Back on branch ${g}.`)):U.window.showInformationMessage("Ricwiz: Operation complete.")}catch{U.window.showInformationMessage("Ricwiz: Operation complete.")}}})}var U,Mt=$(()=>{"use strict";U=v(require("vscode"));R();qe();me()});async function Tt(t=!1){let e=y();if(!e)return;let o=await L.initialize(e);if(!o)return;let i=await J(e,{prompt:"Enter the full ticket ID for the Merge Requests (e.g., SCPSCA-1234) or just the number"});if(!i)return;let{ticketId:s}=i,a=te.workspace.getConfiguration("ricwiz").get("gitlabUrlOverride",""),p="";if(a&&a.trim()!=="")p=a.trim().replace(/\/+$/,"");else{let n="";try{let{stdout:r}=await h("git remote get-url origin",{cwd:e});n=r.trim()}catch{te.window.showErrorMessage("Ricwiz: Could not get the remote origin URL. Please configure the URL manually in the extension settings.");return}p=n,p.endsWith(".git")&&(p=p.slice(0,-4)),p.startsWith("git@")&&(p=p.replace("git@","").replace(":","/"),p=`https://${p}`)}let l=[],d=o.ticketSourceBranch;try{let{stdout:n}=await h(`git config branch.${s}.ricwiz-source`,{cwd:e});n.trim()&&(d=n.trim())}catch{}if(o.environments.length===0)l.push({source:s,target:d});else for(let n of o.environments)l.push({source:`${s}-to-${n.name}`,target:n.sourceBranch});for(let n of l){let r=`${p}/-/merge_requests/new?merge_request[source_branch]=${n.source}&merge_request[target_branch]=${n.target}`;t?te.commands.executeCommand("simpleBrowser.show",r):te.env.openExternal(te.Uri.parse(r))}te.window.showInformationMessage(`Ricwiz: Opening ${t?"VS Code browser":"external browser"} for Merge Requests!`)}async function Dt(){return Tt(!1)}async function At(){return Tt(!0)}var te,It=$(()=>{"use strict";te=v(require("vscode"));R();me()});async function Lt(t=!1){let e=y();if(!e)return;let o=oe.workspace.getConfiguration("ricwiz"),i=o.get("jiraUrl","");if(!i||i.trim()===""){oe.window.showErrorMessage("Ricwiz: Jira URL is not configured. Please set it in the extension settings (e.g., https://jira.company.com/browse/).");return}let{getCurrentBranch:s,resolvePrefix:u,extractTicketSuggestion:a}=(R(),ee(Se)),p=await s(e),l=o.get("ticketPrefix","SFPSCA-"),d=u(p,l),r=a(p,d,!0);if(r){let{normalizeTicketId:m}=(R(),ee(Se));r=m(r,d)}else{let m=await J(e,{prompt:"Ricwiz could not detect the ticket from the branch name. Enter Jira ticket ID (e.g. SFPSCA-1234)",handleToSuffix:!0});if(!m)return;r=m.ticketId}let c=i.trim();c.endsWith("/")||(c+="/"),c+=r,t?oe.commands.executeCommand("simpleBrowser.show",c):oe.env.openExternal(oe.Uri.parse(c)),oe.window.showInformationMessage(`Ricwiz: Opening Jira Ticket ${r} in ${t?"VS Code":"browser"}!`)}async function Ft(){return Lt(!1)}async function Ot(){return Lt(!0)}var oe,Nt=$(()=>{"use strict";oe=v(require("vscode"));R()});async function ii(){let t=jt.workspace.getConfiguration("ricwiz"),e=t.get("jiraUrl",""),o=t.get("jiraEmail","")?.trim(),i=(await ut())?.trim();if(!e||!i)throw new Error('Jira API Token is not securely configured. Please run the "Ricwiz: Set Secure Jira API Token" command.');let s=e;s.includes("/browse")&&(s=s.split("/browse")[0]),s.endsWith("/")&&(s=s.slice(0,-1));let u=o?`Basic ${Buffer.from(`${o}:${i}`).toString("base64")}`:`Bearer ${i}`;return{baseUrl:s,headerAuth:u}}async function Ce(t,e,o){let{baseUrl:i,headerAuth:s}=await ii(),u=new URL(`${i}${e}`);return new Promise((a,p)=>{let l=Ut.request(u,{method:t,headers:{Authorization:s,Accept:"application/json",...o?{"Content-Type":"application/json"}:{}}},d=>{let n="";d.on("data",r=>n+=r),d.on("end",()=>{if(d.statusCode===401||d.statusCode===403)return p(new Error(`Authentication failed (HTTP ${d.statusCode}). Please check your Jira settings.`));if(d.statusCode&&d.statusCode>=400){let r="";try{let c=JSON.parse(n);c.errorMessages&&c.errorMessages.length>0&&(r=c.errorMessages.join(", "))}catch{}return d.statusCode===404||d.statusCode===410?p(new Error(`Ticket not found or deleted (HTTP ${d.statusCode}). ${r}`)):p(new Error(`Jira API returned HTTP status ${d.statusCode}. ${r}`))}if(!n)return a({});try{let r=JSON.parse(n);a(r)}catch{p(new Error("Failed to parse Jira response."))}})});l.on("error",d=>p(new Error(`Network error: ${d.message}`))),o&&l.write(JSON.stringify(o)),l.end()})}async function $e(t){let e=await Ce("GET",`/rest/api/2/issue/${t}`);return e&&e.fields?{summary:e.fields.summary||"",description:e.fields.description||"No description provided."}:null}async function Jt(t){let e=await Ce("GET",`/rest/api/2/issue/${t}/transitions`);return e&&e.transitions?e.transitions.map(o=>({id:o.id,name:o.name})):[]}async function Wt(t,e){await Ce("POST",`/rest/api/2/issue/${t}/transitions`,{transition:{id:e}})}async function qt(t,e){await Ce("POST",`/rest/api/2/issue/${t}/comment`,{body:e})}async function Gt(t,e){await Ce("PUT",`/rest/api/2/issue/${t}`,{update:{labels:[{add:e}]}})}async function Ht(t){let e=await Ce("POST","/rest/api/3/search/jql",{jql:t,maxResults:50,fields:["summary","status","assignee"]});return e&&e.issues?e.issues.map(o=>({key:o.key,summary:o.fields?.summary||"No Title",status:o.fields?.status?.name||"Unknown",assignee:o.fields?.assignee?.displayName||"Unassigned"})):[]}var Ut,jt,Pe=$(()=>{"use strict";Ut=v(require("https")),jt=v(require("vscode"));xe()});async function Xe(){let t=await Ze();return!!(t&&t.trim())}async function Kt(t){let e=Zt.workspace.getConfiguration("ricwiz"),o=(await Ze())?.trim();if(!o)throw new Error("No GitLab token");let i=e.get("gitlabUrlOverride","");if(!i||i.trim()==="")if(Ke)i=Ke;else try{let{stdout:p}=await h("git remote get-url origin",{cwd:t}),l=p.trim();l.endsWith(".git")&&(l=l.slice(0,-4)),l.startsWith("git@")&&(l=l.replace("git@","").replace(":","/"),l=`https://${l}`),i=l,Ke=i}catch{throw new Error("Could not get remote origin URL.")}let s=new URL(i),u=`${s.protocol}//${s.host}`,a=Vt[t];if(!a){let p=s.pathname;p.startsWith("/")&&(p=p.substring(1)),p.endsWith("/")&&(p=p.slice(0,-1)),p.endsWith(".git")&&(p=p.slice(0,-4)),a=encodeURIComponent(p),Vt[t]=a}return{baseUrl:u,token:o,projectPath:a}}async function _t(t,e,o){let{baseUrl:i,token:s}=await Kt(t),u=new URL(`${i}${o}`);return new Promise((a,p)=>{let l=Yt.request(u,{method:e,timeout:5e3,headers:{"PRIVATE-TOKEN":s,Accept:"application/json"}},d=>{let n="";d.on("data",r=>n+=r),d.on("end",()=>{if(d.statusCode&&d.statusCode>=400)return p(new Error(`GitLab API error: ${d.statusCode}`));if(!n)return a({});try{let r=JSON.parse(n);a(r)}catch{p(new Error("Failed to parse GitLab response."))}})});l.on("timeout",()=>{l.destroy(),p(new Error("GitLab request timed out"))}),l.on("error",d=>p(new Error(`Network error: ${d.message}`))),l.end()})}async function et(t,e,o){let i=`${t}:${e}:${o||"any"}`,s=Qt.get(i);if(s&&Date.now()-s.timestamp<ni)return s.data;try{let{projectPath:u}=await Kt(t),a=`/api/v4/projects/${u}/merge_requests?source_branch=${encodeURIComponent(e)}&order_by=updated_at&sort=desc`;o&&(a+=`&target_branch=${encodeURIComponent(o)}`);let p=await _t(t,"GET",a);if(p&&p.length>0){let l=p[0];try{let r=await _t(t,"GET",`/api/v4/projects/${u}/merge_requests/${l.iid}`);r&&(l=r)}catch{}let d="none";if(l.head_pipeline&&l.head_pipeline.status){let r=l.head_pipeline.status;r==="success"||r==="failed"||r==="canceled"||r==="skipped"?d=r:d="running"}let n={isMerged:l.state==="merged",isOpen:l.state==="opened",pipelineStatus:d,webUrl:l.web_url};return Qt.set(i,{data:n,timestamp:Date.now()}),n}return null}catch{return null}}var Yt,Zt,Vt,Ke,Qt,ni,Xt=$(()=>{"use strict";Yt=v(require("https")),Zt=v(require("vscode"));xe();R();Vt={},Ke=null;Qt=new Map,ni=30*1e3});var Ge={};Ye(Ge,{findRelatedBranches:()=>st,getCurrentBranchMergeStatus:()=>ot,getRecentCommits:()=>it,getRecentTickets:()=>nt,getRelatedBranchesStatus:()=>tt});function eo(t,e){return e.find(o=>t.endsWith(`-to-${o.name}`))}async function tt(t,e,o,i){let s=await Xe();return await Promise.all(e.map(async a=>{let p=eo(a,i);if(s){let l=p?p.sourceBranch:void 0,d=await et(t,a,l);if(d)return{name:a,isMerged:d.isMerged,pipelineStatus:d.pipelineStatus,mrUrl:d.webUrl}}return{name:a,isMerged:!1}}))}async function ot(t,e,o){let i=eo(e,o);if(!i)return!1;if(await Xe()){let s=await et(t,e,i.sourceBranch);if(s)return s.isMerged}return!1}async function it(t,e=10){try{let{stdout:o}=await h(`git log --oneline -${e} --format="%h|||%s|||%ar"`,{cwd:t});return o.split(`
...
`,r+=n[f].join(`
`)+`
`;let m=await K.workspace.openTextDocument({content:r,language:"plaintext"});await K.window.showTextDocument(m)}catch(u){K.window.showErrorMessage(`Ricwiz: Error running git log - ${u.message}`)}})}var K,Eo=$(()=>{"use strict";K=v(require("vscode"));R()});async function Mo(){let t=y();if(!t){se.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let o=se.workspace.getConfiguration("ricwiz").get("resetTrackingCommand","sf org disable tracking && sf project reset tracking --no-prompt");await se.window.withProgress({location:se.ProgressLocation.Notification,title:"Ricwiz: Resetting tracking...",cancellable:!1},async()=>{try{let{stdout:i,stderr:s}=await h(o,{cwd:t,maxBuffer:52428800}),u=se.window.createOutputChannel("Ricwiz Reset Tracking");u.appendLine(`Executing: ${o}`),u.appendLine(i),s&&(u.appendLine("--- STDERR ---"),u.appendLine(s)),u.show(),se.window.showInformationMessage("Ricwiz: Successfully reset tracking!")}catch(i){let s=se.window.createOutputChannel("Ricwiz Reset Tracking");s.appendLine(`Error executing: ${o}`),i.stdout&&s.appendLine(i.stdout),i.stderr&&s.appendLine(i.stderr),s.appendLine(i.message),s.show(),se.window.showErrorMessage("Ricwiz: Error resetting tracking. See output channel for details.")}})}var se,To=$(()=>{"use strict";se=v(require("vscode"));R()});async function Do(){let t=y();if(!t){X.window.showErrorMessage("Ricwiz: Open a workspace first.");return}let e=["ApexClass","ApexTrigger","CustomObject","CustomField","LightningComponentBundle","AuraDefinitionBundle","Flow","CustomLabel","CustomMetadata","StaticResource","Profile","PermissionSet","PermissionSetGroup","Layout","ValidationRule","RecordType","ListView","Report","EmailTemplate","Other (Type manually)..."],o=await X.window.showQuickPick(e,{placeHolder:"Select Metadata Type to extract (e.g., ApexClass)",ignoreFocusOut:!0});if(!o||o==="Other (Type manually)..."&&(o=await X.window.showInputBox({prompt:"Enter Metadata Type (e.g., CustomApplication, Queue)",ignoreFocusOut:!0}),!o))return;let i={ApexClass:"**/*.cls",ApexTrigger:"**/*.trigger",CustomObject:"**/*.{object,object-meta.xml}",CustomField:"**/*.field-meta.xml",LightningComponentBundle:"**/lwc/*/*.js",AuraDefinitionBundle:"**/aura/*/*.cmp",Flow:"**/*.flow-meta.xml",CustomLabel:"**/*.labels-meta.xml",CustomMetadata:"**/*.md-meta.xml",StaticResource:"**/*.resource-meta.xml",Profile:"**/*.profile-meta.xml",PermissionSet:"**/*.permissionset-meta.xml",PermissionSetGroup:"**/*.permissionsetgroup-meta.xml",Layout:"**/*.layout-meta.xml",ValidationRule:"**/*.validationRule-meta.xml",RecordType:"**/*.recordType-meta.xml",ListView:"**/*.listView-meta.xml"},s=[],u=i[o];if(u)try{s=(await X.workspace.findFiles(u,"**/node_modules/**")).map(l=>{let d=l.fsPath.split(/[\\/]/).pop()||"";if(o==="LightningComponentBundle"||o==="AuraDefinitionBundle"){let n=l.fsPath.split(/[\\/]/);return n[n.length-2]||d.split(".")[0]}return d.split(".")[0]}),s=[...new Set(s)].sort()}catch{}let a=await new Promise(p=>{let l=X.window.createQuickPick();l.title=`Extract ${o}`,l.placeholder="Type name (e.g. MyComponent) or * for all",l.ignoreFocusOut=!0,l.matchOnDescription=!0;let d=()=>{let n=l.value.trim(),r=[];n?r.push({label:`$(cloud-download) Extract "${n}"`,description:"Extract exact name from Salesforce",alwaysShow:!0}):r.push({label:'$(cloud-download) Extract "*" (All)',description:`Extract all ${o}s`,alwaysShow:!0}),s.forEach(c=>{(!n||c.toLowerCase().includes(n.toLowerCase()))&&r.push({label:c,description:"Local workspace component"})}),l.items=r};l.onDidChangeValue(()=>d()),l.onDidAccept(()=>{let n=l.selectedItems[0];if(n){let r=n.label;r.startsWith('$(cloud-download) Extract "')?r=r.replace('$(cloud-download) Extract "',"").replace('" (All)',"").replace('"',""):r==='$(cloud-download) Extract "*" (All)'&&(r="*"),l.hide(),p(r)}}),l.onDidHide(()=>{l.dispose(),p(void 0)}),d(),l.show()});a&&await X.window.withProgress({location:X.ProgressLocation.Notification,title:`Ricwiz: Extracting ${o}:${a} from Salesforce...`,cancellable:!0},async(p,l)=>{try{A.show(!0);let d=`${o}:${a}`,{stdout:n,stderr:r}=await h(`sf project retrieve start -m "${d}"`,{cwd:t});n&&A.appendLine(n),r&&A.appendLine(r),X.window.showInformationMessage(`Ricwiz: Successfully extracted ${d}.`)}catch(d){A.appendLine(`ERROR: ${d.message}`),d.stdout&&A.appendLine(d.stdout),d.stderr&&A.appendLine(d.stderr),X.window.showErrorMessage("Ricwiz: Extraction failed. See Output channel for details.")}})}var X,Ao=$(()=>{"use strict";X=v(require("vscode"));R()});async function Lo(){let t=j.window.activeTextEditor;if(!t){j.window.showErrorMessage("Ricwiz: Please open the file you want to deploy in the editor first.");return}let e=t.document.uri.fsPath,o=y();if(!o)return;let i="";if(await j.window.withProgress({location:j.ProgressLocation.Notification,title:"Ricwiz: Fetching available Salesforce orgs...",cancellable:!1},async()=>{try{let{stdout:l}=await h("sf org list --json",{cwd:o});i=l}catch(l){i=l.stdout||""}}),!i){j.window.showErrorMessage("Ricwiz: Failed to fetch orgs. Is Salesforce CLI installed?");return}let s=[];try{let l=JSON.parse(i),d=l.result?.nonScratchOrgs||[],n=l.result?.scratchOrgs||[];s=[...d,...n]}catch{j.window.showErrorMessage("Ricwiz: Failed to parse org list.");return}if(s.length===0){j.window.showInformationMessage("Ricwiz: No authenticated orgs found.");return}let u=s.map(l=>({label:l.alias||l.username,description:l.alias?l.username:"",picked:l.isDefaultUsername})),a=await j.window.showQuickPick(u,{placeHolder:"Select the org(s) to deploy this file to",canPickMany:!0,ignoreFocusOut:!0});if(!a||a.length===0)return;let p=Io.basename(e);await j.window.withProgress({location:j.ProgressLocation.Notification,title:`Ricwiz: Deploying ${p} to ${a.length} org(s)...`,cancellable:!1},async()=>{A.show(!0),A.appendLine(`--- Starting Parallel Deploy of ${p} ---`);let l=a.map(async c=>{let m=c.label;A.appendLine(`[${m}] Deploying...`);try{let{stdout:f,stderr:g}=await h(`sf project deploy start -d "${e}" -o "${m}"`,{cwd:o});return A.appendLine(`[${m}] \u2705 Success`),f&&A.appendLine(f),{org:m,success:!0}}catch(f){return A.appendLine(`[${m}] \u274C Failed`),f.stdout&&A.appendLine(f.stdout),f.stderr&&A.appendLine(f.stderr),{org:m,success:!1}}}),d=await Promise.all(l),n=d.filter(c=>c.success).length,r=d.filter(c=>!c.success).length;r===0?j.window.showInformationMessage(`Ricwiz: Successfully deployed to all ${n} orgs!`):j.window.showErrorMessage(`Ricwiz: Deploy finished with errors (${n} success, ${r} failed). Check Output channel.`)})}var j,Io,Fo=$(()=>{"use strict";j=v(require("vscode")),Io=v(require("path"));R()});async function Oo(){let t=y();if(!t){T.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e=T.workspace.getConfiguration("ricwiz"),o=e.get("auditUsername",""),i=e.get("auditHours",8),s=await T.window.showInputBox({prompt:"Enter your Salesforce Username to query in SetupAuditTrail",value:o,placeHolder:"admin@tuaorg.com"});if(!s)return;let u=await T.window.showInputBox({prompt:"How many hours back do you want to search?",value:i.toString(),placeHolder:"8"});if(!u)return;let a=parseFloat(u);if(isNaN(a)||a<=0){T.window.showErrorMessage("Ricwiz: Invalid hours specified.");return}let p=new Date(Date.now()-a*60*60*1e3).toISOString(),d=`sf data query -q "${`SELECT Action, Display, Section FROM SetupAuditTrail WHERE CreatedBy.Username = '${s}' AND CreatedDate >= ${p}`}" --json`;await T.window.withProgress({location:T.ProgressLocation.Notification,title:"Ricwiz: Interrogating Setup Audit Trail...",cancellable:!1},async()=>{try{let{stdout:n}=await h(d,{cwd:t,maxBuffer:52428800}),r=JSON.parse(n);if(!r.result||r.result.records.length===0){T.window.showInformationMessage(`Ricwiz: No changes found for ${s} in the last ${a} hours.`);return}let c=r.result.records,m=[],f=new Set;for(let E of c){let N=si(E.Action,E.Display,E.Section);if(N){let G=`${N.isDelete?"DEL":"ADD"}-${N.metadataFormat}`;if(!f.has(G)){f.add(G);let H=N.isDelete?"$(trash)":"$(plus)";m.push({label:`${H} ${N.metadataFormat}`,description:`${E.Action} -> ${E.Display}`,metadataFormat:N.metadataFormat,isDelete:N.isDelete})}}}if(m.length===0){T.window.showInformationMessage(`Ricwiz: No extractable metadata changes found for ${s} in the last ${a} hours (ignored passwords/logins).`);return}let g=await T.window.showQuickPick(m,{canPickMany:!0,placeHolder:"Select the changes you want to extract to GitLab",ignoreFocusOut:!0});if(!g||g.length===0){T.window.showInformationMessage("Ricwiz: No changes selected.");return}let w=g.filter(E=>E.isDelete),z=g.filter(E=>!E.isDelete),x=T.window.createOutputChannel("Ricwiz Admin Bridge");if(x.show(),w.length>0){let{stdout:E}=await h("git ls-files",{cwd:t}),N=E.split(`
`).map(H=>H.trim()),G=0;for(let H of w){let Ie=H.metadataFormat.split(":"),Le=Ie[0],Re=Ie[1],Fe=Re;Le==="CustomField"&&(Fe=Re.split(".")[1]);let D=N.filter(V=>{let ge=Qe.basename(V);return ge.startsWith(Fe+".")&&ge.includes(Le==="CustomField"?".field":"")});for(let V of D){let ge=Qe.join(t,V);_e.existsSync(ge)&&(_e.unlinkSync(ge),x.appendLine(`Deleted local file: ${V}`),G++)}}T.window.showInformationMessage(`Ricwiz: Deleted ${G} local files from Git workspace.`)}if(z.length===0)return;let P=z.map(E=>E.metadataFormat).filter(E=>E!=="").join(", "),B=await T.window.showInputBox({prompt:"Review and adjust the metadata components to retrieve",value:P,ignoreFocusOut:!0});if(!B)return;let O=`sf project retrieve start -m "${B}"`;x.appendLine(`Executing: ${O}`),T.window.showInformationMessage(`Ricwiz: Extracting ${z.length} components...`);let re=await h(O,{cwd:t});x.appendLine(re.stdout),re.stderr&&(x.appendLine("--- STDERR ---"),x.appendLine(re.stderr)),T.window.showInformationMessage("Ricwiz: Changes extracted successfully! Ready for Git Commit.")}catch(n){T.window.showErrorMessage(`Ricwiz: Error capturing changes - ${n.message}`)}})}function si(t,e,o){if(!t||!e||!o)return null;let i=t.toLowerCase(),s=o.toLowerCase();if(["security controls","network access","session settings","data export","login history","password policies","identity verification","delegated administration"].includes(s)||i.includes("login")||i.includes("password")||i.includes("oauth")||i.includes("session"))return null;let a=i.includes("delete"),p=null;if(i==="permissionsetgroupcomponentadd"||i==="permissionsetgroupcomponentdelete")return null;let l=(d,n=!1)=>{let r=d.replace(/\(.*\)/g,"").trim();r.includes(":")&&!i.includes("calculation")&&(r=r.split(":")[0]);let c=["disabled","deleted","removed","created","changed","updated","from","to","on","assigned","assign","assignment","permission","set","group","apex","class","trigger","custom","field","object","layout","validation","rule","flow","profile"],m=r.split(/\s+/);if(n){for(;m.length>0&&c.includes(m[m.length-1].toLowerCase());)m.pop();for(;m.length>0&&c.includes(m[0].toLowerCase());)m.shift();return m.join(" ").trim().replace(/[^a-zA-Z0-9_ ]/g,"")}else return m.filter(w=>!c.includes(w.toLowerCase())).join("_").replace(/[^a-zA-Z0-9_]/g,"")||r.replace(/\s+/g,"")};if(i.includes("profile"))p=`Profile:${l(e,!0)}`;else if(i.includes("permissionsetgroupcalculation")){let d=e.split(":");p=`PermissionSetGroup:${d.length>1?d[d.length-1].trim():l(e,!1)}`}else if(i.includes("permission set group")||i.includes("permissionsetgroup"))p=`PermissionSetGroup:${l(e,!1)}`;else if(i.includes("permission set")||i.includes("permissionset"))p=`PermissionSet:${l(e,!1)}`;else if(i.includes("apexclass"))p=`ApexClass:${l(e,!1)}`;else if(i.includes("apextrigger")||i.includes("apex trigger"))p=`ApexTrigger:${l(e,!1)}`;else if(i.includes("customfield")){let d=e.match(/([A-Za-z0-9_]+__c)/),n=e.match(/(?:on|na|for)\s+([A-Za-z0-9_]+)/i);d&&n?p=`CustomField:${n[1]}.${d[1]}`:p=`CustomField:${l(e,!1)}`}else if(i.includes("layout"))p=`Layout:${l(e,!0)}`;else if(i.includes("validation"))p=`ValidationRule:${l(e,!1)}`;else if(i.includes("flow"))p=`Flow:${l(e,!1)}`;else if(i.includes("customobject")){let d=e.match(/([A-Za-z0-9_]+__c)/);p=d?`CustomObject:${d[1]}`:`CustomObject:${l(e,!1)}`}else if(!i.includes("created")&&!i.includes("changed")&&!i.includes("deleted"))return null;return p?{metadataFormat:p,isDelete:a}:null}var T,_e,Qe,No=$(()=>{"use strict";T=v(require("vscode")),_e=v(require("fs")),Qe=v(require("path"));R()});async function Uo(){let t=y();if(t)try{let{stdout:e}=await h('git for-each-ref --sort=-committerdate --format="%(refname:short)|||%(committerdate:relative)|||%(subject)" refs/heads/',{cwd:t}),o=e.split(`
`).filter(s=>s.trim()).map(s=>{let u=s.split("|||");return{label:`$(git-branch) ${u[0]}`,description:u[1],detail:u[2],branchName:u[0]}}),i=await at.window.showQuickPick(o,{placeHolder:"Select a branch from history to checkout",matchOnDescription:!0,matchOnDetail:!0});i&&await ze(i.branchName)}catch{at.window.showErrorMessage("Ricwiz: Failed to get branch history")}}var at,jo=$(()=>{"use strict";at=v(require("vscode"));R();He()});async function Jo(){let t=y();if(!t)return;let e=await Te.window.showInputBox({prompt:"Enter ticket number or name (e.g., 48934)",placeHolder:"48934"});if(e)try{let{stdout:o}=await h(`git branch --list "*${e}*"`,{cwd:t}),i=o.split(`
`).map(a=>a.replace("*","").trim()).filter(a=>a);if(i.length===0){Te.window.showInformationMessage(`Ricwiz: No branches found matching "${e}"`);return}let s=i.map(a=>({label:`$(git-branch) ${a}`,branchName:a})),u=await Te.window.showQuickPick(s,{placeHolder:`Select a branch for ${e}`});u&&await ze(u.branchName)}catch{Te.window.showErrorMessage("Ricwiz: Failed to search branches")}}var Te,Wo=$(()=>{"use strict";Te=v(require("vscode"));R();He()});async function Go(){let t=be.window.activeTextEditor;if(!t)return be.window.showErrorMessage("Ricwiz: Please open a file in the editor to check blame."),null;let e=t.document.fileName,o=qo.basename(e),i=y();if(!i)return be.window.showErrorMessage("Ricwiz: Workspace is not a git repository."),null;let s=[];try{let{stdout:n}=await h(`git log -5 --pretty=format:"%an|%ar|%s|%h" -- "${e}"`,{cwd:i}),r=n.trim().split(`
`);for(let c of r){let m=c.split("|");m.length>=4&&s.push({author:m[0],time:m[1],message:m.slice(2,-1).join("|"),hash:m[m.length-1]})}}catch(n){console.error("Git blame error:",n)}let u="Unknown",a="Unknown",p="Unknown",l=[],d=ri(e);if(d)try{await be.window.withProgress({location:be.ProgressLocation.Notification,title:`Ricwiz: Analyzing ${d.name} in Salesforce...`,cancellable:!1},async()=>{let n="";if(d.type==="CustomField"){let r=d.name.split(".");r.length===2&&(n=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM CustomField WHERE DeveloperName = '${r[1].replace("__c","")}' AND TableEnumOrId = '${r[0]}'`)}else d.type==="LightningComponentBundle"?n=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM LightningComponentBundle WHERE DeveloperName = '${d.name}'`:n=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM ${d.type} WHERE Name = '${d.name}'`;if(n)try{let{stdout:r}=await h(`sf data query -t -q "${n}" --json`,{cwd:i,maxBuffer:52428800}),c=JSON.parse(r);if(c&&c.result&&c.result.records&&c.result.records.length>0){let m=c.result.records[0];u=m.LastModifiedBy?m.LastModifiedBy.Name:"Unknown",p=m.CreatedBy?m.CreatedBy.Name:"Unknown",a=new Date(m.LastModifiedDate).toLocaleString()}else u="Not found in Org",a="N/A",p="N/A"}catch{u="Query Error",a="N/A",p="N/A"}try{let r="SELECT Action, Display, CreatedBy.Name, CreatedDate FROM SetupAuditTrail ORDER BY CreatedDate DESC LIMIT 1500",{stdout:c}=await h(`sf data query -q "${r}" --json`,{cwd:i,maxBuffer:52428800}),m=JSON.parse(c);if(m&&m.result&&m.result.records){let f=d.name.replace("__c","");l=m.result.records.filter(w=>w.Display&&w.Display.includes(f)).map(w=>({action:w.Action,display:w.Display,author:w.CreatedBy?w.CreatedBy.Name:"Unknown",time:new Date(w.CreatedDate).toLocaleString()})).slice(0,10)}}catch(r){console.error("Audit trail query error:",r)}})}catch(n){console.error("Salesforce query error:",n)}else u="Unsupported Metadata Type",a="N/A";return{fileName:o,gitHistory:s,sfAuthor:u,sfTime:a,sfCreatedBy:p,auditHistory:l}}function ri(t){let e=t.replace(/\\/g,"/");if(e.includes("/classes/")){let o=e.match(/\/classes\/([^/.]+)\.cls/);if(o)return{type:"ApexClass",name:o[1]}}if(e.includes("/triggers/")){let o=e.match(/\/triggers\/([^/.]+)\.trigger/);if(o)return{type:"ApexTrigger",name:o[1]}}if(e.includes("/lwc/")){let o=e.match(/\/lwc\/([^/]+)\//);if(o)return{type:"LightningComponentBundle",name:o[1]}}if(e.includes("/aura/")){let o=e.match(/\/aura\/([^/]+)\//);if(o)return{type:"AuraDefinitionBundle",name:o[1]}}if(e.includes("/objects/")&&e.includes("/fields/")){let o=e.match(/\/objects\/([^/]+)\//),i=e.match(/\/fields\/([^/.]+)\.field/);if(o&&i)return{type:"CustomField",name:`${o[1]}.${i[1]}`}}return null}var be,qo,Ho=$(()=>{"use strict";be=v(require("vscode")),qo=v(require("path"));R()});function Vo(t,e,o){t.subscriptions.push(k.commands.registerCommand("ricwiz.generateDestructiveChanges",bt),k.commands.registerCommand("ricwiz.runSmartTests",kt),k.commands.registerCommand("ricwiz.refreshWebview",()=>{e&&k.commands.executeCommand("workbench.action.webview.reloadWebviewAction")}),k.commands.registerCommand("ricwiz.createBranches",Rt),k.commands.registerCommand("ricwiz.prepareDeploy",Et),k.commands.registerCommand("ricwiz.createMergeRequests",Dt),k.commands.registerCommand("ricwiz.createMergeRequestsVSCode",At),k.commands.registerCommand("ricwiz.openJiraTicket",Ft),k.commands.registerCommand("ricwiz.openJiraTicketVSCode",Ot),k.commands.registerCommand("ricwiz.showJiraDetails",()=>{e&&to(e)}),k.commands.registerCommand("ricwiz.openJiraDashboard",i=>{e&&io(e,i)}),k.commands.registerCommand("ricwiz.openJiraDetailsForId",i=>{e&&no(e,i)}),k.commands.registerCommand("ricwiz.toggleDashboardBranches",i=>{e&&(e.setDashboardShowBranches(i),k.commands.executeCommand("ricwiz.openJiraDashboard"))}),k.commands.registerCommand("ricwiz.changeJiraStatus",ro),k.commands.registerCommand("ricwiz.addJiraComment",ao),k.commands.registerCommand("ricwiz.addJiraLabel",co),k.commands.registerCommand("ricwiz.setJiraToken",lo),k.commands.registerCommand("ricwiz.setGitlabToken",po),k.commands.registerCommand("ricwiz.syncAll",go),k.commands.registerCommand("ricwiz.updateBases",ho),k.commands.registerCommand("ricwiz.deleteUnusedBranches",vo),k.commands.registerCommand("ricwiz.checkoutBranch",ze),k.commands.registerCommand("ricwiz.copyBranchName",bo),k.commands.registerCommand("ricwiz.generatePackageXml",Co),k.commands.registerCommand("ricwiz.deployPackage",zo),k.commands.registerCommand("ricwiz.importData",So),k.commands.registerCommand("ricwiz.listTicketFiles",Po),k.commands.registerCommand("ricwiz.resetTracking",Mo),k.commands.registerCommand("ricwiz.extractComponent",Do),k.commands.registerCommand("ricwiz.deployMultiOrg",Lo),k.commands.registerCommand("ricwiz.captureAdminChanges",Oo),k.commands.registerCommand("ricwiz.openHistory",Uo),k.commands.registerCommand("ricwiz.searchTicket",Jo),k.commands.registerCommand("ricwiz.whoToBlame",async()=>{let i=await Go();i&&e&&(e.setBlameData(i),e.setPage("blame"))}),k.commands.registerCommand("ricwiz.manualRefresh",()=>{o&&o()}),k.commands.registerCommand("ricwiz.toggleAutoRefresh",()=>{if(e){let i=!e.isAutoRefreshEnabled();e.setAutoRefresh(i),k.workspace.getConfiguration("ricwiz").update("autoRefresh",i,k.ConfigurationTarget.Global)}}),k.commands.registerCommand("ricwiz.openSettings",()=>{k.commands.executeCommand("workbench.action.openSettings","ricwiz")}))}var k,_o=$(()=>{"use strict";k=v(require("vscode"));xt();Ct();St();Mt();It();Nt();oo();so();mo();uo();fo();wo();yo();He();xo();$o();Ro();Bo();Eo();To();Ao();Fo();No();jo();Wo();Ho()});function Qo(t,e,o){let i,s=de.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(s),t.subscriptions.push(de.workspace.onDidChangeConfiguration(a=>{if(a.affectsConfiguration("ricwiz.autoRefresh")){let p=de.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(p)}}));async function u(){let a=de.extensions.getExtension("vscode.git");if(a){let d=function(n){let r="",c;async function m(){let g=de.workspace.workspaceFolders;if(!g)return;let w=g[0].uri.fsPath,z=await I(w);if(z&&z!==r){r=z;let x=de.workspace.getConfiguration("ricwiz"),P=x.get("ticketPrefix","SFPSCA-");if(!z.includes(P)){let D=z.match(/([A-Z]+-)\d+/i);D&&(P=D[1].toUpperCase())}let B=[],O=[],re=[],E=[],N=x.get("environments",[{name:"Qual",sourceBranch:"quality"},{name:"Val",sourceBranch:"validation"},{name:"Prod",sourceBranch:"main"}]);try{let D=x.get("workspaceCheckoutButtons",["main","quality","validation"]);re=Array.from(new Set(D))}catch{}let G="",H=z.match(new RegExp(`(${P}\\d+(?:-\\d+)?)`,"i"));if(H){let D=H[1].toUpperCase();G=D;let V=x.get("commitMessageSuffix","- "),ge=/^[A-Z]+-\d+(?:-\d+)?\s*(?:-\s*|:\s*|\s+)?/i;ge.test(n.inputBox.value)?n.inputBox.value.toUpperCase().startsWith(D)||(n.inputBox.value=n.inputBox.value.replace(ge,`${D}${V}`)):n.inputBox.value=`${D}${V}`+n.inputBox.value,o.text=`$(bookmark) ${D}`,o.tooltip=`Branch: ${z}
Click to open Jira ticket`,o.show();try{let ct=await st(w,D,"");B=await tt(w,ct,D,N)}catch{}}else{o.hide();try{E=await nt(w)}catch{}}let[Ie,Le,Re]=await Promise.all([it(w,10),ot(w,z,N),G?$e(G).catch(D=>{let V=D.message;return(V.includes("ENOTFOUND")||V.includes("network"))&&(V="No Internet or Invalid URL"),{summary:`\u26A0\uFE0F Jira Error: ${V}`,description:""}}):Promise.resolve(null)]);O=Ie;let Fe=Re?Re.summary:"";e?.updateBranch(z,Le,B,O,re,E,Fe)}}function f(){e?.isAutoRefreshEnabled()&&(c&&clearTimeout(c),c=setTimeout(()=>{r="",m()},300))}i=()=>{r="",m()},m(),n.state.onDidChange(()=>f()),de.window.onDidChangeWindowState(g=>{g.focused&&f()})};var p=d;a.isActive||await a.activate();let l=a.exports.getAPI(1);l.repositories.length>0&&l.repositories.forEach(n=>d(n)),l.onDidOpenRepository(n=>d(n))}}return u(),()=>{i&&i()}}var de,Yo=$(()=>{"use strict";de=v(require("vscode"));R();Ee();Pe()});var Je={};Ye(Je,{activate:()=>ai,deactivate:()=>ci,webviewProvider:()=>De});module.exports=ee(Je);function ai(t){mt(t),De=new Ne(t.extensionUri),t.subscriptions.push(Ae.window.registerWebviewViewProvider("ricwiz-webview",De));let e=Ae.window.createStatusBarItem(Ae.StatusBarAlignment.Left,100);e.command="ricwiz.openJiraTicket",t.subscriptions.push(e);let o=Qo(t,De,e);Vo(t,De,o)}function ci(){}var Ae,De,We=$(()=>{Ae=v(require("vscode"));lt();xe();_o();Yo()});We();0&&(module.exports={activate,deactivate,webviewProvider});
