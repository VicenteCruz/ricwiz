"use strict";var Zo=Object.create;var je=Object.defineProperty;var Ko=Object.getOwnPropertyDescriptor;var Xo=Object.getOwnPropertyNames;var ei=Object.getPrototypeOf,ti=Object.prototype.hasOwnProperty;var z=(t,e,o)=>()=>{if(o)throw o[0];try{return t&&(e=t(t=0)),e}catch(s){throw o=[s],s}};var Je=(t,e)=>{for(var o in e)je(t,o,{get:e[o],enumerable:!0})},pt=(t,e,o,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Xo(e))!ti.call(t,r)&&r!==o&&je(t,r,{get:()=>e[r],enumerable:!(s=Ko(e,r))||s.enumerable});return t};var y=(t,e,o)=>(o=t!=null?Zo(ei(t)):{},pt(e||!t||!t.__esModule?je(o,"default",{value:t,enumerable:!0}):o,t)),U=t=>pt(je({},"__esModule",{value:!0}),t);function $(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var k,We,ut=z(()=>{"use strict";k=y(require("vscode"));We=class{constructor(e){this._extensionUri=e}_extensionUri;webviewView;resolveWebviewView(e,o,s){this.webviewView=e,e.webview.options={enableScripts:!0,localResourceRoots:[this._extensionUri]},this.updateBranch("",!1),e.webview.onDidReceiveMessage(r=>{switch(r.command){case"createBranches":k.commands.executeCommand("ricwiz.createBranches");break;case"createBranchForTicket":k.commands.executeCommand("ricwiz.createBranches",r.args);break;case"prepareDeploy":k.commands.executeCommand("ricwiz.prepareDeploy");break;case"openMRs":k.commands.executeCommand("ricwiz.createMergeRequests");break;case"openMRsVSCode":k.commands.executeCommand("ricwiz.createMergeRequestsVSCode");break;case"openExternal":r.args&&k.env.openExternal(k.Uri.parse(r.args));break;case"openJira":k.commands.executeCommand("ricwiz.openJiraTicket");break;case"showJiraDetails":k.commands.executeCommand("ricwiz.showJiraDetails");break;case"changeJiraStatus":k.commands.executeCommand("ricwiz.changeJiraStatus");break;case"addJiraComment":k.commands.executeCommand("ricwiz.addJiraComment");break;case"addJiraLabel":k.commands.executeCommand("ricwiz.addJiraLabel");break;case"setPage":this.setPage(r.args);break;case"openDashboard":k.commands.executeCommand("ricwiz.openJiraDashboard");break;case"openJiraDetailsForId":k.commands.executeCommand("ricwiz.openJiraDetailsForId",r.args);break;case"refreshDashboard":k.commands.executeCommand("ricwiz.openJiraDashboard");break;case"switchDashboardQuery":k.commands.executeCommand("ricwiz.openJiraDashboard",parseInt(r.args));break;case"toggleDashboardBranches":k.commands.executeCommand("ricwiz.toggleDashboardBranches",r.args);break;case"openJiraVSCode":k.commands.executeCommand("ricwiz.openJiraTicketVSCode");break;case"openSettings":k.commands.executeCommand("ricwiz.openSettings");break;case"checkout":r.branch&&k.commands.executeCommand("ricwiz.checkoutBranch",r.branch);break;case"copyBranch":k.commands.executeCommand("ricwiz.copyBranchName");break;case"generatePackageXml":k.commands.executeCommand("ricwiz.generatePackageXml");break;case"openDevTools":this.setPage("devtools");break;case"openMain":this.setPage("main");break;case"generateDestructiveChanges":k.commands.executeCommand("ricwiz.generateDestructiveChanges");break;case"deployPackage":k.commands.executeCommand("ricwiz.deployPackage");break;case"runSmartTests":k.commands.executeCommand("ricwiz.runSmartTests");break;case"importData":k.commands.executeCommand("ricwiz.importData");break;case"listTicketFiles":k.commands.executeCommand("ricwiz.listTicketFiles");break;case"resetTracking":k.commands.executeCommand("ricwiz.resetTracking");break;case"extractComponent":k.commands.executeCommand("ricwiz.extractComponent");break;case"deployMultiOrg":k.commands.executeCommand("ricwiz.deployMultiOrg");break;case"captureAdminChanges":k.commands.executeCommand("ricwiz.captureAdminChanges");break;case"whoToBlame":k.commands.executeCommand("ricwiz.whoToBlame");break;case"syncAll":k.commands.executeCommand("ricwiz.syncAll");break;case"updateBases":k.commands.executeCommand("ricwiz.updateBases");break;case"deleteUnused":k.commands.executeCommand("ricwiz.deleteUnusedBranches");break;case"conflict_commitAndContinue":k.commands.executeCommand("ricwiz.conflictAction","commitAndContinue");break;case"conflict_resolveDeletions":k.commands.executeCommand("ricwiz.conflictAction","resolveDeletions");break;case"conflict_abortDeploy":k.commands.executeCommand("ricwiz.conflictAction","abortDeploy");break;case"openFile":if(r.file){let d=k.workspace.workspaceFolders;if(d){let c=k.Uri.joinPath(d[0].uri,r.file);k.commands.executeCommand("vscode.open",c)}}break;case"searchTicket":k.commands.executeCommand("ricwiz.searchTicket");break;case"manualRefresh":k.commands.executeCommand("ricwiz.manualRefresh");break;case"toggleAutoRefresh":k.commands.executeCommand("ricwiz.toggleAutoRefresh");break;case"openHistory":k.commands.executeCommand("ricwiz.openHistory");break}})}conflictState=null;setConflictState(e){this.conflictState=e,this.updateView()}updateBranch(e,o,s=[],r=[],d=[],c=[],u="",p=""){this.webviewView&&(this.currentBranchCache=e,this.currentBranchIsMergedCache=o,this.relatedBranchesCache=s,this.commitsCache=r,this.baseBranchesCache=d,this.recentTicketsCache=c,this.ticketTitleCache=u,this.ticketStatusCache=p,this.updateView())}currentBranchCache="";currentBranchIsMergedCache=!1;relatedBranchesCache=[];commitsCache=[];baseBranchesCache=[];recentTicketsCache=[];ticketTitleCache="";ticketStatusCache="";currentPage="main";blameDataCache=null;jiraDataCache=null;dashboardDataCache=null;dashboardShowBranches=!1;autoRefreshEnabled=!0;setDashboardShowBranches(e){this.dashboardShowBranches=e}getDashboardShowBranches(){return this.dashboardShowBranches}setBlameData(e){this.blameDataCache=e}setJiraData(e){this.jiraDataCache=e}setDashboardData(e){this.dashboardDataCache=e}setAutoRefresh(e){this.autoRefreshEnabled=e,this.updateView()}isAutoRefreshEnabled(){return this.autoRefreshEnabled}setPage(e){this.currentPage=e,this.updateView()}updateView(){if(!this.webviewView)return;let e=this.webviewView.webview.asWebviewUri(k.Uri.joinPath(this._extensionUri,"resources","logo.png"));this.webviewView.webview.html=this._getHtmlForWebview(e,this.currentBranchCache,this.relatedBranchesCache,this.commitsCache,this.baseBranchesCache,this.recentTicketsCache,this.currentPage)}_getHtmlForWebview(e,o,s,r,d,c,u){let p=r.length>0?`
        ...
        </html>`}}});function gt(t){de=t.secrets}async function ft(t){if(!de)throw new Error("SecretStorage is not initialized.");await de.store("ricwiz.jiraApiToken",t)}async function ht(){if(!de)throw new Error("SecretStorage is not initialized.");return await de.get("ricwiz.jiraApiToken")}async function wt(t){if(!de)throw new Error("SecretStorage is not initialized.");await de.store("ricwiz.gitlabApiToken",t)}async function et(){if(!de)throw new Error("SecretStorage is not initialized.");return await de.get("ricwiz.gitlabApiToken")}var de,Re=z(()=>{"use strict"});var Me={};Je(Me,{checkBranchExists:()=>ge,exec:()=>h,extractTicketSuggestion:()=>Pe,getCurrentBranch:()=>F,getWorkspaceCwd:()=>b,normalizeTicketId:()=>bt,promptForTicketId:()=>W,resolvePrefix:()=>Se,ricwizLogger:()=>L});function b(){let t=ze.workspace.workspaceFolders;if(t)return t[0].uri.fsPath}async function F(t){try{let{stdout:e}=await h("git branch --show-current",{cwd:t});return e.trim()}catch{return""}}function Se(t,e){if(!t.includes(e)){let o=t.match(/([A-Z]+-)\d+/i);if(o)return o[1].toUpperCase()}return e}function Pe(t,e,o=!1){let s=t.match(new RegExp(`(${e}\\d+)`,"i"));return s?s[1].toUpperCase():t.includes(e)&&!t.includes("-to-")?t.substring(t.indexOf(e)):o&&t.includes("-to-")?t.substring(t.indexOf(e)).split("-to-")[0]:""}function bt(t,e){let o=t.trim();return/^\d/.test(o)?`${e}${o}`.toUpperCase():o.toUpperCase()}async function W(t,e){let o=ze.workspace.getConfiguration("ricwiz"),s=e?.prefix??o.get("ticketPrefix","SFPSCA-"),r=await F(t),d=Se(r,s),c=e?.suggestedValue??Pe(r,d,e?.handleToSuffix),u=await ze.window.showInputBox({prompt:e?.prompt||"Enter the full ticket ID (e.g., SCPSCA-1234) or just the number",placeHolder:e?.placeHolder||"Ticket ID or number",value:c});return u?{ticketId:bt(u,d),currentBranch:r,prefix:d}:void 0}async function ge(t,e){try{return await h(`git show-ref --verify --quiet refs/heads/${e}`,{cwd:t}),!0}catch{}try{return await h(`git show-ref --verify --quiet refs/remotes/origin/${e}`,{cwd:t}),!0}catch{}return!1}var ze,vt,yt,oi,L,h,S=z(()=>{"use strict";ze=y(require("vscode")),vt=y(require("child_process")),yt=y(require("util")),oi=yt.promisify(vt.exec),L=ze.window.createOutputChannel("Ricwiz"),h=async(t,e)=>{L.appendLine(`[EXEC] ${t}`);let o=await oi(t,{maxBuffer:50*1024*1024,...e});return{stdout:o.stdout.toString(),stderr:o.stderr.toString()}}});async function xt(){let t=b();if(!t){q.window.showErrorMessage("Ricwiz: Open a workspace that is a Git repository.");return}let o=q.workspace.getConfiguration("ricwiz").get("ticketSourceBranch","main");await q.window.withProgress({location:q.ProgressLocation.Notification,title:`Ricwiz: Finding deleted files compared to origin/${o}...`,cancellable:!1},async()=>{try{let{stdout:s}=await h(`git diff --name-only --diff-filter=D origin/${o}...HEAD`,{cwd:t}),r=s.split(`
...
`,n+=i[g].join(`
`)+`
`;let m=await Z.workspace.openTextDocument({content:n,language:"plaintext"});await Z.window.showTextDocument(m)}catch(d){Z.window.showErrorMessage(`Ricwiz: Error running git log - ${d.message}`)}})}var Z,Eo=z(()=>{"use strict";Z=y(require("vscode"));S()});async function To(){let t=b();if(!t){ne.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let o=ne.workspace.getConfiguration("ricwiz").get("resetTrackingCommand","sf org disable tracking && sf project reset tracking --no-prompt");await ne.window.withProgress({location:ne.ProgressLocation.Notification,title:"Ricwiz: Resetting tracking...",cancellable:!1},async()=>{try{let{stdout:s,stderr:r}=await h(o,{cwd:t,maxBuffer:52428800}),d=ne.window.createOutputChannel("Ricwiz Reset Tracking");d.appendLine(`Executing: ${o}`),d.appendLine(s),r&&(d.appendLine("--- STDERR ---"),d.appendLine(r)),d.show(),ne.window.showInformationMessage("Ricwiz: Successfully reset tracking!")}catch(s){let r=ne.window.createOutputChannel("Ricwiz Reset Tracking");r.appendLine(`Error executing: ${o}`),s.stdout&&r.appendLine(s.stdout),s.stderr&&r.appendLine(s.stderr),r.appendLine(s.message),r.show(),ne.window.showErrorMessage("Ricwiz: Error resetting tracking. See output channel for details.")}})}var ne,Mo=z(()=>{"use strict";ne=y(require("vscode"));S()});async function Do(){let t=b();if(!t){K.window.showErrorMessage("Ricwiz: Open a workspace first.");return}let e=["ApexClass","ApexTrigger","CustomObject","CustomField","LightningComponentBundle","AuraDefinitionBundle","Flow","CustomLabel","CustomMetadata","StaticResource","Profile","PermissionSet","PermissionSetGroup","Layout","ValidationRule","RecordType","ListView","Report","EmailTemplate","Other (Type manually)..."],o=await K.window.showQuickPick(e,{placeHolder:"Select Metadata Type to extract (e.g., ApexClass)",ignoreFocusOut:!0});if(!o||o==="Other (Type manually)..."&&(o=await K.window.showInputBox({prompt:"Enter Metadata Type (e.g., CustomApplication, Queue)",ignoreFocusOut:!0}),!o))return;let s={ApexClass:"**/*.cls",ApexTrigger:"**/*.trigger",CustomObject:"**/*.{object,object-meta.xml}",CustomField:"**/*.field-meta.xml",LightningComponentBundle:"**/lwc/*/*.js",AuraDefinitionBundle:"**/aura/*/*.cmp",Flow:"**/*.flow-meta.xml",CustomLabel:"**/*.labels-meta.xml",CustomMetadata:"**/*.md-meta.xml",StaticResource:"**/*.resource-meta.xml",Profile:"**/*.profile-meta.xml",PermissionSet:"**/*.permissionset-meta.xml",PermissionSetGroup:"**/*.permissionsetgroup-meta.xml",Layout:"**/*.layout-meta.xml",ValidationRule:"**/*.validationRule-meta.xml",RecordType:"**/*.recordType-meta.xml",ListView:"**/*.listView-meta.xml"},r=[],d=s[o];if(d)try{r=(await K.workspace.findFiles(d,"**/node_modules/**")).map(p=>{let l=p.fsPath.split(/[\\/]/).pop()||"";if(o==="LightningComponentBundle"||o==="AuraDefinitionBundle"){let i=p.fsPath.split(/[\\/]/);return i[i.length-2]||l.split(".")[0]}return l.split(".")[0]}),r=[...new Set(r)].sort()}catch{}let c=await new Promise(u=>{let p=K.window.createQuickPick();p.title=`Extract ${o}`,p.placeholder="Type name (e.g. MyComponent) or * for all",p.ignoreFocusOut=!0,p.matchOnDescription=!0;let l=()=>{let i=p.value.trim(),n=[];i?n.push({label:`$(cloud-download) Extract "${i}"`,description:"Extract exact name from Salesforce",alwaysShow:!0}):n.push({label:'$(cloud-download) Extract "*" (All)',description:`Extract all ${o}s`,alwaysShow:!0}),r.forEach(a=>{(!i||a.toLowerCase().includes(i.toLowerCase()))&&n.push({label:a,description:"Local workspace component"})}),p.items=n};p.onDidChangeValue(()=>l()),p.onDidAccept(()=>{let i=p.selectedItems[0];if(i){let n=i.label;n.startsWith('$(cloud-download) Extract "')?n=n.replace('$(cloud-download) Extract "',"").replace('" (All)',"").replace('"',""):n==='$(cloud-download) Extract "*" (All)'&&(n="*"),p.hide(),u(n)}}),p.onDidHide(()=>{p.dispose(),u(void 0)}),l(),p.show()});c&&await K.window.withProgress({location:K.ProgressLocation.Notification,title:`Ricwiz: Extracting ${o}:${c} from Salesforce...`,cancellable:!0},async(u,p)=>{try{L.show(!0);let l=`${o}:${c}`,{stdout:i,stderr:n}=await h(`sf project retrieve start -m "${l}"`,{cwd:t});i&&L.appendLine(i),n&&L.appendLine(n),K.window.showInformationMessage(`Ricwiz: Successfully extracted ${l}.`)}catch(l){L.appendLine(`ERROR: ${l.message}`),l.stdout&&L.appendLine(l.stdout),l.stderr&&L.appendLine(l.stderr),K.window.showErrorMessage("Ricwiz: Extraction failed. See Output channel for details.")}})}var K,Ao=z(()=>{"use strict";K=y(require("vscode"));S()});async function Lo(){let t=J.window.activeTextEditor;if(!t){J.window.showErrorMessage("Ricwiz: Please open the file you want to deploy in the editor first.");return}let e=t.document.uri.fsPath,o=b();if(!o)return;let s="";if(await J.window.withProgress({location:J.ProgressLocation.Notification,title:"Ricwiz: Fetching available Salesforce orgs...",cancellable:!1},async()=>{try{let{stdout:p}=await h("sf org list --json",{cwd:o});s=p}catch(p){s=p.stdout||""}}),!s){J.window.showErrorMessage("Ricwiz: Failed to fetch orgs. Is Salesforce CLI installed?");return}let r=[];try{let p=JSON.parse(s),l=p.result?.nonScratchOrgs||[],i=p.result?.scratchOrgs||[];r=[...l,...i]}catch{J.window.showErrorMessage("Ricwiz: Failed to parse org list.");return}if(r.length===0){J.window.showInformationMessage("Ricwiz: No authenticated orgs found.");return}let d=r.map(p=>({label:p.alias||p.username,description:p.alias?p.username:"",picked:p.isDefaultUsername})),c=await J.window.showQuickPick(d,{placeHolder:"Select the org(s) to deploy this file to",canPickMany:!0,ignoreFocusOut:!0});if(!c||c.length===0)return;let u=Io.basename(e);await J.window.withProgress({location:J.ProgressLocation.Notification,title:`Ricwiz: Deploying ${u} to ${c.length} org(s)...`,cancellable:!1},async()=>{L.show(!0),L.appendLine(`--- Starting Parallel Deploy of ${u} ---`);let p=c.map(async a=>{let m=a.label;L.appendLine(`[${m}] Deploying...`);try{let{stdout:g,stderr:f}=await h(`sf project deploy start -d "${e}" -o "${m}"`,{cwd:o});return L.appendLine(`[${m}] \u2705 Success`),g&&L.appendLine(g),{org:m,success:!0}}catch(g){return L.appendLine(`[${m}] \u274C Failed`),g.stdout&&L.appendLine(g.stdout),g.stderr&&L.appendLine(g.stderr),{org:m,success:!1}}}),l=await Promise.all(p),i=l.filter(a=>a.success).length,n=l.filter(a=>!a.success).length;n===0?J.window.showInformationMessage(`Ricwiz: Successfully deployed to all ${i} orgs!`):J.window.showErrorMessage(`Ricwiz: Deploy finished with errors (${i} success, ${n} failed). Check Output channel.`)})}var J,Io,Fo=z(()=>{"use strict";J=y(require("vscode")),Io=y(require("path"));S()});async function Oo(){let t=b();if(!t){A.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e=A.workspace.getConfiguration("ricwiz"),o=e.get("auditUsername",""),s=e.get("auditHours",8),r=await A.window.showInputBox({prompt:"Enter your Salesforce Username to query in SetupAuditTrail",value:o,placeHolder:"admin@tuaorg.com"});if(!r)return;let d=await A.window.showInputBox({prompt:"How many hours back do you want to search?",value:s.toString(),placeHolder:"8"});if(!d)return;let c=parseFloat(d);if(isNaN(c)||c<=0){A.window.showErrorMessage("Ricwiz: Invalid hours specified.");return}let u=new Date(Date.now()-c*60*60*1e3).toISOString(),l=`sf data query -q "${`SELECT Action, Display, Section FROM SetupAuditTrail WHERE CreatedBy.Username = '${r}' AND CreatedDate >= ${u}`}" --json`;await A.window.withProgress({location:A.ProgressLocation.Notification,title:"Ricwiz: Interrogating Setup Audit Trail...",cancellable:!1},async()=>{try{let{stdout:i}=await h(l,{cwd:t,maxBuffer:52428800}),n=JSON.parse(i);if(!n.result||n.result.records.length===0){A.window.showInformationMessage(`Ricwiz: No changes found for ${r} in the last ${c} hours.`);return}let a=n.result.records,m=[],g=new Set;for(let E of a){let I=ai(E.Action,E.Display,E.Section);if(I){let X=`${I.isDelete?"DEL":"ADD"}-${I.metadataFormat}`;if(!g.has(X)){g.add(X);let H=I.isDelete?"$(trash)":"$(plus)";m.push({label:`${H} ${I.metadataFormat}`,description:`${E.Action} -> ${E.Display}`,metadataFormat:I.metadataFormat,isDelete:I.isDelete})}}}if(m.length===0){A.window.showInformationMessage(`Ricwiz: No extractable metadata changes found for ${r} in the last ${c} hours (ignored passwords/logins).`);return}let f=await A.window.showQuickPick(m,{canPickMany:!0,placeHolder:"Select the changes you want to extract to GitLab",ignoreFocusOut:!0});if(!f||f.length===0){A.window.showInformationMessage("Ricwiz: No changes selected.");return}let w=f.filter(E=>E.isDelete),v=f.filter(E=>!E.isDelete),x=A.window.createOutputChannel("Ricwiz Admin Bridge");if(x.show(),w.length>0){let{stdout:E}=await h("git ls-files",{cwd:t}),I=E.split(`
`).map(H=>H.trim()),X=0;for(let H of w){let ce=H.metadataFormat.split(":"),Ne=ce[0],Ue=ce[1],we=Ue;Ne==="CustomField"&&(we=Ue.split(".")[1]);let Xe=I.filter($e=>{let T=Ke.basename($e);return T.startsWith(we+".")&&T.includes(Ne==="CustomField"?".field":"")});for(let $e of Xe){let T=Ke.join(t,$e);Ze.existsSync(T)&&(Ze.unlinkSync(T),x.appendLine(`Deleted local file: ${$e}`),X++)}}A.window.showInformationMessage(`Ricwiz: Deleted ${X} local files from Git workspace.`)}if(v.length===0)return;let R=v.map(E=>E.metadataFormat).filter(E=>E!=="").join(", "),B=await A.window.showInputBox({prompt:"Review and adjust the metadata components to retrieve",value:R,ignoreFocusOut:!0});if(!B)return;let N=`sf project retrieve start -m "${B}"`;x.appendLine(`Executing: ${N}`),A.window.showInformationMessage(`Ricwiz: Extracting ${v.length} components...`);let ue=await h(N,{cwd:t});x.appendLine(ue.stdout),ue.stderr&&(x.appendLine("--- STDERR ---"),x.appendLine(ue.stderr)),A.window.showInformationMessage("Ricwiz: Changes extracted successfully! Ready for Git Commit.")}catch(i){A.window.showErrorMessage(`Ricwiz: Error capturing changes - ${i.message}`)}})}function ai(t,e,o){if(!t||!e||!o)return null;let s=t.toLowerCase(),r=o.toLowerCase();if(["security controls","network access","session settings","data export","login history","password policies","identity verification","delegated administration"].includes(r)||s.includes("login")||s.includes("password")||s.includes("oauth")||s.includes("session"))return null;let c=s.includes("delete"),u=null;if(s==="permissionsetgroupcomponentadd"||s==="permissionsetgroupcomponentdelete")return null;let p=(l,i=!1)=>{let n=l.replace(/\(.*\)/g,"").trim();n.includes(":")&&!s.includes("calculation")&&(n=n.split(":")[0]);let a=["disabled","deleted","removed","created","changed","updated","from","to","on","assigned","assign","assignment","permission","set","group","apex","class","trigger","custom","field","object","layout","validation","rule","flow","profile"],m=n.split(/\s+/);if(i){for(;m.length>0&&a.includes(m[m.length-1].toLowerCase());)m.pop();for(;m.length>0&&a.includes(m[0].toLowerCase());)m.shift();return m.join(" ").trim().replace(/[^a-zA-Z0-9_ ]/g,"")}else return m.filter(w=>!a.includes(w.toLowerCase())).join("_").replace(/[^a-zA-Z0-9_]/g,"")||n.replace(/\s+/g,"")};if(s.includes("profile"))u=`Profile:${p(e,!0)}`;else if(s.includes("permissionsetgroupcalculation")){let l=e.split(":");u=`PermissionSetGroup:${l.length>1?l[l.length-1].trim():p(e,!1)}`}else if(s.includes("permission set group")||s.includes("permissionsetgroup"))u=`PermissionSetGroup:${p(e,!1)}`;else if(s.includes("permission set")||s.includes("permissionset"))u=`PermissionSet:${p(e,!1)}`;else if(s.includes("apexclass"))u=`ApexClass:${p(e,!1)}`;else if(s.includes("apextrigger")||s.includes("apex trigger"))u=`ApexTrigger:${p(e,!1)}`;else if(s.includes("customfield")){let l=e.match(/([A-Za-z0-9_]+__c)/),i=e.match(/(?:on|na|for)\s+([A-Za-z0-9_]+)/i);l&&i?u=`CustomField:${i[1]}.${l[1]}`:u=`CustomField:${p(e,!1)}`}else if(s.includes("layout"))u=`Layout:${p(e,!0)}`;else if(s.includes("validation"))u=`ValidationRule:${p(e,!1)}`;else if(s.includes("flow"))u=`Flow:${p(e,!1)}`;else if(s.includes("customobject")){let l=e.match(/([A-Za-z0-9_]+__c)/);u=l?`CustomObject:${l[1]}`:`CustomObject:${p(e,!1)}`}else if(!s.includes("created")&&!s.includes("changed")&&!s.includes("deleted"))return null;return u?{metadataFormat:u,isDelete:c}:null}var A,Ze,Ke,No=z(()=>{"use strict";A=y(require("vscode")),Ze=y(require("fs")),Ke=y(require("path"));S()});async function Uo(){let t=b();if(t)try{let{stdout:e}=await h('git for-each-ref --sort=-committerdate --format="%(refname:short)|||%(committerdate:relative)|||%(subject)" refs/heads/',{cwd:t}),o=e.split(`
`).filter(r=>r.trim()).map(r=>{let d=r.split("|||");return{label:`$(git-branch) ${d[0]}`,description:d[1],detail:d[2],branchName:d[0]}}),s=await dt.window.showQuickPick(o,{placeHolder:"Select a branch from history to checkout",matchOnDescription:!0,matchOnDetail:!0});s&&await Te(s.branchName)}catch{dt.window.showErrorMessage("Ricwiz: Failed to get branch history")}}var dt,jo=z(()=>{"use strict";dt=y(require("vscode"));S();Qe()});async function Jo(){let t=b();if(!t)return;let e=await Le.window.showInputBox({prompt:"Enter ticket number or name (e.g., 48934)",placeHolder:"48934"});if(e)try{let{stdout:o}=await h(`git branch --list "*${e}*"`,{cwd:t}),s=o.split(`
`).map(c=>c.replace("*","").trim()).filter(c=>c);if(s.length===0){Le.window.showInformationMessage(`Ricwiz: No branches found matching "${e}"`);return}let r=s.map(c=>({label:`$(git-branch) ${c}`,branchName:c})),d=await Le.window.showQuickPick(r,{placeHolder:`Select a branch for ${e}`});d&&await Te(d.branchName)}catch{Le.window.showErrorMessage("Ricwiz: Failed to search branches")}}var Le,Wo=z(()=>{"use strict";Le=y(require("vscode"));S();Qe()});async function Go(){let t=Ce.window.activeTextEditor;if(!t)return Ce.window.showErrorMessage("Ricwiz: Please open a file in the editor to check blame."),null;let e=t.document.fileName,o=qo.basename(e),s=b();if(!s)return Ce.window.showErrorMessage("Ricwiz: Workspace is not a git repository."),null;let r=[];try{let{stdout:i}=await h(`git log -5 --pretty=format:"%an|%ar|%s|%h" -- "${e}"`,{cwd:s}),n=i.trim().split(`
`);for(let a of n){let m=a.split("|");m.length>=4&&r.push({author:m[0],time:m[1],message:m.slice(2,-1).join("|"),hash:m[m.length-1]})}}catch(i){console.error("Git blame error:",i)}let d="Unknown",c="Unknown",u="Unknown",p=[],l=ci(e);if(l)try{await Ce.window.withProgress({location:Ce.ProgressLocation.Notification,title:`Ricwiz: Analyzing ${l.name} in Salesforce...`,cancellable:!1},async()=>{let i="";if(l.type==="CustomField"){let n=l.name.split(".");n.length===2&&(i=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM CustomField WHERE DeveloperName = '${n[1].replace("__c","")}' AND TableEnumOrId = '${n[0]}'`)}else l.type==="LightningComponentBundle"?i=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM LightningComponentBundle WHERE DeveloperName = '${l.name}'`:i=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM ${l.type} WHERE Name = '${l.name}'`;if(i)try{let{stdout:n}=await h(`sf data query -t -q "${i}" --json`,{cwd:s,maxBuffer:52428800}),a=JSON.parse(n);if(a&&a.result&&a.result.records&&a.result.records.length>0){let m=a.result.records[0];d=m.LastModifiedBy?m.LastModifiedBy.Name:"Unknown",u=m.CreatedBy?m.CreatedBy.Name:"Unknown",c=new Date(m.LastModifiedDate).toLocaleString()}else d="Not found in Org",c="N/A",u="N/A"}catch{d="Query Error",c="N/A",u="N/A"}try{let n="SELECT Action, Display, CreatedBy.Name, CreatedDate FROM SetupAuditTrail ORDER BY CreatedDate DESC LIMIT 1500",{stdout:a}=await h(`sf data query -q "${n}" --json`,{cwd:s,maxBuffer:52428800}),m=JSON.parse(a);if(m&&m.result&&m.result.records){let g=l.name.replace("__c","");p=m.result.records.filter(w=>w.Display&&w.Display.includes(g)).map(w=>({action:w.Action,display:w.Display,author:w.CreatedBy?w.CreatedBy.Name:"Unknown",time:new Date(w.CreatedDate).toLocaleString()})).slice(0,10)}}catch(n){console.error("Audit trail query error:",n)}})}catch(i){console.error("Salesforce query error:",i)}else d="Unsupported Metadata Type",c="N/A";return{fileName:o,gitHistory:r,sfAuthor:d,sfTime:c,sfCreatedBy:u,auditHistory:p}}function ci(t){let e=t.replace(/\\/g,"/");if(e.includes("/classes/")){let o=e.match(/\/classes\/([^/.]+)\.cls/);if(o)return{type:"ApexClass",name:o[1]}}if(e.includes("/triggers/")){let o=e.match(/\/triggers\/([^/.]+)\.trigger/);if(o)return{type:"ApexTrigger",name:o[1]}}if(e.includes("/lwc/")){let o=e.match(/\/lwc\/([^/]+)\//);if(o)return{type:"LightningComponentBundle",name:o[1]}}if(e.includes("/aura/")){let o=e.match(/\/aura\/([^/]+)\//);if(o)return{type:"AuraDefinitionBundle",name:o[1]}}if(e.includes("/objects/")&&e.includes("/fields/")){let o=e.match(/\/objects\/([^/]+)\//),s=e.match(/\/fields\/([^/.]+)\.field/);if(o&&s)return{type:"CustomField",name:`${o[1]}.${s[1]}`}}return null}var Ce,qo,Ho=z(()=>{"use strict";Ce=y(require("vscode")),qo=y(require("path"));S()});function Vo(t,e,o){t.subscriptions.push(C.commands.registerCommand("ricwiz.generateDestructiveChanges",xt),C.commands.registerCommand("ricwiz.runSmartTests",Ct),C.commands.registerCommand("ricwiz.refreshWebview",()=>{e&&C.commands.executeCommand("workbench.action.webview.reloadWebviewAction")}),C.commands.registerCommand("ricwiz.createBranches",Pt),C.commands.registerCommand("ricwiz.prepareDeploy",Ot),C.commands.registerCommand("ricwiz.createMergeRequests",jt),C.commands.registerCommand("ricwiz.createMergeRequestsVSCode",Jt),C.commands.registerCommand("ricwiz.openJiraTicket",Gt),C.commands.registerCommand("ricwiz.openJiraTicketVSCode",Ht),C.commands.registerCommand("ricwiz.showJiraDetails",()=>{e&&to(e)}),C.commands.registerCommand("ricwiz.openJiraDashboard",s=>{e&&io(e,s)}),C.commands.registerCommand("ricwiz.openJiraDetailsForId",s=>{e&&no(e,s)}),C.commands.registerCommand("ricwiz.toggleDashboardBranches",s=>{e&&(e.setDashboardShowBranches(s),C.commands.executeCommand("ricwiz.openJiraDashboard"))}),C.commands.registerCommand("ricwiz.changeJiraStatus",ro),C.commands.registerCommand("ricwiz.addJiraComment",ao),C.commands.registerCommand("ricwiz.addJiraLabel",co),C.commands.registerCommand("ricwiz.setJiraToken",lo),C.commands.registerCommand("ricwiz.setGitlabToken",po),C.commands.registerCommand("ricwiz.syncAll",go),C.commands.registerCommand("ricwiz.updateBases",ho),C.commands.registerCommand("ricwiz.deleteUnusedBranches",vo),C.commands.registerCommand("ricwiz.checkoutBranch",Te),C.commands.registerCommand("ricwiz.copyBranchName",bo),C.commands.registerCommand("ricwiz.generatePackageXml",Co),C.commands.registerCommand("ricwiz.deployPackage",Ro),C.commands.registerCommand("ricwiz.importData",So),C.commands.registerCommand("ricwiz.listTicketFiles",Bo),C.commands.registerCommand("ricwiz.resetTracking",To),C.commands.registerCommand("ricwiz.extractComponent",Do),C.commands.registerCommand("ricwiz.deployMultiOrg",Lo),C.commands.registerCommand("ricwiz.captureAdminChanges",Oo),C.commands.registerCommand("ricwiz.openHistory",Uo),C.commands.registerCommand("ricwiz.searchTicket",Jo),C.commands.registerCommand("ricwiz.whoToBlame",async()=>{let s=await Go();s&&e&&(e.setBlameData(s),e.setPage("blame"))}),C.commands.registerCommand("ricwiz.manualRefresh",()=>{o&&o()}),C.commands.registerCommand("ricwiz.toggleAutoRefresh",()=>{if(e){let s=!e.isAutoRefreshEnabled();e.setAutoRefresh(s),C.workspace.getConfiguration("ricwiz").update("autoRefresh",s,C.ConfigurationTarget.Global)}}),C.commands.registerCommand("ricwiz.openSettings",()=>{C.commands.executeCommand("workbench.action.openSettings","ricwiz")}))}var C,_o=z(()=>{"use strict";C=y(require("vscode"));kt();$t();Bt();Nt();Wt();Vt();oo();so();mo();uo();fo();wo();yo();Qe();xo();$o();zo();Po();Eo();Mo();Ao();Fo();No();jo();Wo();Ho()});function Qo(t,e,o){let s,r=ae.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(r),t.subscriptions.push(ae.workspace.onDidChangeConfiguration(c=>{if(c.affectsConfiguration("ricwiz.autoRefresh")){let u=ae.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(u)}}));async function d(){let c=ae.extensions.getExtension("vscode.git");if(c){let l=function(i){let n="",a;async function m(){let f=ae.workspace.workspaceFolders;if(!f)return;let w=f[0].uri.fsPath,v=await F(w);if(v&&v!==n){n=v;let x=ae.workspace.getConfiguration("ricwiz"),R=x.get("ticketPrefix","SFPSCA-");if(!v.includes(R)){let T=v.match(/([A-Z]+-)\d+/i);T&&(R=T[1].toUpperCase())}let B=[],N=[],ue=[],E=[],I=await D.initialize(w,{skipPrompt:!0}),X=I?.environments||x.get("environments",[{name:"Qual",sourceBranch:"quality"},{name:"Val",sourceBranch:"validation"},{name:"Prod",sourceBranch:"main"}]);try{let T=x.get("workspaceCheckoutButtons",["main","quality","validation"]);ue=Array.from(new Set(T))}catch{}let H="",ce=v.match(new RegExp(`(${R}\\d+(?:-\\d+)?)`,"i"));if(ce){let T=ce[1].toUpperCase();H=T;let ve=x.get("commitMessageSuffix","- "),lt=/^[A-Z]+-\d+(?:-\d+)?\s*(?:-\s*|:\s*|\s+)?/i;lt.test(i.inputBox.value)?i.inputBox.value.toUpperCase().startsWith(T)||(i.inputBox.value=i.inputBox.value.replace(lt,`${T}${ve}`)):i.inputBox.value=`${T}${ve}`+i.inputBox.value,o.text=`$(bookmark) ${T}`,o.tooltip=`Branch: ${v}
Click to open Jira ticket`,o.show();try{let mt=await at(w,T,"");B=await it(w,mt,T,X,I)}catch{}}else{o.hide();try{E=await rt(w)}catch{}}let[Ne,Ue,we]=await Promise.all([st(w,10),nt(w,v,X,I),H?Ee(H).catch(T=>{let ve=T.message;return(ve.includes("ENOTFOUND")||ve.includes("network"))&&(ve="No Internet or Invalid URL"),{summary:`\u26A0\uFE0F Jira Error: ${ve}`,description:"",status:""}}):Promise.resolve(null)]);N=Ne;let Xe=we?we.summary:"",$e=we&&we.status||"";e?.updateBranch(v,Ue,B,N,ue,E,Xe,$e)}}function g(){e?.isAutoRefreshEnabled()&&(a&&clearTimeout(a),a=setTimeout(()=>{n="",m()},300))}s=()=>{n="",m()},m(),i.state.onDidChange(()=>g()),ae.window.onDidChangeWindowState(f=>{f.focused&&g()})};var u=l;c.isActive||await c.activate();let p=c.exports.getAPI(1);p.repositories.length>0&&p.repositories.forEach(i=>l(i)),p.onDidOpenRepository(i=>l(i))}}return d(),()=>{s&&s()}}var ae,Yo=z(()=>{"use strict";ae=y(require("vscode"));S();he();Ae();ee()});var He={};Je(He,{activate:()=>di,deactivate:()=>li,webviewProvider:()=>Fe});module.exports=U(He);function di(t){gt(t),Fe=new We(t.extensionUri),t.subscriptions.push(Oe.window.registerWebviewViewProvider("ricwiz-webview",Fe));let e=Oe.window.createStatusBarItem(Oe.StatusBarAlignment.Left,100);e.command="ricwiz.openJiraTicket",t.subscriptions.push(e);let o=Qo(t,Fe,e);Vo(t,Fe,o)}function li(){}var Oe,Fe,Ve=z(()=>{Oe=y(require("vscode"));ut();Re();_o();Yo()});Ve();0&&(module.exports={activate,deactivate,webviewProvider});
