                ...
                for (const env of environments) {
                    ...
                    if (await (0, git_1.checkBranchExists)(cwd, envBranchName)) {
                        ...
                        try {
                            ...
                            try {
                                await (0, git_1.exec)(`git checkout -b ${envBranchName} ${sourceBranch}`, { cwd });
                                createdLocalBranches.push(envBranchName);
                            }
                            catch (err) {
