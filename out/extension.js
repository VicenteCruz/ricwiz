"use strict";var Fo=Object.create;var Ae=Object.defineProperty;var Oo=Object.getOwnPropertyDescriptor;var No=Object.getOwnPropertyNames;var jo=Object.getPrototypeOf,Jo=Object.prototype.hasOwnProperty;var k=(t,e,i)=>()=>{if(i)throw i[0];try{return t&&(e=t(t=0)),e}catch(r){throw i=[r],r}};var _e=(t,e)=>{for(var i in e)Ae(t,i,{get:e[i],enumerable:!0})},Ze=(t,e,i,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of No(e))!Jo.call(t,s)&&s!==i&&Ae(t,s,{get:()=>e[s],enumerable:!(r=Oo(e,s))||r.enumerable});return t};var y=(t,e,i)=>(i=t!=null?Fo(jo(t)):{},Ze(e||!t||!t.__esModule?Ae(i,"default",{value:t,enumerable:!0}):i,t)),ge=t=>Ze(Ae({},"__esModule",{value:!0}),t);function z(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var b,Ie,Xe=k(()=>{"use strict";b=y(require("vscode"));Ie=class{constructor(e){this._extensionUri=e}_extensionUri;webviewView;resolveWebviewView(e,i,r){this.webviewView=e,e.webview.options={enableScripts:!0,localResourceRoots:[this._extensionUri]},this.updateBranch("",!1),e.webview.onDidReceiveMessage(s=>{switch(s.command){case"createBranches":b.commands.executeCommand("ricwiz.createBranches");break;case"prepareDeploy":b.commands.executeCommand("ricwiz.prepareDeploy");break;case"openMRs":b.commands.executeCommand("ricwiz.createMergeRequests");break;case"openMRsVSCode":b.commands.executeCommand("ricwiz.createMergeRequestsVSCode");break;case"openJira":b.commands.executeCommand("ricwiz.openJiraTicket");break;case"showJiraDetails":b.commands.executeCommand("ricwiz.showJiraDetails");break;case"changeJiraStatus":b.commands.executeCommand("ricwiz.changeJiraStatus");break;case"addJiraComment":b.commands.executeCommand("ricwiz.addJiraComment");break;case"addJiraLabel":b.commands.executeCommand("ricwiz.addJiraLabel");break;case"setPage":this.setPage(s.args);break;case"openDashboard":b.commands.executeCommand("ricwiz.openJiraDashboard");break;case"openJiraDetailsForId":b.commands.executeCommand("ricwiz.openJiraDetailsForId",s.args);break;case"refreshDashboard":b.commands.executeCommand("ricwiz.openJiraDashboard");break;case"switchDashboardQuery":b.commands.executeCommand("ricwiz.openJiraDashboard",parseInt(s.args));break;case"openJiraVSCode":b.commands.executeCommand("ricwiz.openJiraTicketVSCode");break;case"openSettings":b.commands.executeCommand("ricwiz.openSettings");break;case"checkout":s.branch&&b.commands.executeCommand("ricwiz.checkoutBranch",s.branch);break;case"copyBranch":b.commands.executeCommand("ricwiz.copyBranchName");break;case"generatePackageXml":b.commands.executeCommand("ricwiz.generatePackageXml");break;case"openDevTools":this.setPage("devtools");break;case"openMain":this.setPage("main");break;case"generateDestructiveChanges":b.commands.executeCommand("ricwiz.generateDestructiveChanges");break;case"deployPackage":b.commands.executeCommand("ricwiz.deployPackage");break;case"runSmartTests":b.commands.executeCommand("ricwiz.runSmartTests");break;case"importData":b.commands.executeCommand("ricwiz.importData");break;case"listTicketFiles":b.commands.executeCommand("ricwiz.listTicketFiles");break;case"resetTracking":b.commands.executeCommand("ricwiz.resetTracking");break;case"extractComponent":b.commands.executeCommand("ricwiz.extractComponent");break;case"deployMultiOrg":b.commands.executeCommand("ricwiz.deployMultiOrg");break;case"captureAdminChanges":b.commands.executeCommand("ricwiz.captureAdminChanges");break;case"whoToBlame":b.commands.executeCommand("ricwiz.whoToBlame");break;case"syncAll":b.commands.executeCommand("ricwiz.syncAll");break;case"updateBases":b.commands.executeCommand("ricwiz.updateBases");break;case"deleteUnused":b.commands.executeCommand("ricwiz.deleteUnusedBranches");break;case"conflict_commitAndContinue":b.commands.executeCommand("ricwiz.conflictAction","commitAndContinue");break;case"conflict_resolveDeletions":b.commands.executeCommand("ricwiz.conflictAction","resolveDeletions");break;case"conflict_abortDeploy":b.commands.executeCommand("ricwiz.conflictAction","abortDeploy");break;case"openFile":if(s.file){let m=b.workspace.workspaceFolders;if(m){let a=b.Uri.joinPath(m[0].uri,s.file);b.commands.executeCommand("vscode.open",a)}}break;case"searchTicket":b.commands.executeCommand("ricwiz.searchTicket");break;case"manualRefresh":b.commands.executeCommand("ricwiz.manualRefresh");break;case"toggleAutoRefresh":b.commands.executeCommand("ricwiz.toggleAutoRefresh");break;case"openHistory":b.commands.executeCommand("ricwiz.openHistory");break}})}conflictState=null;setConflictState(e){this.conflictState=e,this.updateView()}updateBranch(e,i,r=[],s=[],m=[],a=[],f=""){this.webviewView&&(this.currentBranchCache=e,this.currentBranchIsMergedCache=i,this.relatedBranchesCache=r,this.commitsCache=s,this.baseBranchesCache=m,this.recentTicketsCache=a,this.ticketTitleCache=f,this.updateView())}currentBranchCache="";currentBranchIsMergedCache=!1;relatedBranchesCache=[];commitsCache=[];baseBranchesCache=[];recentTicketsCache=[];ticketTitleCache="";currentPage="main";blameDataCache=null;jiraDataCache=null;dashboardDataCache=null;autoRefreshEnabled=!0;setBlameData(e){this.blameDataCache=e}setJiraData(e){this.jiraDataCache=e}setDashboardData(e){this.dashboardDataCache=e}setAutoRefresh(e){this.autoRefreshEnabled=e,this.updateView()}isAutoRefreshEnabled(){return this.autoRefreshEnabled}setPage(e){this.currentPage=e,this.updateView()}updateView(){if(!this.webviewView)return;let e=this.webviewView.webview.asWebviewUri(b.Uri.joinPath(this._extensionUri,"resources","logo.png"));this.webviewView.webview.html=this._getHtmlForWebview(e,this.currentBranchCache,this.relatedBranchesCache,this.commitsCache,this.baseBranchesCache,this.recentTicketsCache,this.currentPage)}_getHtmlForWebview(e,i,r,s,m,a,f){let u=s.length>0?`
...
`).map(d=>d.trimRight()).filter(d=>d.length>2).filter(d=>{let c=d.substring(0,2);return["UU","AA","UD","DU","AU","UA","DD"].includes(c)}).map(d=>{let c=d.substring(0,2);return{file:d.substring(3).trim(),state:n(c)}})}catch{return[]}},u=async()=>{if(s)return;let o=await a(),n=await f(),{webviewProvider:d}=(Je(),ge(je));d&&d.setConflictState({isConflict:!0,sourceStr:e,targetStr:i,deletionsCount:o.length,files:n})},l=te.commands.registerCommand("ricwiz.conflictAction",async o=>{if(o==="abortDeploy")m=!0;else if(o==="resolveDeletions"){try{let d=(await a()).map(g=>({label:g})),c=await te.window.showQuickPick(d,{canPickMany:!0,placeHolder:"Select conflicted files to DELETE",title:"Ricwiz: Delete Conflicted Files"});if(c&&c.length>0){for(let g of c)try{await p(`git rm --force "${g.label}"`,{cwd:t})}catch{}te.window.showInformationMessage(`Ricwiz: Deleted ${c.length} conflicted file(s).`)}}catch(n){te.window.showErrorMessage(`Ricwiz: Error. (${n.message})`)}u()}else if(o==="commitAndContinue")try{let d=(await a()).filter(g=>ft.existsSync(ht.join(t,g)));if(d.length>0&&await te.window.showWarningMessage(`Wait! There are ${d.length} file(s) with deletion conflicts that are still on your disk.

If you commit now, you will KEEP them in the project.

Are you sure you want to KEEP them?`,{modal:!0},"Yes, KEEP them","No, let me DELETE them")!=="Yes, KEEP them"){u();return}let c=!1;try{let{stdout:g}=await p('git grep -E "^<<<<<<< "',{cwd:t});g.trim().length>0&&(c=!0)}catch{}if(c){te.window.showErrorMessage("Ricwiz: You still have unresolved conflict markers (<<<<<<<) in your files. Please resolve them first!"),u();return}await p("git add .",{cwd:t}),await p("git commit --no-edit",{cwd:t})}catch(n){te.window.showErrorMessage(`Ricwiz: Could not commit automatically. (${n.message})`),u()}});for(u();;){if(m){s=!0,l.dispose(),(Je(),ge(je)).webviewProvider?.setConflictState(null);try{await p("git merge --abort",{cwd:t})}catch{}return!1}try{let{stdout:o}=await p("git status --porcelain",{cwd:t});if(o.trim().length===0)return s=!0,l.dispose(),(Je(),ge(je)).webviewProvider?.setConflictState(null),te.window.showInformationMessage("Ricwiz: Changes committed!"),!0}catch{}await new Promise(o=>setTimeout(o,2e3))}}var te,ft,ht,Ue=k(()=>{"use strict";te=y(require("vscode")),ft=y(require("fs")),ht=y(require("path"));$()});async function wt(){let t=v();if(!t){F.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}try{await p("git status",{cwd:t})}catch{F.window.showErrorMessage("Ricwiz: The opened folder does not appear to be a valid Git repository.");return}let e=await A.initialize(t);if(!e)return;let i=e.environments,r=await N(t,{prefix:e.ticketPrefix});if(!r){F.window.showErrorMessage("Operation cancelled: Ticket not provided.");return}let{ticketId:s,currentBranch:m}=r,a=s;if(!await de(t,a)){F.window.showErrorMessage(`Ricwiz: Main branch '${a}' does not exist! Prepare deploy is only available when a main ticket branch is used.`);return}let f=e.getConfig("defaultReviewers",""),u="";try{let{stdout:l}=await p(`git config branch.${s}.ricwiz-reviewers`,{cwd:t});u=l.trim()}catch{}if(f.trim()){let l=await F.window.showInputBox({prompt:"Ricwiz: Reviewers for this deploy (optional, comma-separated)",placeHolder:"e.g. @joao, 123456",value:u||f,ignoreFocusOut:!0});if(l===void 0)return;try{l.trim()?await p(`git config branch.${s}.ricwiz-reviewers "${l.trim()}"`,{cwd:t}):u&&await p(`git config --unset branch.${s}.ricwiz-reviewers`,{cwd:t})}catch{}}await F.window.withProgress({location:F.ProgressLocation.Notification,title:"Ricwiz: Preparing Deploy",cancellable:!0},async(l,o)=>{let n=0,d=m,c=!1;o.onCancellationRequested(()=>{c=!0}),l.report({message:"Syncing remote information...",increment:10});try{await p("git fetch --all",{cwd:t});let h=10/(i.length||1);for(let w of i)try{if(c)throw new Error("Aborted");l.report({message:`Fetching ${w.sourceBranch}...`,increment:h});let R=e.getFetchRemote(w.sourceBranch),S=e.getFetchBranch(w.sourceBranch);await p(`git fetch ${R} ${S}:${S}`,{cwd:t})}catch{}}catch{}let g=60/(i.length||1);for(let h of i){if(c)break;let w=`${s}-to-${h.name}`,R=h.sourceBranch;try{l.report({message:`Processing ${w}...`,increment:g/4}),await p(`git checkout ${w}`,{cwd:t});try{await p(`git pull ${e.originRemote} ${w}`,{cwd:t})}catch{}let S=async K=>{try{await p(`git merge ${K}`,{cwd:t})}catch(P){let L=!1;try{let{stdout:U}=await p("git ls-files -u",{cwd:t});U.trim().length>0&&(L=!0)}catch{}let J=((P.stdout||"")+(P.stderr||"")+(P.message||"")).toLowerCase();if(L||J.includes("conflict")||J.includes("conflit")){if(!await he(t,K,w,l))throw c=!0,new Error("Deploy aborted by user.")}else throw P}};l.report({message:`Merging ${R} into ${w}...`,increment:g/4});let ae=e.getFetchRemote(R),ue=e.getFetchBranch(R),pe=e.buildUpstreamPath(R);if(await p(`git fetch ${ae} ${ue}`,{cwd:t}),await S(pe),l.report({message:`Merging ${a} into ${w}...`,increment:g/4}),await S(a),c)break;l.report({message:`Pushing ${w}...`,increment:g/4}),await p(`git push ${e.originRemote} ${w}`,{cwd:t}),n++}catch(S){S.message.includes("aborted")?F.window.showInformationMessage("Ricwiz: Deploy cancelled."):F.window.showErrorMessage(`Ricwiz: Failed to process branch ${w}. Detail: ${S.message}`);return}}if(!c){l.report({message:"Finishing up...",increment:10});let h=d;try{await p(`git show-ref --verify --quiet refs/heads/${a}`,{cwd:t}),h=a}catch{}try{let w=await T(t);h&&h!==w?(await p(`git checkout ${h}`,{cwd:t}),F.window.showInformationMessage(`Ricwiz: Operation complete. Back on branch ${h}.`)):F.window.showInformationMessage("Ricwiz: Operation complete.")}catch{F.window.showInformationMessage("Ricwiz: Operation complete.")}}})}var F,vt=k(()=>{"use strict";F=y(require("vscode"));$();Ue();re()});async function yt(t=!1){let e=v();if(!e)return;let i=await A.initialize(e);if(!i)return;let r=await N(e,{prompt:"Enter the full ticket ID for the Merge Requests (e.g., SCPSCA-1234) or just the number"});if(!r)return;let{ticketId:s}=r,a=Y.workspace.getConfiguration("ricwiz").get("gitlabUrlOverride",""),f="";if(a&&a.trim()!=="")f=a.trim();else{let o="";try{let{stdout:n}=await p("git remote get-url origin",{cwd:e});o=n.trim()}catch{Y.window.showErrorMessage("Ricwiz: Could not get the remote origin URL. Please configure the URL manually in the extension settings.");return}f=o,f.endsWith(".git")&&(f=f.slice(0,-4)),f.startsWith("git@")&&(f=f.replace("git@","").replace(":","/"),f=`https://${f}`)}let u=[],l=i.ticketSourceBranch;try{let{stdout:o}=await p(`git config branch.${s}.ricwiz-source`,{cwd:e});o.trim()&&(l=o.trim())}catch{}if(i.environments.length===0)u.push({source:s,target:l});else for(let o of i.environments)u.push({source:`${s}-to-${o.name}`,target:o.sourceBranch});for(let o of u){let n=`${f}/-/merge_requests/new?merge_request[source_branch]=${o.source}&merge_request[target_branch]=${o.target}`;t?Y.commands.executeCommand("simpleBrowser.show",n):Y.env.openExternal(Y.Uri.parse(n))}Y.window.showInformationMessage(`Ricwiz: Opening ${t?"VS Code browser":"external browser"} for Merge Requests!`)}async function bt(){return yt(!1)}async function xt(){return yt(!0)}var Y,kt=k(()=>{"use strict";Y=y(require("vscode"));$();re()});async function Ct(t=!1){let e=v();if(!e)return;let i=_.workspace.getConfiguration("ricwiz"),r=i.get("jiraUrl","");if(!r||r.trim()===""){_.window.showErrorMessage("Ricwiz: Jira URL is not configured. Please set it in the extension settings (e.g., https://jira.company.com/browse/).");return}let{getCurrentBranch:s,resolvePrefix:m,extractTicketSuggestion:a}=($(),ge(Fe)),f=await s(e),u=i.get("ticketPrefix","SFPSCA-"),l=m(f,u),n=a(f,l,!0);if(n){let{normalizeTicketId:c}=($(),ge(Fe));n=c(n,l)}else{let c=await N(e,{prompt:"Ricwiz could not detect the ticket from the branch name. Enter Jira ticket ID (e.g. SFPSCA-1234)",handleToSuffix:!0});if(!c)return;n=c.ticketId}let d=r.trim();d.endsWith("/")||(d+="/"),d+=n,t?_.commands.executeCommand("simpleBrowser.show",d):_.env.openExternal(_.Uri.parse(d)),_.window.showInformationMessage(`Ricwiz: Opening Jira Ticket ${n} in ${t?"VS Code":"browser"}!`)}async function $t(){return Ct(!1)}async function zt(){return Ct(!0)}var _,Rt=k(()=>{"use strict";_=y(require("vscode"));$()});async function Wo(){let t=Pt.workspace.getConfiguration("ricwiz"),e=t.get("jiraUrl",""),i=t.get("jiraEmail","")?.trim(),r=(await tt())?.trim();if(!e||!r)throw new Error('Jira API Token is not securely configured. Please run the "Ricwiz: Set Secure Jira API Token" command.');let s=e;s.includes("/browse")&&(s=s.split("/browse")[0]),s.endsWith("/")&&(s=s.slice(0,-1));let m=i?`Basic ${Buffer.from(`${i}:${r}`).toString("base64")}`:`Bearer ${r}`;return{baseUrl:s,headerAuth:m}}async function be(t,e,i){let{baseUrl:r,headerAuth:s}=await Wo(),m=new URL(`${r}${e}`);return new Promise((a,f)=>{let u=St.request(m,{method:t,headers:{Authorization:s,Accept:"application/json",...i?{"Content-Type":"application/json"}:{}}},l=>{let o="";l.on("data",n=>o+=n),l.on("end",()=>{if(l.statusCode===401||l.statusCode===403)return f(new Error(`Authentication failed (HTTP ${l.statusCode}). Please check your Jira settings.`));if(l.statusCode&&l.statusCode>=400){let n="";try{let d=JSON.parse(o);d.errorMessages&&d.errorMessages.length>0&&(n=d.errorMessages.join(", "))}catch{}return l.statusCode===404||l.statusCode===410?f(new Error(`Ticket not found or deleted (HTTP ${l.statusCode}). ${n}`)):f(new Error(`Jira API returned HTTP status ${l.statusCode}. ${n}`))}if(!o)return a({});try{let n=JSON.parse(o);a(n)}catch{f(new Error("Failed to parse Jira response."))}})});u.on("error",l=>f(new Error(`Network error: ${l.message}`))),i&&u.write(JSON.stringify(i)),u.end()})}async function xe(t){let e=await be("GET",`/rest/api/2/issue/${t}`);return e&&e.fields?{summary:e.fields.summary||"",description:e.fields.description||"No description provided."}:null}async function Bt(t){let e=await be("GET",`/rest/api/2/issue/${t}/transitions`);return e&&e.transitions?e.transitions.map(i=>({id:i.id,name:i.name})):[]}async function Et(t,e){await be("POST",`/rest/api/2/issue/${t}/transitions`,{transition:{id:e}})}async function Dt(t,e){await be("POST",`/rest/api/2/issue/${t}/comment`,{body:e})}async function Mt(t,e){await be("PUT",`/rest/api/2/issue/${t}`,{update:{labels:[{add:e}]}})}async function Tt(t){let e=await be("POST","/rest/api/3/search",{jql:t,maxResults:50,fields:["summary","status","assignee"]});return e&&e.issues?e.issues.map(i=>({key:i.key,summary:i.fields?.summary||"No Title",status:i.fields?.status?.name||"Unknown",assignee:i.fields?.assignee?.displayName||"Unassigned"})):[]}var St,Pt,Re=k(()=>{"use strict";St=y(require("https")),Pt=y(require("vscode"));Le()});async function At(t){let e=v();if(e)try{if(!await A.initialize(e))return;let s=(await T(e)).split("-to-")[0];if(!s){oe.window.showErrorMessage("Ricwiz: You are not currently on a valid ticket branch.");return}await oe.window.withProgress({location:oe.ProgressLocation.Notification,title:`Fetching details for ${s}...`,cancellable:!1},async m=>{let a=await xe(s);a?(t.setJiraData({ticketId:s,...a}),t.setPage("jira")):oe.window.showErrorMessage("Ricwiz: No data found for this ticket.")})}catch(i){i.message.includes("securely configured")?await oe.window.showErrorMessage(i.message,"Set Token Now")==="Set Token Now"&&oe.commands.executeCommand("ricwiz.setJiraToken"):oe.window.showErrorMessage(`Ricwiz Jira Error: ${i.message}`)}}var oe,It=k(()=>{"use strict";oe=y(require("vscode"));$();re();Re()});async function Lt(t,e){let r=me.workspace.getConfiguration("ricwiz").get("jiraDashboards",[]);if(e!==void 0&&(we=e),!r||r.length===0){t.setDashboardData({queries:[],selectedIndex:0,results:[],error:"No queries defined in settings. Go to Settings > Ricwiz > Jira Dashboards."}),t.setPage("dashboard");return}we>=r.length&&(we=0);let s=r[we];t.setDashboardData({queries:r,selectedIndex:we,results:[],error:"\u23F3 Loading tickets..."}),t.setPage("dashboard");try{let m=await Tt(s.jql);t.setDashboardData({queries:r,selectedIndex:we,results:m,error:null}),t.setPage("dashboard")}catch(m){let a=m.message;(a.includes("ENOTFOUND")||a.includes("network"))&&(a="No Internet or Invalid URL"),t.setDashboardData({queries:r,selectedIndex:we,results:[],error:a}),t.setPage("dashboard")}}async function Ft(t,e){await me.window.withProgress({location:me.ProgressLocation.Notification,title:`Fetching details for ${e}...`,cancellable:!1},async()=>{try{let i=await xe(e);i?(t.setJiraData({ticketId:e,...i}),t.setPage("jira")):me.window.showErrorMessage(`Ricwiz: No data found for ticket ${e}.`)}catch(i){me.window.showErrorMessage(`Ricwiz Jira Error: ${i.message}`)}})}var me,we,Ot=k(()=>{"use strict";me=y(require("vscode"));Re();we=0});async function Ge(){let t=v();return!t||!await A.initialize(t,{forcePrompt:!1})?void 0:(await T(t)).split("-to-")[0]}async function Nt(){try{let t=await Ge();if(!t){C.window.showErrorMessage("Ricwiz: You are not on a valid ticket branch.");return}let e=await C.window.withProgress({location:C.ProgressLocation.Notification,title:`Fetching available status for ${t}...`,cancellable:!1},()=>Bt(t));if(!e||e.length===0){C.window.showInformationMessage(`Ricwiz: No transitions available for ${t}.`);return}let i=e.map(s=>({label:s.name,id:s.id})),r=await C.window.showQuickPick(i,{placeHolder:`Select new status for ${t}`,ignoreFocusOut:!0});r&&(await C.window.withProgress({location:C.ProgressLocation.Notification,title:`Updating status to ${r.label}...`,cancellable:!1},()=>Et(t,r.id)),C.window.showInformationMessage(`Ricwiz: Status for ${t} updated to ${r.label}.`))}catch(t){t.message.includes("securely configured")?C.window.showErrorMessage(t.message,"Set Token Now").then(e=>{e==="Set Token Now"&&C.commands.executeCommand("ricwiz.setJiraToken")}):C.window.showErrorMessage(`Ricwiz Jira Error: ${t.message}`)}}async function jt(){try{let t=await Ge();if(!t){C.window.showErrorMessage("Ricwiz: You are not on a valid ticket branch.");return}let e=await C.window.showInputBox({prompt:`Add comment to ${t}`,placeHolder:"Type your comment here...",ignoreFocusOut:!0});e&&(await C.window.withProgress({location:C.ProgressLocation.Notification,title:`Adding comment to ${t}...`,cancellable:!1},()=>Dt(t,e)),C.window.showInformationMessage(`Ricwiz: Comment added to ${t}.`))}catch(t){t.message.includes("securely configured")?C.window.showErrorMessage(t.message,"Set Token Now").then(e=>{e==="Set Token Now"&&C.commands.executeCommand("ricwiz.setJiraToken")}):C.window.showErrorMessage(`Ricwiz Jira Error: ${t.message}`)}}async function Jt(){try{let t=await Ge();if(!t){C.window.showErrorMessage("Ricwiz: You are not on a valid ticket branch.");return}let e=await C.window.showInputBox({prompt:`Add a label to ${t}`,placeHolder:"e.g. Needs-Review, Bug, High-Priority",ignoreFocusOut:!0});e&&e.trim()&&(await C.window.withProgress({location:C.ProgressLocation.Notification,title:`Adding label to ${t}...`,cancellable:!1},()=>Mt(t,e.trim())),C.window.showInformationMessage(`Ricwiz: Label '${e.trim()}' added to ${t}.`))}catch(t){t.message.includes("securely configured")?C.window.showErrorMessage(t.message,"Set Token Now").then(e=>{e==="Set Token Now"&&C.commands.executeCommand("ricwiz.setJiraToken")}):C.window.showErrorMessage(`Ricwiz Jira Error: ${t.message}`)}}async function Ut(){let t=await C.window.showInputBox({prompt:"Enter your Jira API Token (or Personal Access Token). It will be securely stored in your OS keychain.",password:!0,ignoreFocusOut:!0});if(t)try{await et(t.trim()),C.window.showInformationMessage("Ricwiz: Jira API Token securely stored!")}catch(e){C.window.showErrorMessage(`Ricwiz: Failed to store token: ${e.message}`)}}var C,Wt=k(()=>{"use strict";C=y(require("vscode"));$();re();Re();Le()});async function qt(){let t=v();if(!t){se.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e=await A.initialize(t);if(!e)return;let i=await N(t,{prefix:e.ticketPrefix,prompt:"Enter the full ticket ID to sync all branches for (e.g., SCPSCA-1234) or just the number"});if(!i)return;let{ticketId:r,currentBranch:s}=i;await se.window.withProgress({location:se.ProgressLocation.Notification,title:`Ricwiz: Syncing all branches for ${r}...`,cancellable:!1},async m=>{try{m.report({message:"Fetching from remote..."});try{await p("git fetch --all",{cwd:t})}catch{}let{stdout:a}=await p(`git branch --list "*${r}*"`,{cwd:t}),f=a.split(`
`).map(o=>o.replace("*","").trim()).filter(o=>o.length>0);if(f.length===0){se.window.showWarningMessage(`Ricwiz: No local branches found for ${r}.`);return}let u=0,l=0;for(let o of f)if(m.report({message:`Syncing ${o}...`}),o===s)try{await p(`git pull ${e.originRemote} ${o}`,{cwd:t}),u++}catch(n){let d=!1;try{let{stdout:g}=await p("git ls-files -u",{cwd:t});g.trim().length>0&&(d=!0)}catch{}let c=((n.stdout||"")+(n.stderr||"")+(n.message||"")).toLowerCase();(d||c.includes("conflict")||c.includes("conflit"))&&await he(t,`${e.originRemote}/${o}`,o,m)?u++:l++}else try{await p(`git fetch ${e.originRemote} ${o}:${o}`,{cwd:t}),u++}catch{try{await p(`git checkout ${o}`,{cwd:t});try{await p(`git pull ${e.originRemote} ${o}`,{cwd:t}),u++}catch(d){let c=!1;try{let{stdout:h}=await p("git ls-files -u",{cwd:t});h.trim().length>0&&(c=!0)}catch{}let g=((d.stdout||"")+(d.stderr||"")+(d.message||"")).toLowerCase();(c||g.includes("conflict")||g.includes("conflit"))&&await he(t,`${e.originRemote}/${o}`,o,m)?u++:l++}await p(`git checkout ${s}`,{cwd:t})}catch{try{await p(`git checkout ${s}`,{cwd:t})}catch{}l++}}l>0?se.window.showWarningMessage(`Ricwiz: Synced ${u}/${f.length} branches. ${l} branch(es) could not be synced (possible conflicts or diverged history).`):se.window.showInformationMessage(`Ricwiz: \u{1F504} All ${u} branches for ${r} are up to date!`)}catch(a){se.window.showErrorMessage(`Ricwiz: Sync failed: ${a.message}`)}})}var se,Ht=k(()=>{"use strict";se=y(require("vscode"));$();Ue();re()});async function Vt(){let t=v();if(!t){ne.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}try{await p("git status",{cwd:t})}catch{ne.window.showErrorMessage("Ricwiz: The opened folder does not appear to be a valid Git repository.");return}let e=await A.initialize(t);if(!e)return;let i=e.environments,r=await N(t,{prefix:e.ticketPrefix});if(!r)return;let{ticketId:s,currentBranch:m}=r;await ne.window.withProgress({location:ne.ProgressLocation.Notification,title:"Ricwiz: Updating environment branches from their bases",cancellable:!0},async(a,f)=>{let u=0,l=m,o=!1;f.onCancellationRequested(()=>{o=!0}),a.report({message:"Syncing remote information...",increment:10});try{await p("git fetch --all",{cwd:t})}catch{}let n=80/(i.length||1);for(let d of i){if(o)break;let c=`${s}-to-${d.name}`,g=d.sourceBranch;if(await de(t,c))try{a.report({message:`Processing ${c}...`,increment:n/2}),await p(`git checkout ${c}`,{cwd:t});try{a.report({message:`Merging ${g} into ${c}...`,increment:n/2});let h=e.getFetchRemote(g),w=e.getFetchBranch(g),R=e.buildUpstreamPath(g);await p(`git fetch ${h} ${w}`,{cwd:t}),await p(`git merge ${R}`,{cwd:t})}catch(h){let w=!1;try{let{stdout:S}=await p("git ls-files -u",{cwd:t});S.trim().length>0&&(w=!0)}catch{}let R=((h.stdout||"")+(h.stderr||"")+(h.message||"")).toLowerCase();if(w||R.includes("conflict")||R.includes("conflit")){let S=e.buildUpstreamPath(g);if(!await he(t,S,c,a))throw o=!0,new Error("Update aborted by user.")}else throw h}if(o)break;u++}catch(h){h.message.includes("aborted")?ne.window.showInformationMessage("Ricwiz: Update cancelled."):ne.window.showErrorMessage(`Ricwiz: Failed to update branch ${c}. Detail: ${h.message}`);return}}if(!o){a.report({message:"Finishing up...",increment:10});try{let d=await T(t);l&&l!==d&&await p(`git checkout ${l}`,{cwd:t})}catch{}ne.window.showInformationMessage(`Ricwiz: Successfully updated ${u} environment branches from their bases!`)}})}var ne,Gt=k(()=>{"use strict";ne=y(require("vscode"));$();Ue();re()});async function Qt(){let t=v();if(!t){I.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e=await T(t),i=I.workspace.getConfiguration("ricwiz");await I.window.withProgress({location:I.ProgressLocation.Notification,title:"Ricwiz: Scanning for unused local branches...",cancellable:!1},async()=>{try{await p("git fetch --prune",{cwd:t})}catch{}let r=[];try{let{stdout:n}=await p('git branch --format="%(refname:short)"',{cwd:t});r=n.split(`
`).map(d=>d.trim()).filter(d=>d.length>0)}catch{}if(r.length===0){I.window.showInformationMessage("Ricwiz: No local branches found.");return}let s=[];try{let{stdout:n}=await p('git branch -r --format="%(refname:short)"',{cwd:t});s=n.split(`
...
`).filter(d=>d.includes("[gone]")).map(d=>d.split("|||")[0].trim())}catch{}let a=r.filter(n=>!s.includes(n));if(a.length===0){I.window.showInformationMessage("Ricwiz: Your local repository is totally clean! All local branches exist on the remote.");return}let f=a.map(n=>{let d=m.includes(n),c=n===e,g="Not found on remote";return d&&(g="Deleted on remote [gone]"),c&&(g+=" (Current branch - will checkout main first)"),{label:n,description:g,picked:d&&!c}}),u=await I.window.showQuickPick(f,{canPickMany:!0,placeHolder:"Select local branches to delete",title:"Ricwiz: Delete Unused Branches"});if(!u||u.length===0){I.window.showInformationMessage("Ricwiz: No branches selected for deletion.");return}if(await I.window.showWarningMessage(`Ricwiz: Delete ${u.length} local branch(es)?
This cannot be undone!`,{modal:!0},"Yes, delete them")!=="Yes, delete them"){I.window.showInformationMessage("Ricwiz: Deletion cancelled.");return}let o=0;for(let n of u){let d=n.label;if(d===e){let c=i.get("ticketSourceBranch","main");try{await p(`git checkout ${c}`,{cwd:t}),e=c}catch{I.window.showWarningMessage(`Ricwiz: Could not switch away from ${d}. Skipping.`);continue}}try{await p(`git branch -D ${d}`,{cwd:t}),o++}catch{I.window.showWarningMessage(`Ricwiz: Could not delete local branch ${d}.`)}}I.window.showInformationMessage(`Ricwiz: \u{1F5D1}\uFE0F Cleaned up ${o} unused local branch(es).`)})}var I,Yt=k(()=>{"use strict";I=y(require("vscode"));$()});async function ke(t){let e=v();e&&await Z.window.withProgress({location:Z.ProgressLocation.Notification,title:`Ricwiz: Switching to ${t}...`,cancellable:!1},async()=>{try{let i=await T(e),r=!1;try{let{stdout:m}=await p("git status --porcelain",{cwd:e});r=m.trim().length>0}catch{}if(r&&i)try{await p(`git stash push --include-untracked -m "ricwiz-auto:${i}"`,{cwd:e}),Z.window.showInformationMessage(`Ricwiz: \u{1F4E6} Stashed changes from ${i}`)}catch{Z.window.showWarningMessage("Ricwiz: Could not stash changes. Checkout may fail if there are conflicts.")}let s=t;t.includes("/")&&(s=t.split("/").slice(1).join("/"));try{await p(`git checkout ${s}`,{cwd:e})}catch{let a="";if(t.includes("/"))a=t.split("/")[0];else{let{stdout:f}=await p("git branch -r",{cwd:e}),u=f.split(`
`).map(o=>o.trim()).filter(o=>o),l=[];for(let o of u){let n=o.split(" ")[0];n.endsWith(`/${s}`)&&l.push(n.substring(0,n.lastIndexOf("/")))}if(l.length===0){Z.window.showErrorMessage(`Ricwiz: A branch "${s}" n\xE3o existe localmente nem em nenhuma remote!`);return}else if(l.length===1)a=l[0];else{let o=await A.initialize(e);l.includes("origin")?a="origin":o&&l.includes(o.upstreamRemote)?a=o.upstreamRemote:a=l[0]}}try{await p(`git fetch ${a} ${s}`,{cwd:e}),await p(`git checkout -b ${s} --track ${a}/${s}`,{cwd:e})}catch{Z.window.showErrorMessage(`Ricwiz: Encontrou na remote ${a} mas falhou a fazer checkout.`);return}}try{let{stdout:m}=await p("git stash list",{cwd:e}),a=m.split(`
`);for(let f=0;f<a.length;f++)if(a[f].includes(`ricwiz-auto:${s}`)){let u=a[f].match(/stash@\{(\d+)\}/);u&&(await p(`git stash pop stash@{${u[1]}}`,{cwd:e}),Z.window.showInformationMessage(`Ricwiz: \u{1F4E6} Restored stashed changes on ${s}`));break}}catch{Z.window.showWarningMessage(`Ricwiz: Could not restore stashed changes on ${s}. You may need to resolve conflicts manually (check git stash list).`)}}catch{Z.window.showErrorMessage(`Ricwiz: Could not checkout branch ${t}.`)}})}var Z,We=k(()=>{"use strict";Z=y(require("vscode"));$();re()});async function _t(){let t=v();if(t)try{let{stdout:e}=await p("git branch --show-current",{cwd:t}),i=e.trim();i&&(await Se.env.clipboard.writeText(i),Se.window.showInformationMessage(`Ricwiz: \u{1F4CB} Copied "${i}" to clipboard`))}catch{Se.window.showErrorMessage("Ricwiz: Could not get the current branch name.")}}var Se,Zt=k(()=>{"use strict";Se=y(require("vscode"));$()});async function Kt(){let t=v();if(!t){q.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e=q.workspace.getConfiguration("ricwiz"),i=e.get("ticketSourceBranch","main"),s=e.get("packageXmlCommand",'sf sgd source delta --to "HEAD" --from "origin/{baseBranch}" --output-dir "."').replace("{baseBranch}",i);await q.window.showWarningMessage("Are you sure you want to generate the package.xml? This may overwrite existing local manifest files.",{modal:!0},"Yes, Generate")==="Yes, Generate"&&await q.window.withProgress({location:q.ProgressLocation.Notification,title:"Ricwiz: Generating package.xml using Salesforce CLI...",cancellable:!1},async()=>{try{await p(s,{cwd:t,maxBuffer:10*1024*1024}),q.window.showInformationMessage("Ricwiz: Successfully generated package.xml!");let a=qe.join(t,"package","package.xml"),f=qe.join(t,"package.xml"),u=qe.join(t,"manifest","package.xml");for(let l of[a,f,u])if(Xt.existsSync(l)){let o=await q.workspace.openTextDocument(l);await q.window.showTextDocument(o);break}}catch(a){q.window.showErrorMessage(`Ricwiz: Error running sf command - ${a.message}`)}})}var q,qe,Xt,eo=k(()=>{"use strict";q=y(require("vscode")),qe=y(require("path")),Xt=y(require("fs"));$()});async function to(){let t=v();if(!t){H.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let i=H.workspace.getConfiguration("ricwiz").get("deployCommand","sf project deploy start --manifest package/package.xml --post-destructive-changes destructiveChanges/destructiveChanges.xml -c -l NoTestRun -g");await H.window.showWarningMessage("Are you sure you want to deploy to Salesforce? This action modifies your org and cannot be easily undone.",{modal:!0},"Yes, Deploy")==="Yes, Deploy"&&await H.window.withProgress({location:H.ProgressLocation.Notification,title:"Ricwiz: Deploying package...",cancellable:!1},async()=>{try{let{stdout:s,stderr:m}=await p(i,{cwd:t,maxBuffer:52428800}),a=H.window.createOutputChannel("Ricwiz Deploy");a.appendLine(`Executing: ${i}`),a.appendLine(s),m&&(a.appendLine("--- STDERR ---"),a.appendLine(m)),a.show(),H.window.showInformationMessage("Ricwiz: Successfully ran deploy command!")}catch(s){let m=H.window.createOutputChannel("Ricwiz Deploy");m.appendLine(`Error executing: ${i}`),s.stdout&&m.appendLine(s.stdout),s.stderr&&m.appendLine(s.stderr),m.appendLine(s.message),m.show(),H.window.showErrorMessage("Ricwiz: Error running deploy command. See output channel for details.")}})}var H,oo=k(()=>{"use strict";H=y(require("vscode"));$()});async function io(){let t=v();if(!t){V.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let i=V.workspace.getConfiguration("ricwiz").get("importDataCommand","sfdx force:data:tree:import --plan data/plan.json");await V.window.showWarningMessage("Are you sure you want to import data into Salesforce? This action modifies records in your org.",{modal:!0},"Yes, Import")==="Yes, Import"&&await V.window.withProgress({location:V.ProgressLocation.Notification,title:"Ricwiz: Importing data...",cancellable:!1},async()=>{try{let{stdout:s,stderr:m}=await p(i,{cwd:t,maxBuffer:52428800}),a=V.window.createOutputChannel("Ricwiz Import Data");a.appendLine(`Executing: ${i}`),a.appendLine(s),m&&(a.appendLine("--- STDERR ---"),a.appendLine(m)),a.show(),V.window.showInformationMessage("Ricwiz: Successfully ran import data command!")}catch(s){let m=V.window.createOutputChannel("Ricwiz Import Data");m.appendLine(`Error executing: ${i}`),s.stdout&&m.appendLine(s.stdout),s.stderr&&m.appendLine(s.stderr),m.appendLine(s.message),m.show(),V.window.showErrorMessage("Ricwiz: Error running import data command. See output channel for details.")}})}var V,ro=k(()=>{"use strict";V=y(require("vscode"));$()});async function so(){let t=v();if(!t){G.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e="";try{e=await T(t)}catch{}let r=G.workspace.getConfiguration("ricwiz").get("ticketSourceBranch","main"),s=await G.window.showInputBox({prompt:`Enter the branch name to list modified files (compared to ${r})`,value:e,placeHolder:"SFPSCA-1234"});s&&await G.window.withProgress({location:G.ProgressLocation.Notification,title:`Ricwiz: Finding files for ${s}...`,cancellable:!1},async()=>{try{let m=s.replace(/-to-[a-zA-Z0-9]+$/i,""),a=[];try{let g="";try{let{stdout:h}=await p(`git merge-base origin/${r} ${s}`,{cwd:t});g=h.trim()}catch{let{stdout:h}=await p(`git merge-base ${r} ${s}`,{cwd:t});g=h.trim()}if(g){let{stdout:h}=await p(`git diff --name-only ${g} ${s}`,{cwd:t,maxBuffer:10485760});a=h.split(`
...
`).map(h=>h.trim()).filter(h=>h.length>0)}catch{}let u=[...a,...f];if(u.length===0){G.window.showInformationMessage(`Ricwiz: No modified files found for ${s}.`);return}let l=Array.from(new Set(u)).sort(),o={};for(let g of l){let h=g.match(/default\/([^/]+)/),w=h&&h[1]?h[1].toUpperCase():"OUTROS";o[w]||(o[w]=[]),o[w].push(g)}let n=`Files modified in branch ${s}:
`,d=Object.keys(o).sort();for(let g of d)n+=`
=== ${g} ===
`,n+=o[g].join(`
`)+`
`;let c=await G.workspace.openTextDocument({content:n,language:"plaintext"});await G.window.showTextDocument(c)}catch(m){G.window.showErrorMessage(`Ricwiz: Error running git log - ${m.message}`)}})}var G,no=k(()=>{"use strict";G=y(require("vscode"));$()});async function ao(){let t=v();if(!t){X.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let i=X.workspace.getConfiguration("ricwiz").get("resetTrackingCommand","sf org disable tracking && sf project reset tracking --no-prompt");await X.window.withProgress({location:X.ProgressLocation.Notification,title:"Ricwiz: Resetting tracking...",cancellable:!1},async()=>{try{let{stdout:r,stderr:s}=await p(i,{cwd:t,maxBuffer:52428800}),m=X.window.createOutputChannel("Ricwiz Reset Tracking");m.appendLine(`Executing: ${i}`),m.appendLine(r),s&&(m.appendLine("--- STDERR ---"),m.appendLine(s)),m.show(),X.window.showInformationMessage("Ricwiz: Successfully reset tracking!")}catch(r){let s=X.window.createOutputChannel("Ricwiz Reset Tracking");s.appendLine(`Error executing: ${i}`),r.stdout&&s.appendLine(r.stdout),r.stderr&&s.appendLine(r.stderr),s.appendLine(r.message),s.show(),X.window.showErrorMessage("Ricwiz: Error resetting tracking. See output channel for details.")}})}var X,co=k(()=>{"use strict";X=y(require("vscode"));$()});async function lo(){let t=v();if(!t){Q.window.showErrorMessage("Ricwiz: Open a workspace first.");return}let e=["ApexClass","ApexTrigger","CustomObject","CustomField","LightningComponentBundle","AuraDefinitionBundle","Flow","CustomLabel","CustomMetadata","StaticResource","Profile","PermissionSet","PermissionSetGroup","Layout","ValidationRule","RecordType","ListView","Report","EmailTemplate","Other (Type manually)..."],i=await Q.window.showQuickPick(e,{placeHolder:"Select Metadata Type to extract (e.g., ApexClass)",ignoreFocusOut:!0});if(!i||i==="Other (Type manually)..."&&(i=await Q.window.showInputBox({prompt:"Enter Metadata Type (e.g., CustomApplication, Queue)",ignoreFocusOut:!0}),!i))return;let r={ApexClass:"**/*.cls",ApexTrigger:"**/*.trigger",CustomObject:"**/*.{object,object-meta.xml}",CustomField:"**/*.field-meta.xml",LightningComponentBundle:"**/lwc/*/*.js",AuraDefinitionBundle:"**/aura/*/*.cmp",Flow:"**/*.flow-meta.xml",CustomLabel:"**/*.labels-meta.xml",CustomMetadata:"**/*.md-meta.xml",StaticResource:"**/*.resource-meta.xml",Profile:"**/*.profile-meta.xml",PermissionSet:"**/*.permissionset-meta.xml",PermissionSetGroup:"**/*.permissionsetgroup-meta.xml",Layout:"**/*.layout-meta.xml",ValidationRule:"**/*.validationRule-meta.xml",RecordType:"**/*.recordType-meta.xml",ListView:"**/*.listView-meta.xml"},s=[],m=r[i];if(m)try{s=(await Q.workspace.findFiles(m,"**/node_modules/**")).map(u=>{let l=u.fsPath.split(/[\\/]/).pop()||"";if(i==="LightningComponentBundle"||i==="AuraDefinitionBundle"){let o=u.fsPath.split(/[\\/]/);return o[o.length-2]||l.split(".")[0]}return l.split(".")[0]}),s=[...new Set(s)].sort()}catch{}let a=await new Promise(f=>{let u=Q.window.createQuickPick();u.title=`Extract ${i}`,u.placeholder="Type name (e.g. MyComponent) or * for all",u.ignoreFocusOut=!0,u.matchOnDescription=!0;let l=()=>{let o=u.value.trim(),n=[];o?n.push({label:`$(cloud-download) Extract "${o}"`,description:"Extract exact name from Salesforce",alwaysShow:!0}):n.push({label:'$(cloud-download) Extract "*" (All)',description:`Extract all ${i}s`,alwaysShow:!0}),s.forEach(d=>{(!o||d.toLowerCase().includes(o.toLowerCase()))&&n.push({label:d,description:"Local workspace component"})}),u.items=n};u.onDidChangeValue(()=>l()),u.onDidAccept(()=>{let o=u.selectedItems[0];if(o){let n=o.label;n.startsWith('$(cloud-download) Extract "')?n=n.replace('$(cloud-download) Extract "',"").replace('" (All)',"").replace('"',""):n==='$(cloud-download) Extract "*" (All)'&&(n="*"),u.hide(),f(n)}}),u.onDidHide(()=>{u.dispose(),f(void 0)}),l(),u.show()});a&&await Q.window.withProgress({location:Q.ProgressLocation.Notification,title:`Ricwiz: Extracting ${i}:${a} from Salesforce...`,cancellable:!0},async(f,u)=>{try{M.show(!0);let l=`${i}:${a}`,{stdout:o,stderr:n}=await p(`sf project retrieve start -m "${l}"`,{cwd:t});o&&M.appendLine(o),n&&M.appendLine(n),Q.window.showInformationMessage(`Ricwiz: Successfully extracted ${l}.`)}catch(l){M.appendLine(`ERROR: ${l.message}`),l.stdout&&M.appendLine(l.stdout),l.stderr&&M.appendLine(l.stderr),Q.window.showErrorMessage("Ricwiz: Extraction failed. See Output channel for details.")}})}var Q,mo=k(()=>{"use strict";Q=y(require("vscode"));$()});async function po(){let t=O.window.activeTextEditor;if(!t){O.window.showErrorMessage("Ricwiz: Please open the file you want to deploy in the editor first.");return}let e=t.document.uri.fsPath,i=v();if(!i)return;let r="";if(await O.window.withProgress({location:O.ProgressLocation.Notification,title:"Ricwiz: Fetching available Salesforce orgs...",cancellable:!1},async()=>{try{let{stdout:u}=await p("sf org list --json",{cwd:i});r=u}catch(u){r=u.stdout||""}}),!r){O.window.showErrorMessage("Ricwiz: Failed to fetch orgs. Is Salesforce CLI installed?");return}let s=[];try{let u=JSON.parse(r),l=u.result?.nonScratchOrgs||[],o=u.result?.scratchOrgs||[];s=[...l,...o]}catch{O.window.showErrorMessage("Ricwiz: Failed to parse org list.");return}if(s.length===0){O.window.showInformationMessage("Ricwiz: No authenticated orgs found.");return}let m=s.map(u=>({label:u.alias||u.username,description:u.alias?u.username:"",picked:u.isDefaultUsername})),a=await O.window.showQuickPick(m,{placeHolder:"Select the org(s) to deploy this file to",canPickMany:!0,ignoreFocusOut:!0});if(!a||a.length===0)return;let f=uo.basename(e);await O.window.withProgress({location:O.ProgressLocation.Notification,title:`Ricwiz: Deploying ${f} to ${a.length} org(s)...`,cancellable:!1},async()=>{M.show(!0),M.appendLine(`--- Starting Parallel Deploy of ${f} ---`);let u=a.map(async d=>{let c=d.label;M.appendLine(`[${c}] Deploying...`);try{let{stdout:g,stderr:h}=await p(`sf project deploy start -d "${e}" -o "${c}"`,{cwd:i});return M.appendLine(`[${c}] \u2705 Success`),g&&M.appendLine(g),{org:c,success:!0}}catch(g){return M.appendLine(`[${c}] \u274C Failed`),g.stdout&&M.appendLine(g.stdout),g.stderr&&M.appendLine(g.stderr),{org:c,success:!1}}}),l=await Promise.all(u),o=l.filter(d=>d.success).length,n=l.filter(d=>!d.success).length;n===0?O.window.showInformationMessage(`Ricwiz: Successfully deployed to all ${o} orgs!`):O.window.showErrorMessage(`Ricwiz: Deploy finished with errors (${o} success, ${n} failed). Check Output channel.`)})}var O,uo,go=k(()=>{"use strict";O=y(require("vscode")),uo=y(require("path"));$()});async function fo(){let t=v();if(!t){E.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e=E.workspace.getConfiguration("ricwiz"),i=e.get("auditUsername",""),r=e.get("auditHours",8),s=await E.window.showInputBox({prompt:"Enter your Salesforce Username to query in SetupAuditTrail",value:i,placeHolder:"admin@tuaorg.com"});if(!s)return;let m=await E.window.showInputBox({prompt:"How many hours back do you want to search?",value:r.toString(),placeHolder:"8"});if(!m)return;let a=parseFloat(m);if(isNaN(a)||a<=0){E.window.showErrorMessage("Ricwiz: Invalid hours specified.");return}let f=new Date(Date.now()-a*60*60*1e3).toISOString(),l=`sf data query -q "${`SELECT Action, Display, Section FROM SetupAuditTrail WHERE CreatedBy.Username = '${s}' AND CreatedDate >= ${f}`}" --json`;await E.window.withProgress({location:E.ProgressLocation.Notification,title:"Ricwiz: Interrogating Setup Audit Trail...",cancellable:!1},async()=>{try{let{stdout:o}=await p(l,{cwd:t,maxBuffer:52428800}),n=JSON.parse(o);if(!n.result||n.result.records.length===0){E.window.showInformationMessage(`Ricwiz: No changes found for ${s} in the last ${a} hours.`);return}let d=n.result.records,c=[],g=new Set;for(let P of d){let L=qo(P.Action,P.Display,P.Section);if(L){let J=`${L.isDelete?"DEL":"ADD"}-${L.metadataFormat}`;if(!g.has(J)){g.add(J);let U=L.isDelete?"$(trash)":"$(plus)";c.push({label:`${U} ${L.metadataFormat}`,description:`${P.Action} -> ${P.Display}`,metadataFormat:L.metadataFormat,isDelete:L.isDelete})}}}if(c.length===0){E.window.showInformationMessage(`Ricwiz: No extractable metadata changes found for ${s} in the last ${a} hours (ignored passwords/logins).`);return}let h=await E.window.showQuickPick(c,{canPickMany:!0,placeHolder:"Select the changes you want to extract to GitLab",ignoreFocusOut:!0});if(!h||h.length===0){E.window.showInformationMessage("Ricwiz: No changes selected.");return}let w=h.filter(P=>P.isDelete),R=h.filter(P=>!P.isDelete),S=E.window.createOutputChannel("Ricwiz Admin Bridge");if(S.show(),w.length>0){let{stdout:P}=await p("git ls-files",{cwd:t}),L=P.split(`
`).map(U=>U.trim()),J=0;for(let U of w){let De=U.metadataFormat.split(":"),Me=De[0],Ce=De[1],Te=Ce;Me==="CustomField"&&(Te=Ce.split(".")[1]);let D=L.filter(W=>{let ce=Ve.basename(W);return ce.startsWith(Te+".")&&ce.includes(Me==="CustomField"?".field":"")});for(let W of D){let ce=Ve.join(t,W);He.existsSync(ce)&&(He.unlinkSync(ce),S.appendLine(`Deleted local file: ${W}`),J++)}}E.window.showInformationMessage(`Ricwiz: Deleted ${J} local files from Git workspace.`)}if(R.length===0)return;let ae=R.map(P=>P.metadataFormat).filter(P=>P!=="").join(", "),ue=await E.window.showInputBox({prompt:"Review and adjust the metadata components to retrieve",value:ae,ignoreFocusOut:!0});if(!ue)return;let pe=`sf project retrieve start -m "${ue}"`;S.appendLine(`Executing: ${pe}`),E.window.showInformationMessage(`Ricwiz: Extracting ${R.length} components...`);let K=await p(pe,{cwd:t});S.appendLine(K.stdout),K.stderr&&(S.appendLine("--- STDERR ---"),S.appendLine(K.stderr)),E.window.showInformationMessage("Ricwiz: Changes extracted successfully! Ready for Git Commit.")}catch(o){E.window.showErrorMessage(`Ricwiz: Error capturing changes - ${o.message}`)}})}function qo(t,e,i){if(!t||!e||!i)return null;let r=t.toLowerCase(),s=i.toLowerCase();if(["security controls","network access","session settings","data export","login history","password policies","identity verification","delegated administration"].includes(s)||r.includes("login")||r.includes("password")||r.includes("oauth")||r.includes("session"))return null;let a=r.includes("delete"),f=null;if(r==="permissionsetgroupcomponentadd"||r==="permissionsetgroupcomponentdelete")return null;let u=(l,o=!1)=>{let n=l.replace(/\(.*\)/g,"").trim();n.includes(":")&&!r.includes("calculation")&&(n=n.split(":")[0]);let d=["disabled","deleted","removed","created","changed","updated","from","to","on","assigned","assign","assignment","permission","set","group","apex","class","trigger","custom","field","object","layout","validation","rule","flow","profile"],c=n.split(/\s+/);if(o){for(;c.length>0&&d.includes(c[c.length-1].toLowerCase());)c.pop();for(;c.length>0&&d.includes(c[0].toLowerCase());)c.shift();return c.join(" ").trim().replace(/[^a-zA-Z0-9_ ]/g,"")}else return c.filter(w=>!d.includes(w.toLowerCase())).join("_").replace(/[^a-zA-Z0-9_]/g,"")||n.replace(/\s+/g,"")};if(r.includes("profile"))f=`Profile:${u(e,!0)}`;else if(r.includes("permissionsetgroupcalculation")){let l=e.split(":");f=`PermissionSetGroup:${l.length>1?l[l.length-1].trim():u(e,!1)}`}else if(r.includes("permission set group")||r.includes("permissionsetgroup"))f=`PermissionSetGroup:${u(e,!1)}`;else if(r.includes("permission set")||r.includes("permissionset"))f=`PermissionSet:${u(e,!1)}`;else if(r.includes("apexclass"))f=`ApexClass:${u(e,!1)}`;else if(r.includes("apextrigger")||r.includes("apex trigger"))f=`ApexTrigger:${u(e,!1)}`;else if(r.includes("customfield")){let l=e.match(/([A-Za-z0-9_]+__c)/),o=e.match(/(?:on|na|for)\s+([A-Za-z0-9_]+)/i);l&&o?f=`CustomField:${o[1]}.${l[1]}`:f=`CustomField:${u(e,!1)}`}else if(r.includes("layout"))f=`Layout:${u(e,!0)}`;else if(r.includes("validation"))f=`ValidationRule:${u(e,!1)}`;else if(r.includes("flow"))f=`Flow:${u(e,!1)}`;else if(r.includes("customobject")){let l=e.match(/([A-Za-z0-9_]+__c)/);f=l?`CustomObject:${l[1]}`:`CustomObject:${u(e,!1)}`}else if(!r.includes("created")&&!r.includes("changed")&&!r.includes("deleted"))return null;return f?{metadataFormat:f,isDelete:a}:null}var E,He,Ve,ho=k(()=>{"use strict";E=y(require("vscode")),He=y(require("fs")),Ve=y(require("path"));$()});async function wo(){let t=v();if(t)try{let{stdout:e}=await p('git for-each-ref --sort=-committerdate --format="%(refname:short)|||%(committerdate:relative)|||%(subject)" refs/heads/',{cwd:t}),i=e.split(`
`).filter(s=>s.trim()).map(s=>{let m=s.split("|||");return{label:`$(git-branch) ${m[0]}`,description:m[1],detail:m[2],branchName:m[0]}}),r=await Qe.window.showQuickPick(i,{placeHolder:"Select a branch from history to checkout",matchOnDescription:!0,matchOnDetail:!0});r&&await ke(r.branchName)}catch{Qe.window.showErrorMessage("Ricwiz: Failed to get branch history")}}var Qe,vo=k(()=>{"use strict";Qe=y(require("vscode"));$();We()});async function yo(){let t=v();if(!t)return;let e=await Pe.window.showInputBox({prompt:"Enter ticket number or name (e.g., 48934)",placeHolder:"48934"});if(e)try{let{stdout:i}=await p(`git branch --list "*${e}*"`,{cwd:t}),r=i.split(`
`).map(a=>a.replace("*","").trim()).filter(a=>a);if(r.length===0){Pe.window.showInformationMessage(`Ricwiz: No branches found matching "${e}"`);return}let s=r.map(a=>({label:`$(git-branch) ${a}`,branchName:a})),m=await Pe.window.showQuickPick(s,{placeHolder:`Select a branch for ${e}`});m&&await ke(m.branchName)}catch{Pe.window.showErrorMessage("Ricwiz: Failed to search branches")}}var Pe,bo=k(()=>{"use strict";Pe=y(require("vscode"));$();We()});async function ko(){let t=ve.window.activeTextEditor;if(!t)return ve.window.showErrorMessage("Ricwiz: Please open a file in the editor to check blame."),null;let e=t.document.fileName,i=xo.basename(e),r=v();if(!r)return ve.window.showErrorMessage("Ricwiz: Workspace is not a git repository."),null;let s=[];try{let{stdout:o}=await p(`git log -5 --pretty=format:"%an|%ar|%s|%h" -- "${e}"`,{cwd:r}),n=o.trim().split(`
`);for(let d of n){let c=d.split("|");c.length>=4&&s.push({author:c[0],time:c[1],message:c.slice(2,-1).join("|"),hash:c[c.length-1]})}}catch(o){console.error("Git blame error:",o)}let m="Unknown",a="Unknown",f="Unknown",u=[],l=Ho(e);if(l)try{await ve.window.withProgress({location:ve.ProgressLocation.Notification,title:`Ricwiz: Analyzing ${l.name} in Salesforce...`,cancellable:!1},async()=>{let o="";if(l.type==="CustomField"){let n=l.name.split(".");n.length===2&&(o=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM CustomField WHERE DeveloperName = '${n[1].replace("__c","")}' AND TableEnumOrId = '${n[0]}'`)}else l.type==="LightningComponentBundle"?o=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM LightningComponentBundle WHERE DeveloperName = '${l.name}'`:o=`SELECT LastModifiedBy.Name, LastModifiedDate, CreatedBy.Name FROM ${l.type} WHERE Name = '${l.name}'`;if(o)try{let{stdout:n}=await p(`sf data query -t -q "${o}" --json`,{cwd:r,maxBuffer:52428800}),d=JSON.parse(n);if(d&&d.result&&d.result.records&&d.result.records.length>0){let c=d.result.records[0];m=c.LastModifiedBy?c.LastModifiedBy.Name:"Unknown",f=c.CreatedBy?c.CreatedBy.Name:"Unknown",a=new Date(c.LastModifiedDate).toLocaleString()}else m="Not found in Org",a="N/A",f="N/A"}catch{m="Query Error",a="N/A",f="N/A"}try{let n="SELECT Action, Display, CreatedBy.Name, CreatedDate FROM SetupAuditTrail ORDER BY CreatedDate DESC LIMIT 1500",{stdout:d}=await p(`sf data query -q "${n}" --json`,{cwd:r,maxBuffer:52428800}),c=JSON.parse(d);if(c&&c.result&&c.result.records){let g=l.name.replace("__c","");u=c.result.records.filter(w=>w.Display&&w.Display.includes(g)).map(w=>({action:w.Action,display:w.Display,author:w.CreatedBy?w.CreatedBy.Name:"Unknown",time:new Date(w.CreatedDate).toLocaleString()})).slice(0,10)}}catch(n){console.error("Audit trail query error:",n)}})}catch(o){console.error("Salesforce query error:",o)}else m="Unsupported Metadata Type",a="N/A";return{fileName:i,gitHistory:s,sfAuthor:m,sfTime:a,sfCreatedBy:f,auditHistory:u}}function Ho(t){let e=t.replace(/\\/g,"/");if(e.includes("/classes/")){let i=e.match(/\/classes\/([^/.]+)\.cls/);if(i)return{type:"ApexClass",name:i[1]}}if(e.includes("/triggers/")){let i=e.match(/\/triggers\/([^/.]+)\.trigger/);if(i)return{type:"ApexTrigger",name:i[1]}}if(e.includes("/lwc/")){let i=e.match(/\/lwc\/([^/]+)\//);if(i)return{type:"LightningComponentBundle",name:i[1]}}if(e.includes("/aura/")){let i=e.match(/\/aura\/([^/]+)\//);if(i)return{type:"AuraDefinitionBundle",name:i[1]}}if(e.includes("/objects/")&&e.includes("/fields/")){let i=e.match(/\/objects\/([^/]+)\//),r=e.match(/\/fields\/([^/.]+)\.field/);if(i&&r)return{type:"CustomField",name:`${i[1]}.${r[1]}`}}return null}var ve,xo,Co=k(()=>{"use strict";ve=y(require("vscode")),xo=y(require("path"));$()});function $o(t,e,i){t.subscriptions.push(x.commands.registerCommand("ricwiz.generateDestructiveChanges",at),x.commands.registerCommand("ricwiz.runSmartTests",dt),x.commands.registerCommand("ricwiz.refreshWebview",()=>{e&&x.commands.executeCommand("workbench.action.webview.reloadWebviewAction")}),x.commands.registerCommand("ricwiz.createBranches",pt),x.commands.registerCommand("ricwiz.prepareDeploy",wt),x.commands.registerCommand("ricwiz.createMergeRequests",bt),x.commands.registerCommand("ricwiz.createMergeRequestsVSCode",xt),x.commands.registerCommand("ricwiz.openJiraTicket",$t),x.commands.registerCommand("ricwiz.openJiraTicketVSCode",zt),x.commands.registerCommand("ricwiz.showJiraDetails",()=>{e&&At(e)}),x.commands.registerCommand("ricwiz.openJiraDashboard",r=>{e&&Lt(e,r)}),x.commands.registerCommand("ricwiz.openJiraDetailsForId",r=>{e&&Ft(e,r)}),x.commands.registerCommand("ricwiz.changeJiraStatus",Nt),x.commands.registerCommand("ricwiz.addJiraComment",jt),x.commands.registerCommand("ricwiz.addJiraLabel",Jt),x.commands.registerCommand("ricwiz.setJiraToken",Ut),x.commands.registerCommand("ricwiz.syncAll",qt),x.commands.registerCommand("ricwiz.updateBases",Vt),x.commands.registerCommand("ricwiz.deleteUnusedBranches",Qt),x.commands.registerCommand("ricwiz.checkoutBranch",ke),x.commands.registerCommand("ricwiz.copyBranchName",_t),x.commands.registerCommand("ricwiz.generatePackageXml",Kt),x.commands.registerCommand("ricwiz.deployPackage",to),x.commands.registerCommand("ricwiz.importData",io),x.commands.registerCommand("ricwiz.listTicketFiles",so),x.commands.registerCommand("ricwiz.resetTracking",ao),x.commands.registerCommand("ricwiz.extractComponent",lo),x.commands.registerCommand("ricwiz.deployMultiOrg",po),x.commands.registerCommand("ricwiz.captureAdminChanges",fo),x.commands.registerCommand("ricwiz.openHistory",wo),x.commands.registerCommand("ricwiz.searchTicket",yo),x.commands.registerCommand("ricwiz.whoToBlame",async()=>{let r=await ko();r&&e&&(e.setBlameData(r),e.setPage("blame"))}),x.commands.registerCommand("ricwiz.manualRefresh",()=>{i&&i()}),x.commands.registerCommand("ricwiz.toggleAutoRefresh",()=>{if(e){let r=!e.isAutoRefreshEnabled();e.setAutoRefresh(r),x.workspace.getConfiguration("ricwiz").update("autoRefresh",r,x.ConfigurationTarget.Global)}}),x.commands.registerCommand("ricwiz.openSettings",()=>{x.commands.executeCommand("workbench.action.openSettings","ricwiz")}))}var x,zo=k(()=>{"use strict";x=y(require("vscode"));ct();lt();gt();vt();kt();Rt();It();Ot();Wt();Ht();Gt();Yt();We();Zt();eo();oo();ro();no();co();mo();go();ho();vo();bo();Co()});function Ro(){let t=new Map;function e(r,s){let m=s,a=t.get(m);if(a)return a;let f=(async()=>{try{let{stdout:u}=await p(`git rev-parse origin/${s}`,{cwd:r});return u.trim()}catch{let{stdout:u}=await p(`git rev-parse ${s}`,{cwd:r});return u.trim()}})();return t.set(m,f),f}function i(r,s){let m=`branch:${s}`,a=t.get(m);if(a)return a;let f=(async()=>{let{stdout:u}=await p(`git rev-parse ${s}`,{cwd:r});return u.trim()})();return t.set(m,f),f}return{resolveEnvRef:e,resolveBranchRef:i}}async function So(t,e,i,r,s){try{if(!(await p(`git --no-pager log ${e} --grep="\\\\b${i}\\\\b" -i -E -1 --format="%h"`,{cwd:t}).catch(()=>({stdout:"",stderr:""}))).stdout.trim())return!1;let[a,f]=await Promise.all([s.resolveBranchRef(t,e),s.resolveEnvRef(t,r.sourceBranch)]);if(a===f)return!1;try{return await p(`git merge-base --is-ancestor ${e} origin/${r.sourceBranch}`,{cwd:t}),!0}catch{try{return await p(`git merge-base --is-ancestor ${e} ${r.sourceBranch}`,{cwd:t}),!0}catch{return!1}}}catch{return!1}}function Po(t,e){return e.find(i=>t.endsWith(`-to-${i.name}`))}async function Bo(t,e,i,r){let s=Ro();return await Promise.all(e.map(async a=>{let f=Po(a,r);if(!f)return{name:a,isMerged:!1};let u=await So(t,a,i,f,s);return{name:a,isMerged:u}}))}async function Eo(t,e,i){let r=Po(e,i);if(!r)return!1;let s=e.replace(new RegExp(`-to-${r.name}$`,"i"),""),m=Ro();return So(t,e,s,r,m)}async function Do(t,e=10){try{let{stdout:i}=await p(`git log --oneline -${e} --format="%h|||%s|||%ar"`,{cwd:t});return i.split(`
`).filter(r=>r.trim()).map(r=>{let s=r.split("|||");return{hash:s[0]||"",message:s.length>=3?s.slice(1,-1).join("|||"):s[1]||"",timeAgo:s.length>=3?s[s.length-1]:""}})}catch{return[]}}async function Mo(t,e=3){try{let{stdout:i}=await p('git for-each-ref --sort=-committerdate --format="%(refname:short)" refs/heads/',{cwd:t}),r=i.split(`
`).map(m=>m.trim()).filter(m=>m),s=/^[A-Z]+-\d+$/i;return r.filter(m=>s.test(m)).slice(0,e)}catch{return[]}}async function To(t,e,i){let{stdout:r}=await p(`git branch --list "*${e}*"`,{cwd:t});return r.split(`
`).map(s=>s.replace("*","").trim()).filter(s=>s&&s!==i)}var Ao=k(()=>{"use strict";$()});function Io(t,e,i){let r,s=ie.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(s),t.subscriptions.push(ie.workspace.onDidChangeConfiguration(a=>{if(a.affectsConfiguration("ricwiz.autoRefresh")){let f=ie.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(f)}}));async function m(){let a=ie.extensions.getExtension("vscode.git");if(a){let l=function(o){let n="",d;async function c(){let h=ie.workspace.workspaceFolders;if(!h)return;let w=h[0].uri.fsPath,R=await T(w);if(R&&R!==n){n=R;let S=ie.workspace.getConfiguration("ricwiz"),ae=S.get("ticketPrefix","SFPSCA-");if(!R.includes(ae)){let D=R.match(/([A-Z]+-)\d+/i);D&&(ae=D[1].toUpperCase())}let ue=[],pe=[],K=[],P=[],L=S.get("environments",[{name:"Qual",sourceBranch:"quality"},{name:"Val",sourceBranch:"validation"},{name:"Prod",sourceBranch:"main"}]);try{let D=S.get("workspaceCheckoutButtons",["main","quality","validation"]);K=Array.from(new Set(D))}catch{}let J="",U=R.match(new RegExp(`(${ae}\\d+(?:-\\d+)?)`,"i"));if(U){let D=U[1].toUpperCase();J=D;let W=S.get("commitMessageSuffix","- "),ce=/^[A-Z]+-\d+(?:-\d+)?\s*(?:-\s*|:\s*|\s+)?/i;ce.test(o.inputBox.value)?o.inputBox.value.toUpperCase().startsWith(D)||(o.inputBox.value=o.inputBox.value.replace(ce,`${D}${W}`)):o.inputBox.value=`${D}${W}`+o.inputBox.value,i.text=`$(bookmark) ${D}`,i.tooltip=`Branch: ${R}
Click to open Jira ticket`,i.show();try{let Ye=await To(w,D,R);ue=await Bo(w,Ye,D,L)}catch{}}else{i.hide();try{P=await Mo(w)}catch{}}let[De,Me,Ce]=await Promise.all([Do(w,10),Eo(w,R,L),J?xe(J).catch(D=>{let W=D.message;return(W.includes("ENOTFOUND")||W.includes("network"))&&(W="No Internet or Invalid URL"),{summary:`\u26A0\uFE0F Jira Error: ${W}`,description:""}}):Promise.resolve(null)]);pe=De;let Te=Ce?Ce.summary:"";e?.updateBranch(R,Me,ue,pe,K,P,Te)}}function g(){e?.isAutoRefreshEnabled()&&(d&&clearTimeout(d),d=setTimeout(()=>{n="",c()},300))}r=()=>{n="",c()},c(),o.state.onDidChange(()=>g()),ie.window.onDidChangeWindowState(h=>{h.focused&&g()})};var f=l;a.isActive||await a.activate();let u=a.exports.getAPI(1);u.repositories.length>0&&u.repositories.forEach(o=>l(o)),u.onDidOpenRepository(o=>l(o))}}return m(),r}var ie,Lo=k(()=>{"use strict";ie=y(require("vscode"));$();Ao();Re()});var je={};_e(je,{activate:()=>Vo,deactivate:()=>Go,webviewProvider:()=>Be});module.exports=ge(je);function Vo(t){Ke(t),Be=new Ie(t.extensionUri),t.subscriptions.push(Ee.window.registerWebviewViewProvider("ricwiz-webview",Be));let e=Ee.window.createStatusBarItem(Ee.StatusBarAlignment.Left,100);e.command="ricwiz.openJiraTicket",t.subscriptions.push(e);let i=Io(t,Be,e);$o(t,Be,i)}function Go(){}var Ee,Be,Je=k(()=>{Ee=y(require("vscode"));Xe();Le();zo();Lo()});Je();0&&(module.exports={activate,deactivate,webviewProvider});
