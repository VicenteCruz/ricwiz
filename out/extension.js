"use strict";var _o=Object.create;var Fe=Object.defineProperty;var Qo=Object.getOwnPropertyDescriptor;var Yo=Object.getOwnPropertyNames;var Zo=Object.getPrototypeOf,Ko=Object.prototype.hasOwnProperty;var k=(t,e,i)=>()=>{if(i)throw i[0];try{return t&&(e=t(t=0)),e}catch(n){throw i=[n],n}};var et=(t,e)=>{for(var i in e)Fe(t,i,{get:e[i],enumerable:!0})},tt=(t,e,i,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Yo(e))!Ko.call(t,r)&&r!==i&&Fe(t,r,{get:()=>e[r],enumerable:!(n=Qo(e,r))||n.enumerable});return t};var v=(t,e,i)=>(i=t!=null?_o(Zo(t)):{},tt(e||!t||!t.__esModule?Fe(i,"default",{value:t,enumerable:!0}):i,t)),ue=t=>tt(Fe({},"__esModule",{value:!0}),t);function C(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var y,Oe,ot=k(()=>{"use strict";y=v(require("vscode"));Oe=class{constructor(e){this._extensionUri=e}_extensionUri;webviewView;resolveWebviewView(e,i,n){this.webviewView=e,e.webview.options={enableScripts:!0,localResourceRoots:[this._extensionUri]},this.updateBranch("",!1),e.webview.onDidReceiveMessage(r=>{switch(r.command){case"createBranches":y.commands.executeCommand("ricwiz.createBranches");break;case"createBranchForTicket":y.commands.executeCommand("ricwiz.createBranches",r.args);break;case"prepareDeploy":y.commands.executeCommand("ricwiz.prepareDeploy");break;case"openMRs":y.commands.executeCommand("ricwiz.createMergeRequests");break;case"openMRsVSCode":y.commands.executeCommand("ricwiz.createMergeRequestsVSCode");break;case"openJira":y.commands.executeCommand("ricwiz.openJiraTicket");break;case"showJiraDetails":y.commands.executeCommand("ricwiz.showJiraDetails");break;case"changeJiraStatus":y.commands.executeCommand("ricwiz.changeJiraStatus");break;case"addJiraComment":y.commands.executeCommand("ricwiz.addJiraComment");break;case"addJiraLabel":y.commands.executeCommand("ricwiz.addJiraLabel");break;case"setPage":this.setPage(r.args);break;case"openDashboard":y.commands.executeCommand("ricwiz.openJiraDashboard");break;case"openJiraDetailsForId":y.commands.executeCommand("ricwiz.openJiraDetailsForId",r.args);break;case"refreshDashboard":y.commands.executeCommand("ricwiz.openJiraDashboard");break;case"switchDashboardQuery":y.commands.executeCommand("ricwiz.openJiraDashboard",parseInt(r.args));break;case"openJiraVSCode":y.commands.executeCommand("ricwiz.openJiraTicketVSCode");break;case"openSettings":y.commands.executeCommand("ricwiz.openSettings");break;case"checkout":r.branch&&y.commands.executeCommand("ricwiz.checkoutBranch",r.branch);break;case"copyBranch":y.commands.executeCommand("ricwiz.copyBranchName");break;case"generatePackageXml":y.commands.executeCommand("ricwiz.generatePackageXml");break;case"openDevTools":this.setPage("devtools");break;case"openMain":this.setPage("main");break;case"generateDestructiveChanges":y.commands.executeCommand("ricwiz.generateDestructiveChanges");break;case"deployPackage":y.commands.executeCommand("ricwiz.deployPackage");break;case"runSmartTests":y.commands.executeCommand("ricwiz.runSmartTests");break;case"importData":y.commands.executeCommand("ricwiz.importData");break;case"listTicketFiles":y.commands.executeCommand("ricwiz.listTicketFiles");break;case"resetTracking":y.commands.executeCommand("ricwiz.resetTracking");break;case"extractComponent":y.commands.executeCommand("ricwiz.extractComponent");break;case"deployMultiOrg":y.commands.executeCommand("ricwiz.deployMultiOrg");break;case"captureAdminChanges":y.commands.executeCommand("ricwiz.captureAdminChanges");break;case"whoToBlame":y.commands.executeCommand("ricwiz.whoToBlame");break;case"syncAll":y.commands.executeCommand("ricwiz.syncAll");break;case"updateBases":y.commands.executeCommand("ricwiz.updateBases");break;case"deleteUnused":y.commands.executeCommand("ricwiz.deleteUnusedBranches");break;case"conflict_commitAndContinue":y.commands.executeCommand("ricwiz.conflictAction","commitAndContinue");break;case"conflict_resolveDeletions":y.commands.executeCommand("ricwiz.conflictAction","resolveDeletions");break;case"conflict_abortDeploy":y.commands.executeCommand("ricwiz.conflictAction","abortDeploy");break;case"openFile":if(r.file){let p=y.workspace.workspaceFolders;if(p){let a=y.Uri.joinPath(p[0].uri,r.file);y.commands.executeCommand("vscode.open",a)}}break;case"searchTicket":y.commands.executeCommand("ricwiz.searchTicket");break;case"manualRefresh":y.commands.executeCommand("ricwiz.manualRefresh");break;case"toggleAutoRefresh":y.commands.executeCommand("ricwiz.toggleAutoRefresh");break;case"openHistory":y.commands.executeCommand("ricwiz.openHistory");break}})}conflictState=null;setConflictState(e){this.conflictState=e,this.updateView()}updateBranch(e,i,n=[],r=[],p=[],a=[],u=""){this.webviewView&&(this.currentBranchCache=e,this.currentBranchIsMergedCache=i,this.relatedBranchesCache=n,this.commitsCache=r,this.baseBranchesCache=p,this.recentTicketsCache=a,this.ticketTitleCache=u,this.updateView())}currentBranchCache="";currentBranchIsMergedCache=!1;relatedBranchesCache=[];commitsCache=[];baseBranchesCache=[];recentTicketsCache=[];ticketTitleCache="";currentPage="main";blameDataCache=null;jiraDataCache=null;dashboardDataCache=null;autoRefreshEnabled=!0;setBlameData(e){this.blameDataCache=e}setJiraData(e){this.jiraDataCache=e}setDashboardData(e){this.dashboardDataCache=e}setAutoRefresh(e){this.autoRefreshEnabled=e,this.updateView()}isAutoRefreshEnabled(){return this.autoRefreshEnabled}setPage(e){this.currentPage=e,this.updateView()}updateView(){if(!this.webviewView)return;let e=this.webviewView.webview.asWebviewUri(y.Uri.joinPath(this._extensionUri,"resources","logo.png"));this.webviewView.webview.html=this._getHtmlForWebview(e,this.currentBranchCache,this.relatedBranchesCache,this.commitsCache,this.baseBranchesCache,this.recentTicketsCache,this.currentPage)}_getHtmlForWebview(e,i,n,r,p,a,u){let m=r.length>0?`
        ...
        `;if(this.conflictState){let o=(this.conflictState.files||[]).map(s=>`
            ...
            </html>`}if(u==="jira"){let o=this.jiraDataCache,s=o?.ticketId||"Jira",c=o?.summary||"No Title",d=o?.description||"No description provided.";return`<!DOCTYPE html>
            <html lang="en">
            <head>
                <meta charset="UTF-8">
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            </html>`}if(u==="dashboard"){let o=this.dashboardDataCache||{queries:[],selectedIndex:0,results:[],error:null},s=o.queries.map((d,g)=>`
...
`).map(c=>c.trim()).filter(c=>c.length>0);if(r.length===0){U.window.showInformationMessage(`Ricwiz: No deleted files found compared to origin/${i}.`);return}let p={},a=(c,d)=>{p[c]||(p[c]=[]),p[c].includes(d)||p[c].push(d)};for(let c of r){let d=c.replace(/\\/g,"/");if(d.includes("/classes/")){let g=d.match(/\/classes\/([^/.]+)\.cls/);g&&a("ApexClass",g[1])}else if(d.includes("/triggers/")){let g=d.match(/\/triggers\/([^/.]+)\.trigger/);g&&a("ApexTrigger",g[1])}else if(d.includes("/lwc/")){let g=d.match(/\/lwc\/([^/]+)\//);g&&a("LightningComponentBundle",g[1])}else if(d.includes("/aura/")){let g=d.match(/\/aura\/([^/]+)\//);g&&a("AuraDefinitionBundle",g[1])}else if(d.includes("/objects/")&&d.includes("/fields/")){let g=d.match(/\/objects\/([^/]+)\//),h=d.match(/\/fields\/([^/.]+)\.field/);g&&h&&a("CustomField",`${g[1]}.${h[1]}`)}else if(d.includes("/objects/")){let g=d.match(/\/objects\/([^/.]+)\.object/);g&&a("CustomObject",g[1])}else if(d.includes("/layouts/")){let g=d.match(/\/layouts\/([^/.]+)\.layout/);g&&a("Layout",g[1])}else if(d.includes("/flows/")){let g=d.match(/\/flows\/([^/.]+)\.flow/);g&&a("Flow",g[1])}else if(d.includes("/permissionsets/")){let g=d.match(/\/permissionsets\/([^/.]+)\.permissionset/);g&&a("PermissionSet",g[1])}else if(d.includes("/profiles/")){let g=d.match(/\/profiles\/([^/.]+)\.profile/);g&&a("Profile",g[1])}else if(d.includes("/customMetadata/")){let g=d.match(/\/customMetadata\/([^/.]+)\.md/);g&&a("CustomMetadata",g[1])}else if(d.includes("/flexipages/")){let g=d.match(/\/flexipages\/([^/.]+)\.flexipage/);g&&a("FlexiPage",g[1])}}if(Object.keys(p).length===0){U.window.showInformationMessage("Ricwiz: Found deleted files in Git, but none mapped to recognizable Salesforce metadata.");return}let u=`<?xml version="1.0" encoding="UTF-8"?>
<Package xmlns="http://soap.sforce.com/2006/04/metadata">
`;for(let c of Object.keys(p).sort()){u+=`    <types>
`;for(let d of p[c].sort())u+=`        <members>${d}</members>
`;u+=`        <name>${c}</name>
    </types>
`}u+=`    <version>58.0</version>
</Package>`;let m=Ne.join(t,"destructiveChanges");ge.existsSync(m)||ge.mkdirSync(m);let l=Ne.join(m,"destructiveChanges.xml"),o=Ne.join(m,"package.xml");ge.writeFileSync(l,u,"utf8"),ge.existsSync(o)||ge.writeFileSync(o,`<?xml version="1.0" encoding="UTF-8"?>
<Package xmlns="http://soap.sforce.com/2006/04/metadata">
...
`).map(c=>c.trim().replace(/^origin\//,"").replace(/^[^\/]+\//,"")).filter(c=>c.length>0&&!c.includes("HEAD"))}catch{}let p=[];try{let{stdout:s}=await f('git for-each-ref --format="%(refname:short)|||%(upstream:track)" refs/heads/',{cwd:t});p=s.split(`
`).filter(c=>c.includes("[gone]")).map(c=>c.split("|||")[0].trim())}catch{}let a=n.filter(s=>!r.includes(s));if(a.length===0){I.window.showInformationMessage("Ricwiz: Your local repository is totally clean! All local branches exist on the remote.");return}let u=a.map(s=>{let c=p.includes(s),d=s===e,g="Not found on remote";return c&&(g="Deleted on remote [gone]"),d&&(g+=" (Current branch - will checkout main first)"),{label:s,description:g,picked:c&&!d}}),m=await I.window.showQuickPick(u,{canPickMany:!0,placeHolder:"Select local branches to delete",title:"Ricwiz: Delete Unused Branches"});if(!m||m.length===0){I.window.showInformationMessage("Ricwiz: No branches selected for deletion.");return}if(await I.window.showWarningMessage(`Ricwiz: Delete ${m.length} local branch(es)?
...
`).map(p=>p.trim()).filter(p=>p),r=/^[A-Z]+-\d+$/i;return n.filter(p=>r.test(p)).slice(0,e)}catch{return[]}}async function qo(t,e,i){let{stdout:n}=await f(`git branch --list "*${e}*"`,{cwd:t});return n.split(`
`).map(r=>r.replace("*","").trim()).filter(r=>r&&r!==i)}var Go=k(()=>{"use strict";$();Oo()});function Ho(t,e,i){let n,r=se.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(r),t.subscriptions.push(se.workspace.onDidChangeConfiguration(a=>{if(a.affectsConfiguration("ricwiz.autoRefresh")){let u=se.workspace.getConfiguration("ricwiz").get("autoRefresh",!0);e?.setAutoRefresh(u)}}));async function p(){let a=se.extensions.getExtension("vscode.git");if(a){let l=function(o){let s="",c;async function d(){let h=se.workspace.workspaceFolders;if(!h)return;let w=h[0].uri.fsPath,R=await D(w);if(R&&R!==s){s=R;let S=se.workspace.getConfiguration("ricwiz"),le=S.get("ticketPrefix","SFPSCA-");if(!R.includes(le)){let E=R.match(/([A-Z]+-)\d+/i);E&&(le=E[1].toUpperCase())}let fe=[],he=[],ee=[],P=[],L=S.get("environments",[{name:"Qual",sourceBranch:"quality"},{name:"Val",sourceBranch:"validation"},{name:"Prod",sourceBranch:"main"}]);try{let E=S.get("workspaceCheckoutButtons",["main","quality","validation"]);ee=Array.from(new Set(E))}catch{}let J="",W=R.match(new RegExp(`(${le}\\d+(?:-\\d+)?)`,"i"));if(W){let E=W[1].toUpperCase();J=E;let q=S.get("commitMessageSuffix","- "),me=/^[A-Z]+-\d+(?:-\d+)?\s*(?:-\s*|:\s*|\s+)?/i;me.test(o.inputBox.value)?o.inputBox.value.toUpperCase().startsWith(E)||(o.inputBox.value=o.inputBox.value.replace(me,`${E}${q}`)):o.inputBox.value=`${E}${q}`+o.inputBox.value,i.text=`$(bookmark) ${E}`,i.tooltip=`Branch: ${R}
Click to open Jira ticket`,i.show();try{let Xe=await qo(w,E,R);fe=await Uo(w,Xe,E,L)}catch{}}else{i.hide();try{P=await Wo(w)}catch{}}let[Ae,Ie,Re]=await Promise.all([Jo(w,10),jo(w,R,L),J?$e(J).catch(E=>{let q=E.message;return(q.includes("ENOTFOUND")||q.includes("network"))&&(q="No Internet or Invalid URL"),{summary:`\u26A0\uFE0F Jira Error: ${q}`,description:""}}):Promise.resolve(null)]);he=Ae;let Le=Re?Re.summary:"";e?.updateBranch(R,Ie,fe,he,ee,P,Le)}}function g(){e?.isAutoRefreshEnabled()&&(c&&clearTimeout(c),c=setTimeout(()=>{s="",d()},300))}n=()=>{s="",d()},d(),o.state.onDidChange(()=>g()),se.window.onDidChangeWindowState(h=>{h.focused&&g()})};var u=l;a.isActive||await a.activate();let m=a.exports.getAPI(1);m.repositories.length>0&&m.repositories.forEach(o=>l(o)),m.onDidOpenRepository(o=>l(o))}}return p(),n}var se,Vo=k(()=>{"use strict";se=v(require("vscode"));$();Go();Be()});var je={};et(je,{activate:()=>ni,deactivate:()=>ri,webviewProvider:()=>Me});module.exports=ue(je);function ni(t){it(t),Me=new Oe(t.extensionUri),t.subscriptions.push(De.window.registerWebviewViewProvider("ricwiz-webview",Me));let e=De.window.createStatusBarItem(De.StatusBarAlignment.Left,100);e.command="ricwiz.openJiraTicket",t.subscriptions.push(e);let i=Ho(t,Me,e);Eo(t,Me,i)}function ri(){}var De,Me,Je=k(()=>{De=v(require("vscode"));ot();xe();Mo();Vo()});Je();0&&(module.exports={activate,deactivate,webviewProvider});
