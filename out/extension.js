"use strict";var ei=Object.create;var Oe=Object.defineProperty;var ti=Object.getOwnPropertyDescriptor;var oi=Object.getOwnPropertyNames;var ii=Object.getPrototypeOf,ni=Object.prototype.hasOwnProperty;var $=(t,e,o)=>()=>{if(o)throw o[0];try{return t&&(e=t(t=0)),e}catch(s){throw o=[s],s}};var Ne=(t,e)=>{for(var o in e)Oe(t,o,{get:e[o],enumerable:!0})},mt=(t,e,o,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of oi(e))!ni.call(t,n)&&n!==o&&Oe(t,n,{get:()=>e[n],enumerable:!(s=ti(e,n))||s.enumerable});return t};var v=(t,e,o)=>(o=t!=null?ei(ii(t)):{},mt(e||!t||!t.__esModule?Oe(o,"default",{value:t,enumerable:!0}):o,t)),H=t=>mt(Oe({},"__esModule",{value:!0}),t);function C(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var b,Ue,pt=$(()=>{"use strict";b=v(require("vscode"));Ue=class{constructor(e){this._extensionUri=e}_extensionUri;webviewView;resolveWebviewView(e,o,s){this.webviewView=e,e.webview.options={enableScripts:!0,localResourceRoots:[this._extensionUri]},this.updateBranch("",!1),e.webview.onDidReceiveMessage(n=>{switch(n.command){case"createBranches":b.commands.executeCommand("ricwiz.createBranches");break;case"createBranchForTicket":b.commands.executeCommand("ricwiz.createBranches",n.args);break;case"prepareDeploy":b.commands.executeCommand("ricwiz.prepareDeploy");break;case"openMRs":b.commands.executeCommand("ricwiz.createMergeRequests");break;case"openMRsVSCode":b.commands.executeCommand("ricwiz.createMergeRequestsVSCode");break;case"openExternal":n.args&&b.env.openExternal(b.Uri.parse(n.args));break;case"openJira":b.commands.executeCommand("ricwiz.openJiraTicket");break;case"showJiraDetails":b.commands.executeCommand("ricwiz.showJiraDetails");break;case"changeJiraStatus":b.commands.executeCommand("ricwiz.changeJiraStatus");break;case"addJiraComment":b.commands.executeCommand("ricwiz.addJiraComment");break;case"addJiraLabel":b.commands.executeCommand("ricwiz.addJiraLabel");break;case"setPage":this.setPage(n.args);break;case"openDashboard":b.commands.executeCommand("ricwiz.openJiraDashboard");break;case"openJiraDetailsForId":b.commands.executeCommand("ricwiz.openJiraDetailsForId",n.args);break;case"refreshDashboard":b.commands.executeCommand("ricwiz.openJiraDashboard");break;case"switchDashboardQuery":b.commands.executeCommand("ricwiz.openJiraDashboard",parseInt(n.args));break;case"toggleDashboardBranches":b.commands.executeCommand("ricwiz.toggleDashboardBranches",n.args);break;case"openJiraVSCode":b.commands.executeCommand("ricwiz.openJiraTicketVSCode");break;case"openSettings":b.commands.executeCommand("ricwiz.openSettings");break;case"checkout":n.branch&&b.commands.executeCommand("ricwiz.checkoutBranch",n.branch);break;case"copyBranch":b.commands.executeCommand("ricwiz.copyBranchName");break;case"generatePackageXml":b.commands.executeCommand("ricwiz.generatePackageXml");break;case"openDevTools":this.setPage("devtools");break;case"openMain":this.setPage("main");break;case"generateDestructiveChanges":b.commands.executeCommand("ricwiz.generateDestructiveChanges");break;case"deployPackage":b.commands.executeCommand("ricwiz.deployPackage");break;case"runSmartTests":b.commands.executeCommand("ricwiz.runSmartTests");break;case"importData":b.commands.executeCommand("ricwiz.importData");break;case"listTicketFiles":b.commands.executeCommand("ricwiz.listTicketFiles");break;case"resetTracking":b.commands.executeCommand("ricwiz.resetTracking");break;case"extractComponent":b.commands.executeCommand("ricwiz.extractComponent");break;case"deployMultiOrg":b.commands.executeCommand("ricwiz.deployMultiOrg");break;case"captureAdminChanges":b.commands.executeCommand("ricwiz.captureAdminChanges");break;case"whoToBlame":b.commands.executeCommand("ricwiz.whoToBlame");break;case"syncAll":b.commands.executeCommand("ricwiz.syncAll");break;case"updateBases":b.commands.executeCommand("ricwiz.updateBases");break;case"deleteUnused":b.commands.executeCommand("ricwiz.deleteUnusedBranches");break;case"conflict_commitAndContinue":b.commands.executeCommand("ricwiz.conflictAction","commitAndContinue");break;case"conflict_resolveDeletions":b.commands.executeCommand("ricwiz.conflictAction","resolveDeletions");break;case"conflict_abortDeploy":b.commands.executeCommand("ricwiz.conflictAction","abortDeploy");break;case"openFile":if(n.file){let m=b.workspace.workspaceFolders;if(m){let a=b.Uri.joinPath(m[0].uri,n.file);b.commands.executeCommand("vscode.open",a)}}break;case"searchTicket":b.commands.executeCommand("ricwiz.searchTicket");break;case"manualRefresh":b.commands.executeCommand("ricwiz.manualRefresh");break;case"toggleAutoRefresh":b.commands.executeCommand("ricwiz.toggleAutoRefresh");break;case"openHistory":b.commands.executeCommand("ricwiz.openHistory");break}})}conflictState=null;setConflictState(e){this.conflictState=e,this.updateView()}updateBranch(e,o,s=[],n=[],m=[],a=[],g="",l=""){this.webviewView&&(this.currentBranchCache=e,this.currentBranchIsMergedCache=o,this.relatedBranchesCache=s,this.commitsCache=n,this.baseBranchesCache=m,this.recentTicketsCache=a,this.ticketTitleCache=g,this.ticketStatusCache=l,this.updateView())}currentBranchCache="";currentBranchIsMergedCache=!1;relatedBranchesCache=[];commitsCache=[];baseBranchesCache=[];recentTicketsCache=[];ticketTitleCache="";ticketStatusCache="";currentPage="main";blameDataCache=null;jiraDataCache=null;dashboardDataCache=null;dashboardShowBranches=!1;autoRefreshEnabled=!0;setDashboardShowBranches(e){this.dashboardShowBranches=e}getDashboardShowBranches(){return this.dashboardShowBranches}setBlameData(e){this.blameDataCache=e}setJiraData(e){this.jiraDataCache=e}setDashboardData(e){this.dashboardDataCache=e}setAutoRefresh(e){this.autoRefreshEnabled=e,this.updateView()}isAutoRefreshEnabled(){return this.autoRefreshEnabled}setPage(e){this.currentPage=e,this.updateView()}updateView(){if(!this.webviewView)return;let e=this.webviewView.webview.asWebviewUri(b.Uri.joinPath(this._extensionUri,"resources","logo.png"));this.webviewView.webview.html=this._getHtmlForWebview(e,this.currentBranchCache,this.relatedBranchesCache,this.commitsCache,this.baseBranchesCache,this.recentTicketsCache,this.currentPage)}_getHtmlForWebview(e,o,s,n,m,a,g){let l=n.length>0?`
        ...
        </html>`}}});function ut(t){de=t.secrets}async function gt(t){if(!de)throw new Error("SecretStorage is not initialized.");await de.store("ricwiz.jiraApiToken",t)}async function ft(){if(!de)throw new Error("SecretStorage is not initialized.");return await de.get("ricwiz.jiraApiToken")}async function ht(t){if(!de)throw new Error("SecretStorage is not initialized.");await de.store("ricwiz.gitlabApiToken",t)}async function Ke(){if(!de)throw new Error("SecretStorage is not initialized.");return await de.get("ricwiz.gitlabApiToken")}var de,ke=$(()=>{"use strict"});var Be={};Ne(Be,{checkBranchExists:()=>ue,exec:()=>h,extractTicketSuggestion:()=>bt,getCurrentBranch:()=>L,getWorkspaceCwd:()=>y,normalizeTicketId:()=>xt,promptForTicketId:()=>W,resolvePrefix:()=>yt,ricwizLogger:()=>I});function y(){let t=Ce.workspace.workspaceFolders;if(t)return t[0].uri.fsPath}async function L(t){try{let{stdout:e}=await h("git branch --show-current",{cwd:t});return e.trim()}catch{return""}}function yt(t,e){if(!t.includes(e)){let o=t.match(/([A-Z]+-)\d+/i);if(o)return o[1].toUpperCase()}return e}function bt(t,e,o=!1){let s=t.match(new RegExp(`(${e}\\d+)`,"i"));return s?s[1].toUpperCase():t.includes(e)&&!t.includes("-to-")?t.substring(t.indexOf(e)):o&&t.includes("-to-")?t.substring(t.indexOf(e)).split("-to-")[0]:""}function xt(t,e){let o=t.trim();return/^\d/.test(o)?`${e}${o}`.toUpperCase():o.toUpperCase()}async function W(t,e){let o=Ce.workspace.getConfiguration("ricwiz"),s=e?.prefix??o.get("ticketPrefix","SFPSCA-"),n=await L(t),m=yt(n,s),a=e?.suggestedValue??bt(n,m,e?.handleToSuffix),g=await Ce.window.showInputBox({prompt:e?.prompt||"Enter the full ticket ID (e.g., SCPSCA-1234) or just the number",placeHolder:e?.placeHolder||"Ticket ID or number",value:a});return g?{ticketId:xt(g,m),currentBranch:n,prefix:m}:void 0}async function ue(t,e){try{return await h(`git show-ref --verify --quiet refs/heads/${e}`,{cwd:t}),!0}catch{}try{return await h(`git show-ref --verify --quiet refs/remotes/origin/${e}`,{cwd:t}),!0}catch{}return!1}var Ce,wt,vt,si,I,h,R=$(()=>{"use strict";Ce=v(require("vscode")),wt=v(require("child_process")),vt=v(require("util")),si=vt.promisify(wt.exec),I=Ce.window.createOutputChannel("Ricwiz"),h=async(t,e)=>{I.appendLine(`[EXEC] ${t}`);let o=await si(t,{maxBuffer:50*1024*1024,...e});return{stdout:o.stdout.toString(),stderr:o.stderr.toString()}}});async function kt(){let t=y();if(!t){q.window.showErrorMessage("Ricwiz: Open a workspace that is a Git repository.");return}let o=q.workspace.getConfiguration("ricwiz").get("ticketSourceBranch","main");await q.window.withProgress({location:q.ProgressLocation.Notification,title:`Ricwiz: Finding deleted files compared to origin/${o}...`,cancellable:!1},async()=>{try{let{stdout:s}=await h(`git diff --name-only --diff-filter=D origin/${o}...HEAD`,{cwd:t}),n=s.split(`
`).map(c=>c.trim()).filter(c=>c.length>0);if(n.length===0){q.window.showInformationMessage(`Ricwiz: No deleted files found compared to origin/${o}.`);return}let m={},a=(c,p)=>{m[c]||(m[c]=[]),m[c].includes(p)||m[c].push(p)};for(let c of n){let p=c.replace(/\\/g,"/");if(p.includes("/classes/")){let f=p.match(/\/classes\/([^/.]+)\.cls/);f&&a("ApexClass",f[1])}else if(p.includes("/triggers/")){let f=p.match(/\/triggers\/([^/.]+)\.trigger/);f&&a("ApexTrigger",f[1])}else if(p.includes("/lwc/")){let f=p.match(/\/lwc\/([^/]+)\//);f&&a("LightningComponentBundle",f[1])}else if(p.includes("/aura/")){let f=p.match(/\/aura\/([^/]+)\//);f&&a("AuraDefinitionBundle",f[1])}else if(p.includes("/objects/")&&p.includes("/fields/")){let f=p.match(/\/objects\/([^/]+)\//),u=p.match(/\/fields\/([^/.]+)\.field/);f&&u&&a("CustomField",`${f[1]}.${u[1]}`)}else if(p.includes("/objects/")){let f=p.match(/\/objects\/([^/.]+)\.object/);f&&a("CustomObject",f[1])}else if(p.includes("/layouts/")){let f=p.match(/\/layouts\/([^/.]+)\.layout/);f&&a("Layout",f[1])}else if(p.includes("/flows/")){let f=p.match(/\/flows\/([^/.]+)\.flow/);f&&a("Flow",f[1])}else if(p.includes("/permissionsets/")){let f=p.match(/\/permissionsets\/([^/.]+)\.permissionset/);f&&a("PermissionSet",f[1])}else if(p.includes("/profiles/")){let f=p.match(/\/profiles\/([^/.]+)\.profile/);f&&a("Profile",f[1])}else if(p.includes("/customMetadata/")){let f=p.match(/\/customMetadata\/([^/.]+)\.md/);f&&a("CustomMetadata",f[1])}else if(p.includes("/flexipages/")){let f=p.match(/\/flexipages\/([^/.]+)\.flexipage/);f&&a("FlexiPage",f[1])}}if(Object.keys(m).length===0){q.window.showInformationMessage("Ricwiz: Found deleted files in Git, but none mapped to recognizable Salesforce metadata.");return}let g=`<?xml version="1.0" encoding="UTF-8"?>
<Package xmlns="http://soap.sforce.com/2006/04/metadata">
`;for(let c of Object.keys(m).sort()){g+=`    <types>
`;for(let p of m[c].sort())g+=`        <members>${p}</members>
`;g+=`        <name>${c}</name>
    </types>
`}g+=`    <version>58.0</version>
</Package>`;let l=je.join(t,"destructiveChanges");ge.existsSync(l)||ge.mkdirSync(l);let r=je.join(l,"destructiveChanges.xml"),i=je.join(l,"package.xml");ge.writeFileSync(r,g,"utf8"),ge.existsSync(i)||ge.writeFileSync(i,`<?xml version="1.0" encoding="UTF-8"?>
<Package xmlns="http://soap.sforce.com/2006/04/metadata">
    <version>58.0</version>
</Package>`,"utf8");let d=await q.workspace.openTextDocument(r);await q.window.showTextDocument(d),q.window.showInformationMessage("Ricwiz: destructiveChanges.xml generated successfully!")}catch(s){q.window.showErrorMessage(`Ricwiz: Error generating destructive changes: ${s.message}`)}})}var q,je,ge,Ct=$(()=>{"use strict";q=v(require("vscode")),je=v(require("path")),ge=v(require("fs"));R()});async function $t(){let t=y();if(!t)return;let o=re.workspace.getConfiguration("ricwiz").get("ticketSourceBranch","main");await re.window.withProgress({location:re.ProgressLocation.Notification,title:"Ricwiz: Finding Apex Tests to run...",cancellable:!1},async()=>{try{let{stdout:s}=await h(`git diff --name-status origin/${o}...HEAD`,{cwd:t}),n=s.split(`
`).map(c=>c.trim()).filter(c=>c.length>0),m=new Set,a=new Set;for(let c of n){let p=c.split(/\s+/);if(p[0].startsWith("D"))continue;let f=p[1];if(f&&f.endsWith(".cls")){let u=f.match(/\/classes\/([^/.]+)\.cls/);if(u){let w=u[1];w.toLowerCase().endsWith("test")?m.add(w):a.add(w)}}}for(let c of a)m.add(`${c}Test`);if(m.size===0){re.window.showInformationMessage("Ricwiz: No Apex Classes were modified in this branch.");return}let g=Array.from(m).map(c=>({label:`$(beaker) ${c}`,description:"Apex Test Class"})),l=await re.window.showQuickPick(g,{canPickMany:!0,title:"Select Test Classes to Run",placeHolder:"Select tests..."});if(!l||l.length===0)return;let i=`sf apex run test -n ${l.map(c=>c.label.replace("$(beaker) ","").trim()).join(",")} -r human -w 30`,d=re.window.createTerminal("Ricwiz: Smart Tests");d.show(),d.sendText(i)}catch(s){re.window.showErrorMessage(`Ricwiz: Error finding tests: ${s.message}`)}})}var re,zt=$(()=>{"use strict";re=v(require("vscode"));R()});var we,Rt=$(()=>{"use strict";we=class{static isValidShellArg(e){return e?/^[a-zA-Z0-9\-_/.]+$/.test(e):!1}}});var Bt={};Ne(Bt,{WorkflowContext:()=>T});var Pe,St,Je,T,ee=$(()=>{"use strict";Pe=v(require("vscode")),St=v(require("path")),Je=v(require("fs")),T=class t{style;upstreamRemote;originRemote;ticketSourceBranch;ticketPrefix;environments;static baseConfig=Pe.workspace.getConfiguration("ricwiz");activeProfile;profileName;constructor(e){this.activeProfile=e,this.profileName=e?.name;let o=t.baseConfig;this.style=e?.workflowStyle||o.get("workflowStyle","standard"),this.style==="multi-remote"?(this.upstreamRemote=e?.upstreamRemote||o.get("upstreamRemote","salesforce-master"),this.originRemote=e?.originRemote||o.get("originRemote","origin")):(this.upstreamRemote="origin",this.originRemote="origin"),this.ticketSourceBranch=e?.ticketSourceBranch||o.get("ticketSourceBranch","main"),this.ticketPrefix=e?.ticketPrefix||o.get("ticketPrefix","SFPSCA-");let s=[{name:"Qual",sourceBranch:"quality"},{name:"Val",sourceBranch:"validation"},{name:"Prod",sourceBranch:"main"}];this.environments=e?.environments||o.get("environments",s)}getConfig(e,o){return this.activeProfile&&this.activeProfile[e]!==void 0?this.activeProfile[e]:t.baseConfig.get(e,o)}static async initialize(e,o){let s=t.baseConfig.get("profiles",[]),n=St.join(e,"ricwiz.json");if(Je.existsSync(n))try{let m=Je.readFileSync(n,"utf-8"),a=JSON.parse(m);a&&Array.isArray(a.profiles)&&(s=[...s,...a.profiles])}catch(m){Pe.window.showErrorMessage(`Ricwiz: Error parsing ricwiz.json: ${m.message}`)}if(s.length>0){if(!o?.forcePrompt)try{let{exec:l}=(R(),H(Be)),{stdout:r}=await l("git branch --show-current",{cwd:e}),i=r.trim(),d=i;i.includes("-to-")&&(d=i.split("-to-")[0]);let{stdout:c}=await l(`git config branch.${d}.ricwiz-profile`,{cwd:e}),p=c.trim();if(p){let f=s.find(u=>u.name===p);if(f)return new t(f)}}catch{}if(o?.skipPrompt)return new t;let m=s.map(l=>l.name),a=await Pe.window.showQuickPick(m,{placeHolder:"Ricwiz: Select Workflow Profile",ignoreFocusOut:!0});if(!a)return;let g=s.find(l=>l.name===a);return new t(g)}return new t}buildUpstreamPath(e){return e.includes("/")?e:`${this.upstreamRemote}/${e}`}getFetchRemote(e){return e.includes("/")?e.split("/")[0]:this.upstreamRemote}getFetchBranch(e){return e.includes("/")?e.substring(e.indexOf("/")+1):e}}});async function Pt(t){let e=y();if(!e){D.window.showErrorMessage("Open a folder or workspace that is a Git repository.");return}let o=await T.initialize(e,{forcePrompt:!0});if(!o)return;let s=typeof t=="string"?t:void 0,n=await W(e,{prefix:o.ticketPrefix,suggestedValue:s});if(!n){D.window.showErrorMessage("Branch creation cancelled: Ticket not provided.");return}let{ticketId:m}=n,a=o.environments,g="all",l=[{label:"Create Main Branch & Environments",description:"Creates the main ticket branch and all environment branches",value:"all"},{label:"Create Main Branch Only",description:"Creates only the main ticket branch (skips environments)",value:"mainOnly"},{label:"Create Environments Only",description:"Creates only the environment branches (skip main branch)",value:"envs"}];if(a.length>0){let d=await D.window.showQuickPick(l,{placeHolder:"Ricwiz: What do you want to create?",ignoreFocusOut:!0});if(!d)return;g=d.value}let r=o.ticketSourceBranch;if(g==="all"||g==="mainOnly"){let d=[];try{let{stdout:u}=await h('git branch --all --format="%(refname:short)"',{cwd:e});d=u.split(`
`).map(w=>w.trim()).filter(w=>w&&w!=="origin"),d=[...new Set(d)]}catch{}let c=D.window.createQuickPick();c.title="Ricwiz: Ticket Source Branch",c.placeholder="Confirm or change the source branch for this ticket",c.value=o.ticketSourceBranch,c.ignoreFocusOut=!0;let p=()=>{let u=c.value.trim(),w=[];u&&w.push({label:u,description:"Use typed branch"}),w.push(...d.map(z=>({label:z}))),c.items=w};c.onDidChangeValue(p),p();let f=await new Promise(u=>{c.onDidAccept(()=>{let w=c.selectedItems[0];u(w?w.label:c.value),c.hide()}),c.onDidHide(()=>u(void 0)),c.show()});if(!f){D.window.showInformationMessage("Branch creation cancelled.");return}r=f.trim()}let i=m;if(!we.isValidShellArg(i)){D.window.showErrorMessage(`Invalid format for ticket ID: ${i}`);return}if(!we.isValidShellArg(r)){D.window.showErrorMessage(`Invalid format for ticketSourceBranch in settings: ${r}`);return}for(let d of a){if(!we.isValidShellArg(d.name)){D.window.showErrorMessage(`Invalid format for environment name in settings: ${d.name}`);return}if(!we.isValidShellArg(d.sourceBranch)){D.window.showErrorMessage(`Invalid format for environment sourceBranch in settings: ${d.sourceBranch}`);return}}try{await h("git status",{cwd:e})}catch{D.window.showErrorMessage("The opened folder does not appear to be a valid Git repository.");return}try{await D.window.withProgress({location:D.ProgressLocation.Notification,title:"Ricwiz: Creating Branches",cancellable:!1},async d=>{let c=[];d.report({message:"Checking remote status (git fetch)...",increment:10});try{await h("git fetch",{cwd:e})}catch{}try{if(g==="all"||g==="mainOnly"){if(d.report({message:`Creating main branch ${i}...`,increment:10}),await ue(e,i))D.window.showInformationMessage(`Ricwiz: The branch ${i} already exists. Skipping creation...`),await h(`git checkout ${i}`,{cwd:e});else try{let p=o.getFetchRemote(r),f=o.getFetchBranch(r),u=o.buildUpstreamPath(r);await h(`git fetch ${p} ${f}`,{cwd:e}),await h(`git checkout -b ${i} ${u}`,{cwd:e}),c.push(i)}catch{try{await h(`git checkout -b ${i} ${r}`,{cwd:e}),c.push(i)}catch{throw new Error(`Could not create main branch '${i}' from '${r}'. Does the source branch exist?`)}}try{await h(`git config branch.${i}.ricwiz-source "${r}"`,{cwd:e}),o.profileName&&await h(`git config branch.${i}.ricwiz-profile "${o.profileName}"`,{cwd:e})}catch{}}if(g==="all"||g==="envs"){let p=50/(a.length||1);for(let f of a){let u=`${m}-to-${f.name}`,w=f.sourceBranch;if(d.report({message:`Processing environment branch ${u}...`,increment:p}),!await ue(e,u))try{let z=o.buildUpstreamPath(w);await h(`git checkout -b ${u} ${z}`,{cwd:e}),c.push(u)}catch{try{await h(`git checkout -b ${u} ${w}`,{cwd:e}),c.push(u)}catch{throw new Error(`Could not create environment branch '${u}' from '${w}'. Does the source branch exist?`)}}}}d.report({message:`Publishing branches to ${o.originRemote}...`,increment:10});for(let p of c)try{await h(`git push -u ${o.originRemote} ${p}`,{cwd:e})}catch{D.window.showWarningMessage(`Ricwiz: Branch ${p} was created locally but could not be pushed to ${o.originRemote}.`)}if(g==="all"||g==="mainOnly"){d.report({message:`Switching to ${i}...`,increment:10});try{await h(`git checkout ${i}`,{cwd:e})}catch{}}d.report({increment:100}),D.window.showInformationMessage("Ricwiz: All set! You can start working on your branches! \u{1F680}")}catch(p){if(D.window.showErrorMessage(`Ricwiz Branch Creation Failed: ${p.message}`),c.length>0){try{await h(`git checkout ${r}`,{cwd:e})}catch{}for(let f of c)try{await h(`git branch -D ${f}`,{cwd:e})}catch{}D.window.showWarningMessage(`Ricwiz: Rolled back (deleted) ${c.length} branch(es) locally due to failure.`)}}})}catch(d){D.window.showErrorMessage(`Ricwiz general error: ${d.message}`)}}var D,Et=$(()=>{"use strict";D=v(require("vscode"));R();Rt();ee()});async function ve(t,e,o,s){s&&s.report({message:"CONFLICT! Resolve & click 'Commit & Continue' in Ricwiz panel."});let n=!1,m=!1,a=async()=>{try{let{stdout:i}=await h("git status --porcelain",{cwd:t});return i.split(`
`).filter(d=>{let c=d.substring(0,2);return["UD","DU","DD","AU","UA"].includes(c)}).map(d=>d.substring(3).trim())}catch{return[]}},g=async()=>{try{let{stdout:i}=await h("git status --porcelain",{cwd:t}),d=c=>c==="UU"?"Both Modified":c==="UD"?"Deleted by them":c==="DU"?"Deleted by us":c==="DD"?"Both Deleted":c==="AA"?"Both Added":c==="AU"?"Added by us":c==="UA"?"Added by them":"Conflicted";return i.split(`
`).map(c=>c.trimRight()).filter(c=>c.length>2).filter(c=>{let p=c.substring(0,2);return["UU","AA","UD","DU","AU","UA","DD"].includes(p)}).map(c=>{let p=c.substring(0,2);return{file:c.substring(3).trim(),state:d(p)}})}catch{return[]}},l=async()=>{if(n)return;let i=await a(),d=await g(),{webviewProvider:c}=(qe(),H(We));c&&c.setConflictState({isConflict:!0,sourceStr:e,targetStr:o,deletionsCount:i.length,files:d})},r=ae.commands.registerCommand("ricwiz.conflictAction",async i=>{if(i==="abortDeploy")m=!0;else if(i==="resolveDeletions"){try{let c=(await a()).map(f=>({label:f})),p=await ae.window.showQuickPick(c,{canPickMany:!0,placeHolder:"Select conflicted files to DELETE",title:"Ricwiz: Delete Conflicted Files"});if(p&&p.length>0){for(let f of p)try{await h(`git rm --force "${f.label}"`,{cwd:t})}catch{}ae.window.showInformationMessage(`Ricwiz: Deleted ${p.length} conflicted file(s).`)}}catch(d){ae.window.showErrorMessage(`Ricwiz: Error. (${d.message})`)}l()}else if(i==="commitAndContinue")try{let c=(await a()).filter(f=>Mt.existsSync(Tt.join(t,f)));if(c.length>0&&await ae.window.showWarningMessage(`Wait! There are ${c.length} file(s) with deletion conflicts that are still on your disk.

If you commit now, you will KEEP them in the project.

Are you sure you want to KEEP them?`,{modal:!0},"Yes, KEEP them","No, let me DELETE them")!=="Yes, KEEP them"){l();return}let p=!1;try{let{stdout:f}=await h('git grep -E "^<<<<<<< "',{cwd:t});f.trim().length>0&&(p=!0)}catch{}if(p){ae.window.showErrorMessage("Ricwiz: You still have unresolved conflict markers (<<<<<<<) in your files. Please resolve them first!"),l();return}await h("git add .",{cwd:t}),await h("git commit --no-edit",{cwd:t})}catch(d){ae.window.showErrorMessage(`Ricwiz: Could not commit automatically. (${d.message})`),l()}});for(l();;){if(m){n=!0,r.dispose(),(qe(),H(We)).webviewProvider?.setConflictState(null);try{await h("git merge --abort",{cwd:t})}catch{}return!1}try{let{stdout:i}=await h("git status --porcelain",{cwd:t});if(i.trim().length===0)return n=!0,r.dispose(),(qe(),H(We)).webviewProvider?.setConflictState(null),ae.window.showInformationMessage("Ricwiz: Changes committed!"),!0}catch{}await new Promise(i=>setTimeout(i,2e3))}}var ae,Mt,Tt,Ge=$(()=>{"use strict";ae=v(require("vscode")),Mt=v(require("fs")),Tt=v(require("path"));R()});async function Dt(){let t=y();if(!t){U.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}try{await h("git status",{cwd:t})}catch{U.window.showErrorMessage("Ricwiz: The opened folder does not appear to be a valid Git repository.");return}let e=await T.initialize(t);if(!e)return;let o=e.environments,s=await W(t,{prefix:e.ticketPrefix});if(!s){U.window.showErrorMessage("Operation cancelled: Ticket not provided.");return}let{ticketId:n,currentBranch:m}=s,a=n;if(!await ue(t,a)){U.window.showErrorMessage(`Ricwiz: Main branch '${a}' does not exist! Prepare deploy is only available when a main ticket branch is used.`);return}let g=e.getConfig("defaultReviewers",""),l="";try{let{stdout:r}=await h(`git config branch.${n}.ricwiz-reviewers`,{cwd:t});l=r.trim()}catch{}if(g.trim()){let r=await U.window.showInputBox({prompt:"Ricwiz: Reviewers for this deploy (optional, comma-separated)",placeHolder:"e.g. @joao, 123456",value:l||g,ignoreFocusOut:!0});if(r===void 0)return;try{r.trim()?await h(`git config branch.${n}.ricwiz-reviewers "${r.trim()}"`,{cwd:t}):l&&await h(`git config --unset branch.${n}.ricwiz-reviewers`,{cwd:t})}catch{}}await U.window.withProgress({location:U.ProgressLocation.Notification,title:"Ricwiz: Preparing Deploy",cancellable:!0},async(r,i)=>{let d=0,c=m,p=!1;i.onCancellationRequested(()=>{p=!0}),r.report({message:"Syncing remote information...",increment:10});try{await h("git fetch --all",{cwd:t});let u=10/(o.length||1);for(let w of o)try{if(p)throw new Error("Aborted");r.report({message:`Fetching ${w.sourceBranch}...`,increment:u});let z=e.getFetchRemote(w.sourceBranch),x=e.getFetchBranch(w.sourceBranch);await h(`git fetch ${z} ${x}:${x}`,{cwd:t})}catch{}}catch{}let f=60/(o.length||1);for(let u of o){if(p)break;let w=`${n}-to-${u.name}`,z=u.sourceBranch;try{r.report({message:`Processing ${w}...`,increment:f/4}),await h(`git checkout ${w}`,{cwd:t});try{await h(`git pull ${e.originRemote} ${w}`,{cwd:t})}catch{}let x=async se=>{try{await h(`git merge ${se}`,{cwd:t})}catch(E){let F=!1;try{let{stdout:J}=await h("git ls-files -u",{cwd:t});J.trim().length>0&&(F=!0)}catch{}let X=((E.stdout||"")+(E.stderr||"")+(E.message||"")).toLowerCase();if(F||X.includes("conflict")||X.includes("conflit")){if(!await ve(t,se,w,r))throw p=!0,new Error("Deploy aborted by user.")}else throw E}};r.report({message:`Merging ${z} into ${w}...`,increment:f/4});let P=e.getFetchRemote(z),B=e.getFetchBranch(z),N=e.buildUpstreamPath(z);if(await h(`git fetch ${P} ${B}`,{cwd:t}),await x(N),r.report({message:`Merging ${a} into ${w}...`,increment:f/4}),await x(a),p)break;r.report({message:`Pushing ${w}...`,increment:f/4}),await h(`git push ${e.originRemote} ${w}`,{cwd:t}),d++}catch(x){x.message.includes("aborted")?U.window.showInformationMessage("Ricwiz: Deploy cancelled."):U.window.showErrorMessage(`Ricwiz: Failed to process branch ${w}. Detail: ${x.message}`);return}}if(!p){r.report({message:"Finishing up...",increment:10});let u=c;try{await h(`git show-ref --verify --quiet refs/heads/${a}`,{cwd:t}),u=a}catch{}try{let w=await L(t);u&&u!==w?(await h(`git checkout ${u}`,{cwd:t}),U.window.showInformationMessage(`Ricwiz: Operation complete. Back on branch ${u}.`)):U.window.showInformationMessage("Ricwiz: Operation complete.")}catch{U.window.showInformationMessage("Ricwiz: Operation complete.")}}})}var U,At=$(()=>{"use strict";U=v(require("vscode"));R();Ge();ee()});async function It(t=!1){let e=y();if(!e)return;let o=await T.initialize(e);if(!o)return;let s=await W(e,{prompt:"Enter the full ticket ID for the Merge Requests (e.g., SCPSCA-1234) or just the number"});if(!s)return;let{ticketId:n}=s,m=o.getConfig("gitlabUrlOverride",""),a="";if(m&&m.trim()!=="")a=m.trim().replace(/\/+$/,"");else{let r="";try{let{stdout:i}=await h("git remote get-url origin",{cwd:e});r=i.trim()}catch{le.window.showErrorMessage("Ricwiz: Could not get the remote origin URL. Please configure the URL manually in the extension settings.");return}a=r,a.endsWith(".git")&&(a=a.slice(0,-4)),a.startsWith("git@")&&(a=a.replace("git@","").replace(":","/"),a=`https://${a}`)}let g=[],l=o.ticketSourceBranch;try{let{stdout:r}=await h(`git config branch.${n}.ricwiz-source`,{cwd:e});r.trim()&&(l=r.trim())}catch{}if(o.environments.length===0)g.push({source:n,target:l});else for(let r of o.environments)g.push({source:`${n}-to-${r.name}`,target:r.sourceBranch});for(let r of g){let i=`${a}/-/merge_requests/new?merge_request[source_branch]=${r.source}&merge_request[target_branch]=${r.target}`;t?le.commands.executeCommand("simpleBrowser.show",i):le.env.openExternal(le.Uri.parse(i))}le.window.showInformationMessage(`Ricwiz: Opening ${t?"VS Code browser":"external browser"} for Merge Requests!`)}async function Lt(){return It(!1)}async function Ft(){return It(!0)}var le,Ot=$(()=>{"use strict";le=v(require("vscode"));R();ee()});async function Nt(t=!1){let e=y();if(!e)return;let o=te.workspace.getConfiguration("ricwiz"),s=o.get("jiraUrl","");if(!s||s.trim()===""){te.window.showErrorMessage("Ricwiz: Jira URL is not configured. Please set it in the extension settings (e.g., https://jira.company.com/browse/).");return}let{getCurrentBranch:n,resolvePrefix:m,extractTicketSuggestion:a}=(R(),H(Be)),g=await n(e),l=o.get("ticketPrefix","SFPSCA-"),r=m(g,l),d=a(g,r,!0);if(d){let{normalizeTicketId:p}=(R(),H(Be));d=p(d,r)}else{let p=await W(e,{prompt:"Ricwiz could not detect the ticket from the branch name. Enter Jira ticket ID (e.g. SFPSCA-1234)",handleToSuffix:!0});if(!p)return;d=p.ticketId}let c=s.trim();c.endsWith("/")||(c+="/"),c+=d,t?te.commands.executeCommand("simpleBrowser.show",c):te.env.openExternal(te.Uri.parse(c)),te.window.showInformationMessage(`Ricwiz: Opening Jira Ticket ${d} in ${t?"VS Code":"browser"}!`)}async function Ut(){return Nt(!1)}async function jt(){return Nt(!0)}var te,Jt=$(()=>{"use strict";te=v(require("vscode"));R()});async function ri(){let t=qt.workspace.getConfiguration("ricwiz"),e=t.get("jiraUrl",""),o=t.get("jiraEmail","")?.trim(),s=(await ft())?.trim();if(!e||!s)throw new Error('Jira API Token is not securely configured. Please run the "Ricwiz: Set Secure Jira API Token" command.');let n=e;n.includes("/browse")&&(n=n.split("/browse")[0]),n.endsWith("/")&&(n=n.slice(0,-1));let m=o?`Basic ${Buffer.from(`${o}:${s}`).toString("base64")}`:`Bearer ${s}`;return{baseUrl:n,headerAuth:m}}async function $e(t,e,o){let{baseUrl:s,headerAuth:n}=await ri(),m=new URL(`${s}${e}`);return new Promise((a,g)=>{let l=Wt.request(m,{method:t,headers:{Authorization:n,Accept:"application/json",...o?{"Content-Type":"application/json"}:{}}},r=>{let i="";r.on("data",d=>i+=d),r.on("end",()=>{if(r.statusCode===401||r.statusCode===403)return g(new Error(`Authentication failed (HTTP ${r.statusCode}). Please check your Jira settings.`));if(r.statusCode&&r.statusCode>=400){let d="";try{let c=JSON.parse(i);c.errorMessages&&c.errorMessages.length>0&&(d=c.errorMessages.join(", "))}catch{}return r.statusCode===404||r.statusCode===410?g(new Error(`Ticket not found or deleted (HTTP ${r.statusCode}). ${d}`)):g(new Error(`Jira API returned HTTP status ${r.statusCode}. ${d}`))}if(!i)return a({});try{let d=JSON.parse(i);a(d)}catch{g(new Error("Failed to parse Jira response."))}})});l.on("error",r=>g(new Error(`Network error: ${r.message}`))),o&&l.write(JSON.stringify(o)),l.end()})}async function ze(t){let e=await $e("GET",`/rest/api/2/issue/${t}`);return e&&e.fields?{summary:e.fields.summary||"",description:e.fields.description||"No description provided.",status:e.fields.status?.name||"Unknown"}:null}async function Gt(t){let e=await $e("GET",`/rest/api/2/issue/${t}/transitions`);return e&&e.transitions?e.transitions.map(o=>({id:o.id,name:o.name})):[]}async function Ht(t,e){await $e("POST",`/rest/api/2/issue/${t}/transitions`,{transition:{id:e}})}async function Vt(t,e){await $e("POST",`/rest/api/2/issue/${t}/comment`,{body:e})}async function _t(t,e){await $e("PUT",`/rest/api/2/issue/${t}`,{update:{labels:[{add:e}]}})}async function Qt(t){let e=await $e("POST","/rest/api/3/search/jql",{jql:t,maxResults:50,fields:["summary","status","assignee"]});return e&&e.issues?e.issues.map(o=>({key:o.key,summary:o.fields?.summary||"No Title",status:o.fields?.status?.name||"Unknown",assignee:o.fields?.assignee?.displayName||"Unassigned"})):[]}var Wt,qt,Ee=$(()=>{"use strict";Wt=v(require("https")),qt=v(require("vscode"));ke()});async function et(){let t=await Ke();return!!(t&&t.trim())}async function to(t,e){let o=eo.workspace.getConfiguration("ricwiz"),s=(await Ke())?.trim();if(!s)throw new Error("No GitLab token");let n=e?e.getConfig("gitlabUrlOverride",""):o.get("gitlabUrlOverride","");if(!n||n.trim()==="")if(Xe)n=Xe;else try{let{stdout:l}=await h("git remote get-url origin",{cwd:t}),r=l.trim();r.endsWith(".git")&&(r=r.slice(0,-4)),r.startsWith("git@")&&(r=r.replace("git@","").replace(":","/"),r=`https://${r}`),n=r,Xe=n}catch{throw new Error("Could not get remote origin URL.")}let m=new URL(n),a=`${m.protocol}//${m.host}`,g=Yt[t];if(!g){let l=m.pathname;l.startsWith("/")&&(l=l.substring(1)),l.endsWith("/")&&(l=l.slice(0,-1)),l.endsWith(".git")&&(l=l.slice(0,-4)),g=encodeURIComponent(l),Yt[t]=g}return{baseUrl:a,token:s,projectPath:g}}async function Zt(t,e,o,s){let{baseUrl:n,token:m}=await to(t,s),a=new URL(`${n}${o}`);return new Promise((g,l)=>{let r=Xt.request(a,{method:e,timeout:5e3,headers:{"PRIVATE-TOKEN":m,Accept:"application/json"}},i=>{let d="";i.on("data",c=>d+=c),i.on("end",()=>{if(i.statusCode&&i.statusCode>=400)return l(new Error(`GitLab API error: ${i.statusCode}`));if(!d)return g({});try{let c=JSON.parse(d);g(c)}catch{l(new Error("Failed to parse GitLab response."))}})});r.on("timeout",()=>{r.destroy(),l(new Error("GitLab request timed out"))}),r.on("error",i=>l(new Error(`Network error: ${i.message}`))),r.end()})}async function tt(t,e,o,s){let n=`${t}:${e}:${o||"any"}`,m=Kt.get(n);if(m&&Date.now()-m.timestamp<ai)return m.data;try{let{projectPath:a}=await to(t,s),g=`/api/v4/projects/${a}/merge_requests?source_branch=${encodeURIComponent(e)}&order_by=updated_at&sort=desc`;o&&(g+=`&target_branch=${encodeURIComponent(o)}`);let l=await Zt(t,"GET",g,s);if(l&&l.length>0){let r=l[0];try{let c=await Zt(t,"GET",`/api/v4/projects/${a}/merge_requests/${r.iid}`,s);c&&(r=c)}catch{}let i="none";if(r.head_pipeline&&r.head_pipeline.status){let c=r.head_pipeline.status;c==="success"||c==="failed"||c==="canceled"||c==="skipped"?i=c:i="running"}let d={isMerged:r.state==="merged",isOpen:r.state==="opened",pipelineStatus:i,webUrl:r.web_url};return Kt.set(n,{data:d,timestamp:Date.now()}),d}return null}catch{return null}}var Xt,eo,Yt,Xe,Kt,ai,oo=$(()=>{"use strict";Xt=v(require("https")),eo=v(require("vscode"));ke();R();Yt={},Xe=null;Kt=new Map,ai=30*1e3});var He={};Ne(He,{findRelatedBranches:()=>rt,getCurrentBranchMergeStatus:()=>it,getRecentCommits:()=>nt,getRecentTickets:()=>st,getRelatedBranchesStatus:()=>ot});function io(t,e){return e.find(o=>t.endsWith(`-to-${o.name}`))}async function ot(t,e,o,s,n){let m=await et();return await Promise.all(e.map(async g=>{let l=io(g,s);if(m){let r=l?l.sourceBranch:void 0,i=await tt(t,g,r,n);if(i)return{name:g,isMerged:i.isMerged,pipelineStatus:i.pipelineStatus,mrUrl:i.webUrl}}return{name:g,isMerged:!1}}))}async function it(t,e,o,s){let n=io(e,o);if(!n)return!1;if(await et()){let m=await tt(t,e,n.sourceBranch,s);if(m)return m.isMerged}return!1}async function nt(t,e=10){try{let{stdout:o}=await h(`git log --oneline -${e} --format="%h|||%s|||%ar"`,{cwd:t});return o.split(`
...
`).map(u=>u.trim()).filter(u=>u.length>0)}catch{}let l=[...a,...g];if(l.length===0){Z.window.showInformationMessage(`Ricwiz: No modified files found for ${n}.`);return}let r=Array.from(new Set(l)).sort(),i={};for(let f of r){let u=f.match(/default\/([^/]+)/),w=u&&u[1]?u[1].toUpperCase():"OUTROS";i[w]||(i[w]=[]),i[w].push(f)}let d=`Files modified in branch ${n}:
`,c=Object.keys(i).sort();for(let f of c)d+=`
=== ${f} ===
`,d+=i[f].join(`
`)+`
`;let p=await Z.workspace.openTextDocument({content:d,language:"plaintext"});await Z.window.showTextDocument(p)}catch(m){Z.window.showErrorMessage(`Ricwiz: Error running git log - ${m.message}`)}})}var Z,Do=$(()=>{"use strict";Z=v(require("vscode"));R()});async function Ao(){let t=y();if(!t){ne.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let o=ne.workspace.getConfiguration("ricwiz").get("resetTrackingCommand","sf org disable tracking && sf project reset tracking --no-prompt");await ne.window.withProgress({location:ne.ProgressLocation.Notification,title:"Ricwiz: Resetting tracking...",cancellable:!1},async()=>{try{let{stdout:s,stderr:n}=await h(o,{cwd:t,maxBuffer:52428800}),m=ne.window.createOutputChannel("Ricwiz Reset Tracking");m.appendLine(`Executing: ${o}`),m.appendLine(s),n&&(m.appendLine("--- STDERR ---"),m.appendLine(n)),m.show(),ne.window.showInformationMessage("Ricwiz: Successfully reset tracking!")}catch(s){let n=ne.window.createOutputChannel("Ricwiz Reset Tracking");n.appendLine(`Error executing: ${o}`),s.stdout&&n.appendLine(s.stdout),s.stderr&&n.appendLine(s.stderr),n.appendLine(s.message),n.show(),ne.window.showErrorMessage("Ricwiz: Error resetting tracking. See output channel for details.")}})}var ne,Io=$(()=>{"use strict";ne=v(require("vscode"));R()});async function Lo(){let t=y();if(!t){K.window.showErrorMessage("Ricwiz: Open a workspace first.");return}let e=["ApexClass","ApexTrigger","CustomObject","CustomField","LightningComponentBundle","AuraDefinitionBundle","Flow","CustomLabel","CustomMetadata","StaticResource","Profile","PermissionSet","PermissionSetGroup","Layout","ValidationRule","RecordType","ListView","Report","EmailTemplate","Other (Type manually)..."],o=await K.window.showQuickPick(e,{placeHolder:"Select Metadata Type to extract (e.g., ApexClass)",ignoreFocusOut:!0});if(!o||o==="Other (Type manually)..."&&(o=await K.window.showInputBox({prompt:"Enter Metadata Type (e.g., CustomApplication, Queue)",ignoreFocusOut:!0}),!o))return;let s={ApexClass:"**/*.cls",ApexTrigger:"**/*.trigger",CustomObject:"**/*.{object,object-meta.xml}",CustomField:"**/*.field-meta.xml",LightningComponentBundle:"**/lwc/*/*.js",AuraDefinitionBundle:"**/aura/*/*.cmp",Flow:"**/*.flow-meta.xml",CustomLabel:"**/*.labels-meta.xml",CustomMetadata:"**/*.md-meta.xml",StaticResource:"**/*.resource-meta.xml",Profile:"**/*.profile-meta.xml",PermissionSet:"**/*.permissionset-meta.xml",PermissionSetGroup:"**/*.permissionsetgroup-meta.xml",Layout:"**/*.layout-meta.xml",ValidationRule:"**/*.validationRule-meta.xml",RecordType:"**/*.recordType-meta.xml",ListView:"**/*.listView-meta.xml"},n=[],m=s[o];if(m)try{n=(await K.workspace.findFiles(m,"**/node_modules/**")).map(l=>{let r=l.fsPath.split(/[\\/]/).pop()||"";if(o==="LightningComponentBundle"||o==="AuraDefinitionBundle"){let i=l.fsPath.split(/[\\/]/);return i[i.length-2]||r.split(".")[0]}return r.split(".")[0]}),n=[...new Set(n)].sort()}catch{}let a=await new Promise(g=>{let l=K.window.createQuickPick();l.title=`Extract ${o}`,l.placeholder="Type name (e.g. MyComponent) or * for all",l.ignoreFocusOut=!0,l.matchOnDescription=!0;let r=()=>{let i=l.value.trim(),d=[];i?d.push({label:`$(cloud-download) Extract "${i}"`,description:"Extract exact name from Salesforce",alwaysShow:!0}):d.push({label:'$(cloud-download) Extract "*" (All)',description:`Extract all ${o}s`,alwaysShow:!0}),n.forEach(c=>{(!i||c.toLowerCase().includes(i.toLowerCase()))&&d.push({label:c,description:"Local workspace component"})}),l.items=d};l.onDidChangeValue(()=>r()),l.onDidAccept(()=>{let i=l.selectedItems[0];if(i){let d=i.label;d.startsWith('$(cloud-download) Extract "')?d=d.replace('$(cloud-download) Extract "',"").replace('" (All)',"").replace('"',""):d==='$(cloud-download) Extract "*" (All)'&&(d="*"),l.hide(),g(d)}}),l.onDidHide(()=>{l.dispose(),g(void 0)}),r(),l.show()});a&&await K.window.withProgress({location:K.ProgressLocation.Notification,title:`Ricwiz: Extracting ${o}:${a} from Salesforce...`,cancellable:!0},async(g,l)=>{try{I.show(!0);let r=`${o}:${a}`,{stdout:i,stderr:d}=await h(`sf project retrieve start -m "${r}"`,{cwd:t});i&&I.appendLine(i),d&&I.appendLine(d),K.window.showInformationMessage(`Ricwiz: Successfully extracted ${r}.`)}catch(r){I.appendLine(`ERROR: ${r.message}`),r.stdout&&I.appendLine(r.stdout),r.stderr&&I.appendLine(r.stderr),K.window.showErrorMessage("Ricwiz: Extraction failed. See Output channel for details.")}})}var K,Fo=$(()=>{"use strict";K=v(require("vscode"));R()});async function No(){let t=j.window.activeTextEditor;if(!t){j.window.showErrorMessage("Ricwiz: Please open the file you want to deploy in the editor first.");return}let e=t.document.uri.fsPath,o=y();if(!o)return;let s="";if(await j.window.withProgress({location:j.ProgressLocation.Notification,title:"Ricwiz: Fetching available Salesforce orgs...",cancellable:!1},async()=>{try{let{stdout:l}=await h("sf org list --json",{cwd:o});s=l}catch(l){s=l.stdout||""}}),!s){j.window.showErrorMessage("Ricwiz: Failed to fetch orgs. Is Salesforce CLI installed?");return}let n=[];try{let l=JSON.parse(s),r=l.result?.nonScratchOrgs||[],i=l.result?.scratchOrgs||[];n=[...r,...i]}catch{j.window.showErrorMessage("Ricwiz: Failed to parse org list.");return}if(n.length===0){j.window.showInformationMessage("Ricwiz: No authenticated orgs found.");return}let m=n.map(l=>({label:l.alias||l.username,description:l.alias?l.username:"",picked:l.isDefaultUsername})),a=await j.window.showQuickPick(m,{placeHolder:"Select the org(s) to deploy this file to",canPickMany:!0,ignoreFocusOut:!0});if(!a||a.length===0)return;let g=Oo.basename(e);await j.window.withProgress({location:j.ProgressLocation.Notification,title:`Ricwiz: Deploying ${g} to ${a.length} org(s)...`,cancellable:!1},async()=>{I.show(!0),I.appendLine(`--- Starting Parallel Deploy of ${g} ---`);let l=a.map(async c=>{let p=c.label;I.appendLine(`[${p}] Deploying...`);try{let{stdout:f,stderr:u}=await h(`sf project deploy start -d "${e}" -o "${p}"`,{cwd:o});return I.appendLine(`[${p}] \u2705 Success`),f&&I.appendLine(f),{org:p,success:!0}}catch(f){return I.appendLine(`[${p}] \u274C Failed`),f.stdout&&I.appendLine(f.stdout),f.stderr&&I.appendLine(f.stderr),{org:p,success:!1}}}),r=await Promise.all(l),i=r.filter(c=>c.success).length,d=r.filter(c=>!c.success).length;d===0?j.window.showInformationMessage(`Ricwiz: Successfully deployed to all ${i} orgs!`):j.window.showErrorMessage(`Ricwiz: Deploy finished with errors (${i} success, ${d} failed). Check Output channel.`)})}var j,Oo,Uo=$(()=>{"use strict";j=v(require("vscode")),Oo=v(require("path"));R()});async function jo(){let t=y();if(!t){A.window.showErrorMessage("Ricwiz: Open a folder or workspace that is a Git repository.");return}let e=A.workspace.getConfiguration("ricwiz"),o=e.get("auditUsername",""),s=e.get("auditHours",8),n=await A.window.showInputBox({prompt:"Enter your Salesforce Username to query in SetupAuditTrail",value:o,placeHolder:"admin@tuaorg.com"});if(!n)return;let m=await A.window.showInputBox({prompt:"How many hours back do you want to search?",value:s.toString(),placeHolder:"8"});if(!m)return;let a=parseFloat(m);if(isNaN(a)||a<=0){A.window.showErrorMessage("Ricwiz: Invalid hours specified.");return}let g=new Date(Date.now()-a*60*60*1e3).toISOString(),r=`sf data query -q "${`SELECT Action, Display, Section FROM SetupAuditTrail WHERE CreatedBy.Username = '${n}' AND CreatedDate >= ${g}`}" --json`;await A.window.withProgress({location:A.ProgressLocation.Notification,title:"Ricwiz: Interrogating Setup Audit Trail...",cancellable:!1},async()=>{try{let{stdout:i}=await h(r,{cwd:t,maxBuffer:52428800}),d=JSON.parse(i);if(!d.result||d.result.records.length===0){A.window.showInformationMessage(`Ricwiz: No changes found for ${n} in the last ${a} hours.`);return}let c=d.result.records,p=[],f=new Set;for(let E of c){let F=ci(E.Action,E.Display,E.Section);if(F){let X=`${F.isDelete?"DEL":"ADD"}-${F.metadataFormat}`;if(!f.has(X)){f.add(X);let J=F.isDelete?"$(trash)":"$(plus)";p.push({label:`${J} ${F.metadataFormat}`,description:`${E.Action} -> ${E.Display}`,metadataFormat:F.metadataFormat,isDelete:F.isDelete})}}}if(p.length===0){A.window.showInformationMessage(`Ricwiz: No extractable metadata changes found for ${n} in the last ${a} hours (ignored passwords/logins).`);return}let u=await A.window.showQuickPick(p,{canPickMany:!0,placeHolder:"Select the changes you want to extract to GitLab",ignoreFocusOut:!0});if(!u||u.length===0){A.window.showInformationMessage("Ricwiz: No changes selected.");return}let w=u.filter(E=>E.isDelete),z=u.filter(E=>!E.isDelete),x=A.window.createOutputChannel("Ricwiz Admin Bridge");if(x.show(),w.length>0){let{stdout:E}=await h("git ls-files",{cwd:t}),F=E.split(`
`).map(J=>J.trim()),X=0;for(let J of w){let Se=J.metadataFormat.split(":"),Le=Se[0],Fe=Se[1],fe=Fe;Le==="CustomField"&&(fe=Fe.split(".")[1]);let Ze=F.filter(xe=>{let M=Ye.basename(xe);return M.startsWith(fe+".")&&M.includes(Le==="CustomField"?".field":"")});for(let xe of Ze){let M=Ye.join(t,xe);Qe.existsSync(M)&&(Qe.unlinkSync(M),x.appendLine(`Deleted local file: ${xe}`),X++)}}A.window.showInformationMessage(`Ricwiz: Deleted ${X} local files from Git workspace.`)}if(z.length===0)return;let P=z.map(E=>E.metadataFormat).filter(E=>E!=="").join(", "),B=await A.window.showInputBox({prompt:"Review and adjust the metadata components to retrieve",value:P,ignoreFocusOut:!0});if(!B)return;let N=`sf project retrieve start -m "${B}"`;x.appendLine(`Executing: ${N}`),A.window.showInformationMessage(`Ricwiz: Extracting ${z.length} components...`);let se=await h(N,{cwd:t});x.appendLine(se.stdout),se.stderr&&(x.appendLine("--- STDERR ---"),x.appendLine(se.stderr)),A.window.showInformationMessage("Ricwiz: Changes extracted successfully! Ready for Git Commit.")}catch(i){A.window.showErrorMessage(`Ricwiz: Error capturing changes - ${i.message}`)}})}function ci(t,e,o){if(!t||!e||!o)return null;let s=t.toLowerCase(),n=o.toLowerCase();if(["security controls","network access","session settings","data export","login history","password policies","identity verification","delegated administration"].includes(n)||s.includes("login")||s.includes("password")||s.includes("oauth")||s.includes("session"))return null;let a=s.includes("delete"),g=null;if(s==="permissionsetgroupcomponentadd"||s==="permissionsetgroupcomponentdelete")return null;let l=(r,i=!1)=>{let d=r.replace(/\(.*\)/g,"").trim();d.includes(":")&&!s.includes("calculation")&&(d=d.split(":")[0]);let c=["disabled","deleted","removed","created","changed","updated","from","to","on","assigned","assign","assignment","permission","set","group","apex","class","trigger","custom","field","object","layout","validation","rule","flow","profile"],p=d.split(/\s+/);if(i){for(;p.length>0&&c.includes(p[p.length-1].toLowerCase());)p.pop();for(;p.length>0&&c.includes(p[0].toLowerCase());)p.shift();return p.join(" ").trim().replace(/[^a-zA-Z0-9_ ]/g,"")}else return p.filter(w=>!c.includes(w.toLowerCase())).join("_").replace(/[^a-zA-Z0-9_]/g,"")||d.replace(/\s+/g,"")};if(s.includes("profile"))g=`Profile:${l(e,!0)}`;else if(s.includes("permissionsetgroupcalculation")){let r=e.split(":");g=`PermissionSetGroup:${r.length>1?r[r.length-1].trim():l(e,!1)}`}else if(s.includes("permission set group")||s.includes("permissionsetgroup"))g=`PermissionSetGroup:${l(e,!1)}`;else if(s.includes("permission set")||s.includes("permissionset"))g=`PermissionSet:${l(e,!1)}`;else if(s.includes("apexclass"))g=`ApexClass:${l(e,!1)}`;else if(s.includes("apextrigger")||s.includes("apex trigger"))g=`ApexTrigger:${l(e,!1)}`;else if(s.includes("customfield")){let r=e.match(/([A-Za-z0-9_]+__c)/),i=e.match(/(?:on|na|for)\s+([A-Za-z0-9_]+)/i);r&&i?g=`CustomField:${i[1]}.${r[1]}`:g=`CustomField:${l(e,!1)}`}else if(s.includes("layout"))g=`Layout:${l(e,!0)}`;else if(s.includes("validation"))g=`ValidationRule:${l(e,!1)}`;else if(s.includes("flow"))g=`Flow:${l(e,!1)}`;else if(s.includes("customobject")){let r=e.match(/([A-Za-z0-9_]+__c)/);g=r?`CustomObject:${r[1]}`:`CustomObject:${l(e,!1)}`}else if(!s.includes("created")&&!s.includes("changed")&&!s.includes("deleted"))return null;return g?{metadataFormat:g,isDelete:a}:null}var A,Qe,Ye,Jo=$(()=>{"use strict";A=v(require("vscode")),Qe=v(require("fs")),Ye=v(require("path"));R()});async function Wo(){let t=y();if(t)try{let{stdout:e}=await h('git for-each-ref --sort=-committerdate --format="%(refname:short)|||%(committerdate:relative)|||%(subject)" refs/heads/',{cwd:t}),o=e.split(`
